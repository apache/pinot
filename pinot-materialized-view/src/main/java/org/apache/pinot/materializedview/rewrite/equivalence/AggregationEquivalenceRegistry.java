...
public final class AggregationEquivalenceRegistry {
  ...
  private static final List<AggregationEquivalence> RULES = List.of(
      ...
      new SketchMergeEquivalence("SUMVALUESINTEGERSUMTUPLESKETCH", "DISTINCTCOUNTRAWINTEGERSUMTUPLESKETCH",
          "SUMVALUESINTEGERSUMTUPLESKETCH"),
      new SketchMergeEquivalence("AVGVALUEINTEGERSUMTUPLESKETCH", "DISTINCTCOUNTRAWINTEGERSUMTUPLESKETCH",
      ...
      new SketchMergeEquivalence("DISTINCTCOUNTRAWCPCSKETCH", "DISTINCTCOUNTRAWCPCSKETCH",
          "DISTINCTCOUNTRAWCPCSKETCH"),
      new SketchMergeEquivalence("DISTINCTCOUNTRAWINTEGERSUMTUPLESKETCH", "DISTINCTCOUNTRAWINTEGERSUMTUPLESKETCH",
