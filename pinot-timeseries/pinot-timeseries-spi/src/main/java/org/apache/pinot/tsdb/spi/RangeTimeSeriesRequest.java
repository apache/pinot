...
/// A time-series request received by the Pinot Broker. This is passed to the [TimeSeriesLogicalPlanner] so
...
///   and processed is defined by the [TimeBuckets] used by the operator.
public class RangeTimeSeriesRequest {
  ...
  /// **Optional** field which the caller can use to suggest the default resolution for the query. Language
