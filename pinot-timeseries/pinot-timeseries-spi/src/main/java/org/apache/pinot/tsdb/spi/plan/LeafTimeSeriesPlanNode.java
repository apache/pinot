...
/// This would typically be the leaf node of a plan-tree generated by a time-series engine's logical planner. At
/// runtime, this gets compiled to a Combine Operator.
/// **Note:** You don't need to pass the time-filter to the filter expression, since Pinot will automatically compute
///   the time filter based on the computed time buckets in [org.apache.pinot.tsdb.spi.TimeSeriesLogicalPlanner].
