...
public class DruidToPinotSegmentConverterMapper extends Mapper<LongWritable, Text, LongWritable, Text> {
  protected static final String LOCAL_TEMP_DIR = "pinot_druid_tmp";
  protected static final String PROGRESS_REPORTER_THREAD_NAME = "pinot-druid-progress-reporter";
  ...
  public void setup(Context context)
    ...
    switch (segmentNameGeneratorType) {
      ...
      case JobConfigConstants.NORMALIZED_DATE_SEGMENT_NAME_GENERATOR:
        ...
        _segmentNameGenerator = new NormalizedDateSegmentNameGenerator(_rawTableName,
            _jobConf.get(JobConfigConstants.SEGMENT_NAME_PREFIX),
