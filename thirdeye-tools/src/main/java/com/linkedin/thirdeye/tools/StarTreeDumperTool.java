...
public class StarTreeDumperTool
{
  ...
  private static void countNodes(StarTreeNode node,
                                 ...
                                 AtomicInteger numLeaves,
                                 Map<Integer, Integer> leafDepthCount,
                                 Map<Integer, Integer> parentDepthCount,
                                 int currentDepth)
  {
    if (node.isLeaf())
    {
