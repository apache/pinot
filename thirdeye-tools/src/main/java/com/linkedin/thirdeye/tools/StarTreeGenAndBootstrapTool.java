 ...
 */
public class StarTreeGenAndBootstrapTool implements Runnable
{
  private static final Logger LOG = LoggerFactory.getLogger(StarTreeGenAndBootstrapTool.class);
  ...
  public StarTreeGenAndBootstrapTool(int numTimeBuckets,
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    // Run bootstrap job
    new StarTreeGenAndBootstrapTool(numTimeBuckets,
                              keepMetricValues,
                              keepBuffers,
                              config,
                              recordStreams,
