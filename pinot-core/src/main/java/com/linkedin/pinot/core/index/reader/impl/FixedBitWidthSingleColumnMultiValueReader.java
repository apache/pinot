 ...
 * 
 */
public class FixedBitWidthSingleColumnMultiValueReader implements
		SingleColumnMultiValueReader {
	private static Logger logger = LoggerFactory
			.getLogger(FixedBitWidthSingleColumnMultiValueReader.class);
	 ...
	 * @param isHeap
	 */
	public FixedBitWidthSingleColumnMultiValueReader(File file, int numDocs,
