...
import com.linkedin.pinot.core.block.EmptyBlock;
import com.linkedin.pinot.core.block.IntArrayBlock;
...
public class SingleBlockDataSource implements DataSource {
   ...
   * @param dictionary
   */
  public SingleBlockDataSource(int[] columnData, int[][] invertedIndex, int[] dictionary) {
