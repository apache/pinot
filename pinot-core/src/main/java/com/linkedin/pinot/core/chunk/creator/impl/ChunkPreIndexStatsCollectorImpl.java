...
public class ChunkPreIndexStatsCollectorImpl implements ChunkPreIndexStatsCollector {
  private static final Logger logger = Logger.getLogger(ChunkPreIndexStatsCollectorImpl.class);

  private final Schema dataSchema;
  Map<String, AbstractColumnPreIndexStatsCollector> columnStatsCollectorMap;

  public ChunkPreIndexStatsCollectorImpl(Schema dataSchema) {
