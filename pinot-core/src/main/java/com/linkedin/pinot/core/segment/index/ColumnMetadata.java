...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    String dateTimeTypeStr = config.getString(getKeyFor(column, DATETIME_TYPE), null);
    DateTimeType dateTimeType = (dateTimeTypeStr == null) ? null : DateTimeType.valueOf(dateTimeTypeStr);
    if (dateTimeType != null) {
      builder.setDateTimeType(dateTimeType);
    }
  ...
  public static class Builder {
    ...
    public ColumnMetadata build() {
      return new ColumnMetadata(columnName, cardinality, totalDocs, totalRawDocs, totalAggDocs, dataType,
          ...
          partitionFunction, numPartitions, partitionValues, dateTimeFormat, dateTimeGranularity, dateTimeType);
    }
  }
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalDocs, int totalRawDocs, int totalAggDocs,
    ...
    switch (fieldType) {
      ...
      case TIME:
        ...
        break;
      case DATE_TIME:
        this.fieldSpec = new DateTimeFieldSpec(columnName, dataType, dateTimeFormat, dateTimeGranularity, dateTimeType);
        break;
      default:
