...
public class FloatColumnarReader implements ColumnarReader {

  final Dictionary<Float> dict;
  final IntArray forwardIndex;

  @SuppressWarnings("unchecked")
  public FloatColumnarReader(Dictionary<?> dictionary, IntArray intArray) {
    dict = (Dictionary<Float>) dictionary;
