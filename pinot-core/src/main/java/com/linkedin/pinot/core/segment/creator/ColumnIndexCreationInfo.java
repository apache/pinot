...
public class ColumnIndexCreationInfo {
  ...
  private final int lengthOfShortestEntry;
  private final int lengthOfLongestEntry;
  ...
  public ColumnIndexCreationInfo(boolean createDictionary, Object min, Object max, Object sortedUniqueElementsArray,
      ...
      int totalNumberOfEntries, int maxNumberOfMultiValueElements, int lengthOfShortestEntry, int lengthOfLongestEntry,
      boolean isAutoGenerated, PartitionFunction partitionFunction, int numPartitions, List<IntRange> partitionRanges,
    ...
    this.lengthOfShortestEntry = lengthOfShortestEntry;
    this.lengthOfLongestEntry = lengthOfLongestEntry;
  ...
  public boolean isFixedLength() {
    return lengthOfShortestEntry == lengthOfLongestEntry;
  }
}
