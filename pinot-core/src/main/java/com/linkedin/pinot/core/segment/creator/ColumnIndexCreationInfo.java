...
public class ColumnIndexCreationInfo {
  ...
  private final int lengthOfSmallestEntry;
  ...
  public ColumnIndexCreationInfo(boolean createDictionary, Object min, Object max, Object sortedUniqueElementsArray,
      ...
      int totalNumberOfEntries, int maxNumberOfMultiValueElements, int lengthOfSmallestEntry, int lengthOfLongestEntry,
    ...
    this.lengthOfSmallestEntry = lengthOfSmallestEntry;
  ...
  public boolean isFixedLength() {
    return lengthOfSmallestEntry == lengthOfLongestEntry;
  }
}
