...
public class ChunkInvertedIndexCreatorImpl implements InvertedIndexCreator{
  private static final Logger logger = Logger.getLogger(ChunkInvertedIndexCreatorImpl.class);
  ...
  public ChunkInvertedIndexCreatorImpl(File indexDir, int cardinality , FieldSpec spec) {
    this.spec = spec;
