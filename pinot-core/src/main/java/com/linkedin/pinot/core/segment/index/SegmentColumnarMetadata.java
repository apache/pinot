...
public class SegmentColumnarMetadata implements SegmentMetadata {

  private final PropertiesConfiguration segmentMetadataPropertiesConfiguration;

  private static Logger LOGGER = Logger.getLogger(SegmentColumnarMetadata.class);
  private final Map<String, SegmentMetadataImpl> columnMetadataMap;
  ...
  private SegmentMetadataImpl extractColumnMetadataFor(String column) {
    ...
    return new SegmentMetadataImpl(column, cardinality, totalDocs, dataType, bitsPerElement, stringColumnMaxLength, fieldType, isSorted,
  ...
  public Map<String, SegmentMetadataImpl> getColumnMetadataMap() {
