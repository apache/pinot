...
public class RecordReaderConfig {
  ...
  @JsonProperty("CsvFileFormat")
  public RecordReaderConfig setCsvFileFormat(String csvFileFormat) {
  ...
  @JsonProperty("CsvHeader")
  public RecordReaderConfig setCsvHeader(String csvHeader) {
  ...
  @JsonProperty("CsvDelimiter")
  public RecordReaderConfig setCsvDelimiter(String csvDelimiter) {
  ...
  @JsonProperty("CsvDateFormat")
  public RecordReaderConfig setCsvDateFormat(String csvDateFormat) {
