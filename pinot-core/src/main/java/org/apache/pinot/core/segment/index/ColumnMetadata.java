...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    builder.setHasTextIndex(config.getBoolean(getKeyFor(column, HAS_TEXT_INDEX), false));
    builder.setTextIndexType(config.getString(getKeyFor(column, TEXT_INDEX_TYPE), null));
  ...
  public static class Builder {
    ...
    public Builder setHasTextIndex(boolean hasTextIndex) {
      this.hasTextIndex = hasTextIndex;
      return this;
    }
    ...
    public ColumnMetadata build() {
      return new ColumnMetadata(columnName, cardinality, totalDocs, totalRawDocs, totalAggDocs, dataType,
          ...
          maxValue, partitionFunction, numPartitions, _partitions, dateTimeFormat, dateTimeGranularity, hasTextIndex,
          textIndexType == null ? null : TextIndexType.valueOf(textIndexType));
    }
  }
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalDocs, int totalRawDocs, int totalAggDocs,
      ...
      String dateTimeGranularity, boolean hasTextIndex, TextIndexType textIndexType) {
    this.columnName = columnName;
    this.cardinality = cardinality;
    this.totalDocs = totalDocs;
    this.totalRawDocs = totalRawDocs;
