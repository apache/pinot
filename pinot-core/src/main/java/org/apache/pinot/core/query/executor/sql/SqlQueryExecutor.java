    ...
    switch (statement.getExecutionType()) {
      case MINION:
        ...
        try {
          ...
          result.addException(new BrokerQueryErrorMessage(QueryErrorCode.QUERY_EXECUTION, e.getMessage()));
        }
        break;
      case HTTP:
        try {
      ...
      default:
        result.addException(
            new BrokerQueryErrorMessage(QueryErrorCode.QUERY_EXECUTION, "Unsupported statement: " + statement));
        break;
    }
    return result;
  }
