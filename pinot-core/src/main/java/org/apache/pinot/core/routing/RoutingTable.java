...
public class RoutingTable {
  ...
  private final Map<ServerInstance, SegmentsToQuery> _serverInstanceToSegmentsMap;
  private final List<String> _unavailableSegments;
  private final int _numPrunedSegments;

  public RoutingTable(Map<ServerInstance, SegmentsToQuery> serverInstanceToSegmentsMap,
  ...
  public Map<ServerInstance, SegmentsToQuery> getServerInstanceToSegmentsMap() {
