...
public class ObjectSerDeUtils {
  ...
  public enum ObjectType {
    ...
    public static ObjectType getObjectType(Object value) {
      ...
      } else if (value instanceof org.apache.pinot.core.query.aggregation.function.customobject.AvgPair) {
        return ObjectType.AvgPair;
      } else if (value instanceof org.apache.pinot.core.query.aggregation.function.customobject.MinMaxRangePair) {
        return ObjectType.MinMaxRangePair;
      } else if (value instanceof HyperLogLog) {
        return ObjectType.HyperLogLog;
      } else if (value instanceof org.apache.pinot.core.query.aggregation.function.customobject.QuantileDigest) {
