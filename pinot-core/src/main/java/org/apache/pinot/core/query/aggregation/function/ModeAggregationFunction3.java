...
public class ModeAggregationFunction3
  ...
  public ModeAggregationFunction3(List<ExpressionContext> arguments, boolean nullHandlingEnabled) {
...
//    Preconditions.checkArgument(numArguments <= 2, "Mode expects at most 2 arguments, got: %s", numArguments);
  ...
  protected static Int2IntOpenHashMap getDictIdCountMap(AggregationResultHolder aggregationResultHolder,
    ...
    ModeAggregationFunction3.DictIdsWrapper dictIdsWrapper = aggregationResultHolder.getResult();
    if (dictIdsWrapper == null) {
      dictIdsWrapper = new ModeAggregationFunction3.DictIdsWrapper(dictionary);
  ...
  protected static Int2IntOpenHashMap getDictIdCountMap(GroupByResultHolder groupByResultHolder, int groupKey,
      Dictionary dictionary) {
    ModeAggregationFunction3.DictIdsWrapper dictIdsWrapper = groupByResultHolder.getResult(groupKey);
    if (dictIdsWrapper == null) {
      dictIdsWrapper = new ModeAggregationFunction3.DictIdsWrapper(dictionary);
