...
public class CachedBitmapFilterOperator extends BaseFilterOperator {
  private static final String EXPLAIN_NAME = "FILTER_CACHED_BITMAP";
  private final ImmutableRoaringBitmap _docIds;
  private final boolean _exclusive;

  public CachedBitmapFilterOperator(ImmutableRoaringBitmap docIds, boolean exclusive, int numDocs,
