...
/// Value aggregator that keeps the value with the earliest original time.
///
...
/// group, so it simply keeps the already aggregated value.
///
...
public class FirstWithTimeValueAggregator implements ValueAggregator {
