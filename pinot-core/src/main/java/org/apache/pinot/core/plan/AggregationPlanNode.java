...
public class AggregationPlanNode implements PlanNode {
  private static final EnumSet<AggregationFunctionType> DICTIONARY_BASED_FUNCTIONS =
      EnumSet.of(MIN, MINMV, MINSTRING, MAX, MAXMV, MAXSTRING, MINMAXRANGE, MINMAXRANGEMV, DISTINCTCOUNT,
          DISTINCTCOUNTMV, DISTINCTSUM, DISTINCTSUMMV, DISTINCTAVG, DISTINCTAVGMV, DISTINCTCOUNTOFFHEAP,
  ...
  private static final EnumSet<AggregationFunctionType> METADATA_BASED_FUNCTIONS =
      EnumSet.of(COUNT, MIN, MINMV, MINSTRING, MAX, MAXMV, MAXSTRING, MINMAXRANGE, MINMAXRANGEMV);
