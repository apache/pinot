...
public class GroupByDataTableReducer extends BaseGroupByReducer implements DataTableReducer {
  ...
  private void setSQLGroupByInResultTable(BrokerResponseNative brokerResponseNative, DataSchema dataSchema,
    ...
    if (_sqlQuery) {
      ...
      brokerResponseNative.setResultTable(getResultTable(indexedTable));
    } else {
