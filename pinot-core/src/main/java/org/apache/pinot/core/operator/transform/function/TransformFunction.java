...
public interface TransformFunction {
  ...
  ///
  /// This name should be unique among all transform functions.
  ///
  ...
  /// @param arguments           Arguments for the transform function
  /// @param columnContextMap    Map from column name to context
  /// @param nullHandlingEnabled Whether this transform function handles `null`
  ...
  /// Returns the dictionary for the transform result if the result is dictionary-encoded, or `null` if not.
  @Nullable
