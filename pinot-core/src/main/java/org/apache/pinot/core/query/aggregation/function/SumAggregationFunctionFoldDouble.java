...
public class SumAggregationFunctionFoldDouble extends NullableSingleInputAggregationFunction<Double, Double> {
  private static final double DEFAULT_VALUE = 0.0;

  public SumAggregationFunctionFoldDouble(List<ExpressionContext> arguments, boolean nullHandlingEnabled) {
    this(arguments.get(0), nullHandlingEnabled);
  }

  protected SumAggregationFunctionFoldDouble(ExpressionContext expression, boolean nullHandlingEnabled) {
  ...
  public void aggregate(int length, AggregationResultHolder aggregationResultHolder,
    ...
    switch (blockValSet.getValueType().getStoredType()) {
      case INT: {
        ...
        sum = foldNotNull(length, blockValSet.getNullBitmap(), sum, (acum, from, to) -> {
          double innerSum = 0;
