...
///
/// The function can be used as FirstWithTime(dataExpression, timeExpression, 'float')
///
/// Following arguments are supported:
///
/// - dataExpression: expression that contains the float data column to be calculated first on
