...
public class ProjectionPlanNode implements PlanNode {
  ...
  public ProjectionPlanNode(IndexSegment indexSegment, QueryContext queryContext, Set<String> projectionColumns,
      int maxDocsPerCall, @Nullable BaseFilterOperator filterOperator, boolean isSwimlanePredicate,
      @Nullable ExpressionContext expressionContext) {
  ...
  public ProjectionPlanNode(IndexSegment indexSegment, QueryContext queryContext, Set<String> projectionColumns,
    ...
    this(indexSegment, queryContext, projectionColumns, maxDocsPerCall, filterOperator, false, null);
  }
  ...
  public ProjectionOperator run() {
    ...
    DocIdSetOperator docIdSetOperator =
        _maxDocsPerCall > 0 ? new DocIdSetPlanNode(_indexSegment, _queryContext, _maxDocsPerCall, _filterOperator,
            _isSwimlanePredicate, _expressionContext).run()
            : null;
