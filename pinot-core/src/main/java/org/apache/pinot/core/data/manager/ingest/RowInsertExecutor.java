...
/**
 * Executes INSERT INTO statements for row-based data using a local durable log and prepared store.
 *
 ...
 *   <li>Return {@link InsertResult} with state={@link InsertStatementState#ACCEPTED}</li>
 * </ol>
 *
