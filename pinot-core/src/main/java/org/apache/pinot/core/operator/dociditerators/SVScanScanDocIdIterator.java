...
public final class SVScanScanDocIdIterator implements ValueBasedScanDocIdIterator {
  ...
  public SVScanScanDocIdIterator(PredicateEvaluator predicateEvaluator, ForwardIndexReader reader, int numDocs) {
