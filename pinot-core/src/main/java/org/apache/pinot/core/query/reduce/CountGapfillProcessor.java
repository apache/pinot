...
///
/// [CountGapfillProcessor] is only applying the count aggregation function on the gapfilled result for each time
/// bucket.
///
/// [CountGapfillProcessor] is different from [GapfillProcessor] that [GapfillProcessor] will create
/// the gapfilled entries, but [CountGapfillProcessor] does not generate the gapfilled entries. It just updated
