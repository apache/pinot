...
public class InterSegmentAggregationMultiValueRawQueriesTest extends BaseMultiValueRawQueriesTest {
  ...
  public void testCountMV() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 519028L, 62480L, 400000L, expectedResultTableRows);
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 519028L, 124960L, 400000L,
  ...
  public void testDistinctCountRawHLLMV() {
    ...
    brokerResponse = getBrokerResponse(query + FILTER + SV_GROUP_BY);
    expectedResults[0] = 1296L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 519028L, 124960L, 400000L, expectedResultTableRows,
        cardinalityExtractor);
  ...
  public void testPercentileMV() {
    ...
    for (String query : queries) {
      ...
      brokerResponse = getBrokerResponse(query + FILTER);
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 519028L, 62480L, 400000L,
          expectedResultTableRows);
