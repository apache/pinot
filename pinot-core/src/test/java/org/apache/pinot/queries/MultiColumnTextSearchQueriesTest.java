 ...
 * Similar to TextSearchQueriesTest but uses a single Multi-Column text index.
 */
public class MultiColumnTextSearchQueriesTest extends BaseQueriesTest {
  ...
  private static MultiColumnTextIndexConfig getMultiColumnTextIndexConfig() {
    return new MultiColumnTextIndexConfig(
        ...
        Map.of(
            // originally was specific to SKILLS_TEXT_NO_RAW_NAME
        ...
        Map.of(
            ...
            SKILLS_TEXT_COL_MULTI_TERM_NAME,
            Map.of(FieldConfig.TEXT_INDEX_USE_AND_FOR_MULTI_TERM_QUERIES, "true"),
            SKILLS_TEXT_COL_DICT_NAME,
            Map.of(FieldConfig.TEXT_INDEX_STOP_WORD_EXCLUDE_KEY, "")
        ));
  }
  ...
  public void testTextSearch()
    ...
    //TODO: restore test case once config is supported
//    query =
...
//    testTextSearchSelectQueryHelper(query, expected.size(), false, expected);
  ...
  public void testInterSegment() {
    ...
    query =
        "SELECT count(*) FROM MyTable WHERE TEXT_MATCH(SKILLS_TEXT_COL, '\"IT support\" or \"IT manager\"')";
