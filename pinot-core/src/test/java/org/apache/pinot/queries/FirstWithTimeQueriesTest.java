...
public class FirstWithTimeQueriesTest extends BaseQueriesTest {
  ...
  public void testAggregationOnly() {
    String query = "SELECT FIRSTWITHTIME(boolColumn,timestampColumn, BOOLEAN),"
    ...
    assertEquals(((ValueLongPair<Integer>) aggregationResultsWithoutFilter.get(1)).getValue(), _expectedResultFirstInt);
    assertEquals(((ValueLongPair<Long>) aggregationResultsWithoutFilter.get(2)).getValue(), _expectedResultFirstLong);
    assertEquals(((ValueLongPair<Float>) aggregationResultsWithoutFilter.get(3)).getValue(), _expectedResultFirstFloat);
    ...
    Assert.assertEquals(Float.parseFloat(aggregationResults.get(3).getValue().toString()),
        _expectedResultFirstFloat.floatValue(), DELTA);
    Assert.assertEquals(Double.parseDouble(aggregationResults.get(4).getValue().toString()),
        _expectedResultFirstDouble.doubleValue(), DELTA);
  ...
  public void testAggregationOnlyNoDictionary() {
    String query =
        "SELECT FIRSTWITHTIME(boolNoDictColumn,timestampColumn,boolean),"
    ...
    Assert.assertEquals(Long.parseLong(aggregationResults.get(2).getValue().toString()),
        _expectedResultFirstLong.longValue());
    Assert.assertEquals(Float.parseFloat(aggregationResults.get(3).getValue().toString()),
        _expectedResultFirstFloat, DELTA);
    Assert.assertEquals(Double.parseDouble(aggregationResults.get(4).getValue().toString()),
        _expectedResultFirstDouble, DELTA);
    Assert.assertEquals(aggregationResults.get(5).getValue().toString(),
        _expectedResultFirstString);
  ...
  public void testAggregationGroupBySv() {
    String query =
        "SELECT FIRSTWITHTIME(boolColumn,timestampColumn,boolean),"
            + " FIRSTWITHTIME(intColumn,timestampColumn,int),"
            + " FIRSTWITHTIME(longColumn,timestampColumn,long),"
            + " FIRSTWITHTIME(floatColumn,timestampColumn,float),"
            + " FIRSTWITHTIME(doubleColumn,timestampColumn,double),"
            + " FIRSTWITHTIME(stringColumn,timestampColumn,string) FROM testTable GROUP BY intColumn";
  ...
  public void testAggregationGroupByMv() {
    String query =
        "SELECT FIRSTWITHTIME(boolColumn,timestampColumn,boolean),"
            ...
            + " FIRSTWITHTIME(floatColumn,timestampColumn,float),"
            + " FIRSTWITHTIME(doubleColumn,timestampColumn,double),"
            + " FIRSTWITHTIME(stringColumn,timestampColumn,string) FROM testTable GROUP BY intMvColumn";
  ...
  public void testAggregationGroupByMvNoDictionary() {
    String query =
        "SELECT FIRSTWITHTIME(boolNoDictColumn,timestampColumn,boolean),"
            ...
            + " FIRSTWITHTIME(floatNoDictColumn,timestampColumn,float),"
            + " FIRSTWITHTIME(doubleNoDictColumn,timestampColumn,double),"
            + " FIRSTWITHTIME(stringNoDictColumn,timestampColumn,string) FROM testTable GROUP BY intMvColumn";
