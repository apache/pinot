...
public class InterSegmentOrderByMultiValueQueriesTest extends BaseMultiValueQueriesTest {
  ...
  public Object[][] orderByDataProvider() {
    ...
    // aggregation in order by but not in selection
    query = "SELECT column5 FROM testTable GROUP BY column5 ORDER BY sumMV(column7) LIMIT 5";
    results = Lists
        .newArrayList(new Object[]{"NCoFku"}, new Object[]{"mhoVvrJm"},
            new Object[]{"JXRmGakTYafZFPm"}, new Object[]{"PbQd"},
            new Object[]{"OKyOqU"});
    ...
    results = Lists
        .newArrayList(new Object[]{2147483446.0}, new Object[]{2147483446.0},
            new Object[]{2147483443.0}, new Object[]{2147483436.0},
            new Object[]{2147483443.0}, new Object[]{2147483443.0},
            new Object[]{2147483446.0}, new Object[]{2147483438.0},
            new Object[]{2147483446.0});
    dataSchema = new DataSchema(new String[]{"minmaxrangemv(column7)"},
    ...
    query = "SELECT column5, DISTINCTCOUNTMV(column7) FROM testTable GROUP BY column5 ORDER BY distinctCountMV(column7) limit 5";
    results = Lists
