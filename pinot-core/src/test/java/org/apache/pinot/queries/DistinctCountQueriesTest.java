...
public class DistinctCountQueriesTest extends BaseQueriesTest {
  ...
  public void testAggregationOnly() {
    ...
    for (Object operator : Arrays.asList(getOperatorForSqlQuery(query), getOperatorForSqlQueryWithFilter(query))) {
      assertTrue(operator instanceof DataSourceBasedAggregationOperator);
      IntermediateResultsBlock resultsBlock = ((DataSourceBasedAggregationOperator) operator).nextBlock();
  ...
  public void testHLL() {
    ...
    assertTrue(operator instanceof DataSourceBasedAggregationOperator);
    aggregationResult = ((DataSourceBasedAggregationOperator) operator).nextBlock().getAggregationResult();
    assertNotNull(aggregationResult);
