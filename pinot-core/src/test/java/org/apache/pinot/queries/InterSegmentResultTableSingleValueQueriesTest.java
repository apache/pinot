...
public class InterSegmentResultTableSingleValueQueriesTest extends BaseSingleValueQueriesTest {
  ...
  public void testCount() {
    ...
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "64420"});
  ...
  public void testMax() {
    ...
    rows = new ArrayList<>();
    rows.add(new Object[]{"2146952047.00000", "2147419555.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 0L, 120000L, rows, expectedResultsSize, dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2146952047.00000", "999813884.00000"});
    QueriesTestUtils
    ...
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "2146952047.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
  ...
  public void testMin() {
    ...
    dataSchema = new DataSchema(new String[]{"min(column1)", "min(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"240528.00000", "17891.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 0L, 120000L, rows, expectedResultsSize, dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"101116473.00000", "20396372.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "min(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "17891.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "20396372.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testSum() {
    ...
    dataSchema = new DataSchema(new String[]{"sum(column1)", "sum(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"129268741751388.00000", "129156636756600.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"27503790384288.00000", "12429178874916.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "sum(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "69225631719808.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "8606725456500.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testAvg() {
    ...
    dataSchema = new DataSchema(new String[]{"avg(column1)", "avg(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1077239514.59490", "1076305306.30500"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"1121871038.68037", "506982332.96280"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "avg(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1642909995", "2141451242.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"438926263", "999309554.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testMinMaxRange() {
    ...
    dataSchema = new DataSchema(new String[]{"minmaxrange(column1)", "minmaxrange(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2146711519.00000", "2147401664.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 0L, 120000L, rows, expectedResultsSize, dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2045835574.00000", "979417512.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "minmaxrange(column1)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "2146711519.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "2044094181.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testDistinctCountHLL() {
    ...
    rows = new ArrayList<>();
    rows.add(new Object[]{"5977", "23825"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "distinctcounthll(column1)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "3592"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"296467636", "1324"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testDistinctCountRawHLL() {
    ...
    Function<Object, String> cardinalityExtractor =
    ...
    dataSchema = new DataSchema(new String[]{"distinctcountrawhll(column1)", "distinctcountrawhll(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.OBJECT, DataSchema.ColumnDataType.OBJECT});
    rows = new ArrayList<>();
    Object[] expectedRow0 = new Object[]{"5977", "23825"};
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    Object[] row0 = brokerResponse.getResultTable().getRows().get(0);
    Assert.assertEquals(cardinalityExtractor.apply(row0[0]), expectedRow0[0]);
    Assert.assertEquals(cardinalityExtractor.apply(row0[1]), expectedRow0[1]);

    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    expectedRow0 = new Object[]{"1886", "4492"};
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    expectedRow0 = new Object[]{"296467636", "3592"};
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    expectedRow0 = new Object[]{"296467636", "1324"};
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    row0 = brokerResponse.getResultTable().getRows().get(0);
  ...
  public void testPercentile50() {
    ...
    dataSchema = new DataSchema(new String[]{"percentile50(column1)", "percentile50(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1107310944.00000", "1080136306.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"1139674505.00000", "505053732.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentile90() {
    ...
    dataSchema = new DataSchema(new String[]{"percentile90(column1)", "percentile90(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1943040511.00000", "1936611145.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"1936730975.00000", "899534534.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "percentile90(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2101070986", "2147278341.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentile95() {
    ...
    dataSchema = new DataSchema(new String[]{"percentile95(column1)", "percentile95(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2071559385.00000", "2042409652.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2096857943.00000", "947763150.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "percentile95(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"147745543", "2147419555.00000"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentile99() {
    ...
    dataSchema = new DataSchema(new String[]{"percentile99(column1)", "percentile99(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.DOUBLE, DataSchema.ColumnDataType.DOUBLE});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2139354437.00000", "2125299552.00000"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2146232405.00000", "990669195.00000"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentileEst50() {
    ...
    dataSchema = new DataSchema(new String[]{"percentileest50(column1)", "percentileest50(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.LONG, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1107310944", "1082130431"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"1139674505", "509607935"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "percentileest50(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1642909995", "2141451242"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + GROUP_BY + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"438926263", "999309554"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  }
  ...
  public void testPercentileEst90() {
    ...
    dataSchema = new DataSchema(new String[]{"percentileest90(column1)", "percentileest90(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.LONG, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"1946157055", "1946157055"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"1939865599", "902299647"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "percentileest90(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2101070986", "2147278341"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentileEst95() {
    ...
    dataSchema = new DataSchema(new String[]{"percentileest95(column1)", "percentileest95(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.LONG, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2080374783", "2051014655"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2109734911", "950009855"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    dataSchema = new DataSchema(new String[]{"column9", "percentileest95(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.STRING, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"147745543", "2147419555"});
    expectedResultsSize = 10;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testPercentileEst99() {
    ...
    dataSchema = new DataSchema(new String[]{"percentileest99(column1)", "percentileest99(column3)"},
        new DataSchema.ColumnDataType[]{DataSchema.ColumnDataType.LONG, DataSchema.ColumnDataType.LONG});
    rows = new ArrayList<>();
    rows.add(new Object[]{"2143289343", "2143289343"});
    expectedResultsSize = 1;
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 120000L, 0L, 240000L, 120000L, rows, expectedResultsSize,
            dataSchema);
    ...
    brokerResponse = getBrokerResponseForQuery(query + getFilter(), queryOptions);
    rows = new ArrayList<>();
    rows.add(new Object[]{"2146232405", "991952895"});
    QueriesTestUtils
        .testInterSegmentResultTable(brokerResponse, 24516L, 336536L, 49032L, 120000L, rows, expectedResultsSize,
            dataSchema);
  ...
  public void testSelection() {
    ...
    brokerResponse = getBrokerResponseForQuery(query);
    selectionResults = brokerResponse.getSelectionResults();
    query = "SELECT column1, column3 FROM testTable ORDER BY column3 option(responseFormat=sql,preserveType=true)";
    brokerResponseSQL = getBrokerResponseForQuery(query);
    resultTable = brokerResponseSQL.getResultTable();
    Assert.assertEquals(resultTable.getDataSchema().getColumnNames().length, 2);
    Assert.assertEquals(resultTable.getDataSchema().getColumnNames(), new String[]{"column1", "column3"});
