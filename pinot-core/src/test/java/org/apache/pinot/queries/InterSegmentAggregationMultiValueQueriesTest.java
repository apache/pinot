...
public class InterSegmentAggregationMultiValueQueriesTest extends BaseMultiValueQueriesTest {
  ...
  public void testCountMV() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 400000L, 400000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResults[0] = 62480L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 455552L, 62480L, 400000L, expectedResultTableRows);
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 800000L, 400000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + svGroupBy);
    expectedResults[0] = 58440L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 455552L, 124960L, 400000L,
    ...
    expectedDataSchema = new DataSchema(new String[]{"daysSinceEpoch", "countmv(column6)"},
        new ColumnDataType[]{ColumnDataType.INT, ColumnDataType.LONG});
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1756015683, 426752L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 800000L, 400000L, expectedResultTableRows);
    ...
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{42144376392L, 426752L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 800000L, 400000L, expectedResultTableRows);
  }
  ...
  public void testMaxMV() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2147483647.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 0L, 400000L, expectedResultTableRows);
  ...
  public void testDistinctCountRawHLLMV() {
    ...
    brokerResponse = getBrokerResponse(query + FILTER + SV_GROUP_BY);
    expectedResults[0] = 1296L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 455552L, 124960L, 400000L, expectedResultTableRows,
        cardinalityExtractor);
  ...
  public void testPercentileMV() {
    ...
    for (String query : queries) {
      ...
      brokerResponse = getBrokerResponse(query + FILTER);
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 62480L, 455552L, 62480L, 400000L,
          expectedResultTableRows);
  ...
  public void testPercentileEstMV() {
    ...
    for (String query : queries) {
      ...
      DataSchema expectedDataSchema = new DataSchema(new String[]{"value"}, new ColumnDataType[]{ColumnDataType.LONG});
      ResultTableRows expectedResultTableRows =
          new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2147483647L}));
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 400000L, 0L, 400000L, 400000L, expectedResultTableRows);
  ...
  public void testFilteredAggregations() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{370236L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 370236L, 400000L, 0L, 400000L, expectedResultTableRows);
  }
