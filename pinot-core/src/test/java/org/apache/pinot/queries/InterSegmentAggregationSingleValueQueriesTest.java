...
public class InterSegmentAggregationSingleValueQueriesTest extends BaseSingleValueQueriesTest {
  ...
  public void testCount() {
    ...
    ResultTableRows expectedResultTableRows = new ResultTableRows(expectedDataSchema,
        Collections.singletonList(expectedResults));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResults[0] = 24516L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 0L, 120000L, expectedResultTableRows);
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 120000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + groupBy);
    expectedResults[0] = 17080L;
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 24516L, 120000L, expectedResultTableRows);
    ...
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(expectedResults));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);
  ...
  public void testMax() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146952047.0, 2147419555.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146952047.0, 999813884.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146952047.0, 2146630496.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146952047.0, 999813884.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testMin() {
    ...
    DataSchema expectedDataSchema =
        new DataSchema(new String[]{"v1", "v2"}, new ColumnDataType[]{ColumnDataType.DOUBLE, ColumnDataType.DOUBLE});
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{240528.0, 17891.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{101116473.0, 20396372.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query + FILTER + groupBy);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{101116473.0, 91804599.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testSum() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema,
    ...
    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(
            new Object[]{19058003631876.0, 8606725456500.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testAvg() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(
            new Object[]{1077239514.5949, 1076305306.305}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows,
        1e-5);
    ...
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(
            new Object[]{1121871038.68037, 506982332.96280}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows,
        1e-5);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2142595699.0, 334963174.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);
  ...
  public void testMinMaxRange() {
    ...
    DataSchema expectedDataSchema =
        new DataSchema(new String[]{"v1", "v2"}, new ColumnDataType[]{ColumnDataType.DOUBLE, ColumnDataType.DOUBLE});
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146711519.0, 2147401664.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2045835574.0, 979417512.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146711519.0, 2146612605.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2044094181.0, 979417512.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testDistinctCount() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{6582, 21910}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1872, 4556}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{3495, 11961}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1272, 3289}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testDistinctCountHLL() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{5977L, 23825L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1886L, 4492L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{3592L, 11889L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1324L, 3197L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testDistinctCountHLLPlus() {
    ...
    DataSchema expectedDataSchema =
        new DataSchema(new String[]{"v1", "v2"}, new ColumnDataType[]{ColumnDataType.LONG, ColumnDataType.LONG});
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{6595L, 21822L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1885L, 4545L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{3495L, 12031L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1273L, 3284L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testDistinctCountRawHLL() {
    ...
    Function<Object, Object> cardinalityExtractor =
        value -> ObjectSerDeUtils.HYPER_LOG_LOG_SER_DE.deserialize(BytesUtils.toBytes((String) value))
            .cardinality();
  ...
  public void testPercentile() {
    ...
    for (String query : queries) {
      BrokerResponseNative brokerResponse = getBrokerResponse(query);
      ResultTableRows expectedResultTableRows =
          new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1107310944.0, 1080136306.0}));
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

      brokerResponse = getBrokerResponse(query + FILTER);
      expectedResultTableRows =
          new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1139674505.0, 505053732.0}));
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L,
          expectedResultTableRows);

      brokerResponse = getBrokerResponse(query + GROUP_BY);
      expectedResultTableRows =
          new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146791843.0, 1418523221.0}));
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

      brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
      expectedResultTableRows =
          new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2142595699.0, 334963174.0}));
      QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L,
          expectedResultTableRows);
    }
    ...
    BrokerResponseNative brokerResponse = getBrokerResponse(query);
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1943040511.0, 1936611145.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1936730975.0, 899534534.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2071559385.0, 2042409652.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2096857943.0, 947763150.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2139354437.0, 2125299552.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146232405.0, 990669195.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146232405.0, 990259756.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testPercentileEst() {
    ...
    DataSchema expectedDataSchema =
        new DataSchema(new String[]{"v1", "v2"}, new ColumnDataType[]{ColumnDataType.LONG, ColumnDataType.LONG});
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1107310944L, 1082130431L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1139674505L, 509607935L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146791843L, 1418523221L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2142595699L, 334963174L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1946157055L, 1946157055L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1939865599L, 902299647L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2080374783L, 2051014655L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2109734911L, 950009855L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2143289343L, 2143289343L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 240000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146232405L, 991952895L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);
    ...
    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146232405L, 993001471L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testPercentileKLL() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L,
        240000L, 120000L, expectedResultTableRows, PERCENTILE_KLL_DELTA);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{1139674505L, 509607935L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L,
        49032L, 120000L, expectedResultTableRows, PERCENTILE_KLL_DELTA);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2146791843L, 1418523221L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L,
        360000L, 120000L, expectedResultTableRows, PERCENTILE_KLL_DELTA);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(new Object[]{2142595699L, 334963174L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L,
        73548L, 120000L, expectedResultTableRows, PERCENTILE_KLL_DELTA);
  ...
  public void testDistinctSum() {
    ...
    ResultTableRows expectedResultTableRows =
        new ResultTableRows(expectedDataSchema, Collections.singletonList(
            new Object[]{7074556592262.0, 23553878404013.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{2062916453604.0,
        2334011146274.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{3745055692019.0,
        12836683389098.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1397706323624.0,
        1686328722268.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 73548L, 120000L, expectedResultTableRows);
  }
  ...
  public void testDistinctAvg() {
    ...
    DataSchema expectedDataSchema =
        new DataSchema(new String[]{"v1", "v2"}, new ColumnDataType[]{ColumnDataType.DOUBLE, ColumnDataType.DOUBLE});
    ResultTableRows expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1074833879.1039197, 1075028681.150753}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 0L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + FILTER);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{1101985285.0448718, 512293930.26207197}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 252256L, 49032L, 120000L, expectedResultTableRows);

    brokerResponse = getBrokerResponse(query + GROUP_BY);
    expectedResultTableRows = new ResultTableRows(expectedDataSchema, Collections.singletonList(
        new Object[]{2142595699.0, 334963174.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 120000L, 0L, 360000L, 120000L, expectedResultTableRows);
