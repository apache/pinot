...
public class InterSegmentAggregationSingleValueQueriesTest extends BaseSingleValueQueriesTest {
  ...
  public void testCount() {
    ...
    QueriesTestUtils
        .testInterSegmentAggregationResult(brokerResponse, 24516L, 320600L, 0L, 120000L, new String[]{"24516"});
    ...
    QueriesTestUtils
        .testInterSegmentAggregationResult(brokerResponse, 24516L, 320600L, 24516L, 120000L, new String[]{"17080"});
  }
  ...
  public void testMax() {
    ...
    brokerResponse = getBrokerResponseForPqlQueryWithFilter(query + GROUP_BY);
    QueriesTestUtils.testInterSegmentAggregationResult(brokerResponse, 24516L, 320600L, 73548L, 120000L,
        new String[]{"2146952047.00000", "999813884.00000"});
  }
  ...
  public void testDistinctCountRawHLL() {
    ...
    brokerResponse = getBrokerResponseForPqlQueryWithFilter(query);
    QueriesTestUtils
        .testInterSegmentAggregationResult(brokerResponse, 24516L, 320600L, 49032L, 120000L, cardinalityExtractor,
            new String[]{"1886", "4492"});
    ...
    brokerResponse = getBrokerResponseForPqlQueryWithFilter(query + GROUP_BY);
    QueriesTestUtils
        .testInterSegmentAggregationResult(brokerResponse, 24516L, 320600L, 73548L, 120000L, cardinalityExtractor,
            new String[]{"1324", "3197"});
  }
