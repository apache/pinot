...
public class InterSegmentAggregationSingleValueQueriesTest extends BaseSingleValueQueriesTest {
  ...
  public void testCount() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 235112L, 0L, 120000L, expectedResultTable);
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 235112L, 24516L, 120000L, expectedResultTable);
  ...
  public void testMax() {
    ...
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 235112L, 49032L, 120000L, expectedResultTable);
    ...
    expectedResultTable =
        new ResultTable(expectedDataSchema, List.<Object[]>of(new Object[]{2146952047.0, 999813884.0}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 235112L, 73548L, 120000L, expectedResultTable);
  }
  ...
  public void testPercentileKLL() {
    ...
    expectedResultTable =
        new ResultTable(expectedDataSchema, List.<Object[]>of(new Object[]{1139674505L, 509607935L}));
    QueriesTestUtils.testInterSegmentsResult(brokerResponse, 24516L, 235112L,
