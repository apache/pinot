...
/// Tests exact percentile aggregation below the smart t-digest conversion threshold.
/// Inherits per-class segment state and runs test methods sequentially.
public class PercentileSmartTDigestHighThresholdAggregationFunctionTest
