...
public class GenerateArrayTransformFunctionTest {
  ...
  public void testGenerateIntArrayTransformFunction() {
    ...
    for (int j : inputArray) {
      arrayExpressions.add(ExpressionContext.forLiteralContext(DataType.INT, j));
    }
  ...
  public void testGenerateLongArrayTransformFunction() {
    ...
    int[] inputArray = {0, 10, 1};
    for (int j : inputArray) {
      arrayExpressions.add(ExpressionContext.forLiteralContext(DataType.LONG, (long) j));
    }
  ...
  public void testGenerateFloatArrayTransformFunction() {
    ...
    int[] inputArray = {0, 10, 1};
    for (int j : inputArray) {
      arrayExpressions.add(ExpressionContext.forLiteralContext(DataType.FLOAT, (float) j));
    }
  ...
  public void testGenerateDoubleArrayTransformFunction() {
    ...
    int[] inputArray = {0, 10, 1};
    for (int j : inputArray) {
      arrayExpressions.add(ExpressionContext.forLiteralContext(DataType.DOUBLE, (double) j));
    }
