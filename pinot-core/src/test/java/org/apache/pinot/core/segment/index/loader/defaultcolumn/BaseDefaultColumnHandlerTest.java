...
public class BaseDefaultColumnHandlerTest {
  ...
  private SegmentMetadataImpl consumingSegmentMetadata;
  ...
  public void setUp()
    ...
    consumingSegmentMetadata =
        new SegmentMetadataImpl(new RealtimeSegmentZKMetadata(), committedSegmentMetadata.getSchema());
  }
  ...
  public void testComputeDefaultColumnActionMapForCommittedSegment() {
    ...
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema0, committedSegmentMetadata),
    ...
    Schema schema1 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema1, committedSegmentMetadata),
    ...
    Schema schema2 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema2, committedSegmentMetadata),
        ImmutableMap.of("column11", DefaultColumnAction.ADD_DIMENSION));
    ...
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema3, committedSegmentMetadata),
    ...
    Schema schema4 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema4, committedSegmentMetadata),
        Collections.EMPTY_MAP);
    ...
    Schema schema5 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema5, committedSegmentMetadata),
        Collections.EMPTY_MAP);
  }
  ...
  public void testComputeDefaultColumnActionMapForConsumingSegment() {
    ...
    Schema schema0 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema0, consumingSegmentMetadata),
        Collections.EMPTY_MAP);
    ...
    Schema schema1 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema1, consumingSegmentMetadata),
        ImmutableMap.of("column11", DefaultColumnAction.ADD_DIMENSION));
    ...
    Schema schema2 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema2, consumingSegmentMetadata),
        ImmutableMap.of("column11", DefaultColumnAction.ADD_DIMENSION));
    ...
    Schema schema3 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT)
            .addMetric("column11", FieldSpec.DataType.INT).build(); // add column11
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema3, consumingSegmentMetadata),
        ImmutableMap.of("column11", DefaultColumnAction.ADD_METRIC));
    ...
    Schema schema4 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema4, consumingSegmentMetadata),
        ImmutableMap.of("column2", DefaultColumnAction.REMOVE_DIMENSION));
    ...
    Schema schema5 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema5, consumingSegmentMetadata),
        ImmutableMap.of("column2", DefaultColumnAction.UPDATE_DIMENSION_DATA_TYPE));
    ...
    Schema schema6 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    Assert.assertEquals(BaseDefaultColumnHandler.computeDefaultColumnActionMap(schema6, consumingSegmentMetadata),
        ImmutableMap.of("column6", DefaultColumnAction.UPDATE_DIMENSION_NUMBER_OF_VALUES));
  }
}
