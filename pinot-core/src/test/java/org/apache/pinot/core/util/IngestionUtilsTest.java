...
public class IngestionUtilsTest {
  ...
  public void testExtractFieldsSchema() {
    ...
    List<String> extract = new ArrayList<>(IngestionUtils.getFieldsForRecordExtractor(tableConfig.getIngestionConfig(), schema));
  ...
  public void testExtractFieldsIngestionConfig() {
    ...
    IngestionConfig ingestionConfig = new IngestionConfig(new FilterConfig("Groovy({x > 100}, x)"));
