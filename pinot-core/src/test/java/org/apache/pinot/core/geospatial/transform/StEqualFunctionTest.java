...
public class StEqualFunctionTest extends GeoFunctionTest {
  ...
  public void testEquals()  throws Exception {
    ...
    assertRelation("ST_Equals", "MULTILINESTRING ((1 1, 5 1), (2 4, 4 4))",
        "MULTILINESTRING ((1 1, 5 1), (2 4, 4 4))", true);
    assertRelation("ST_Equals", "POLYGON ((0 0, 0 4, 4 4, 4 0, 0 0))", "POLYGON ((0 0, 0 4, 4 4, 4 0, 0 0))",
        true);
