...
public class InvertedIndexDistinctOperatorUnitTest {
  ...
  @Test
  public void testScanFallbackDoesNotMaterializeBitmapForCountOptimizedFilter() {
    ...
    try {
      DistinctResultsBlock resultsBlock =
          new InvertedIndexDistinctOperator(indexSegment, new SegmentContext(indexSegment), queryContext,
              new CountOptimizedFilterOperator(10, 5), dataSource).nextBlock();
  ...
  private static final class CountOptimizedFilterOperator extends BaseFilterOperator {
