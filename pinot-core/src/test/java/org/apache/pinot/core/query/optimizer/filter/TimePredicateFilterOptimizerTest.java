...
public class TimePredicateFilterOptimizerTest {
  ...
  public void testTimeConvert() {
    ...
    // Other output format
    testPredicateFilterOptimizer("timeConvert(col, 'MILLISECONDS', 'SECONDS') > 1620830760",
        new Range(1620830761000L, true, null, false));
    testPredicateFilterOptimizer("timeConvert(col, 'MILLISECONDS', 'MINUTES') < 27015286",
        new Range(null, false, 1620917160000L, false));
    testPredicateFilterOptimizer("timeConvert(col, 'MILLISECONDS', 'HOURS') BETWEEN 450230 AND 450254",
    ...
    // Other input format
    testPredicateFilterOptimizer("timeConvert(col, 'MINUTES', 'SECONDS') > 1620830760",
        new Range(27013846L, false, null, false));
    testPredicateFilterOptimizer("timeConvert(col, 'HOURS', 'MINUTES') < 27015286",
        new Range(null, false, 450254L, true));
    testPredicateFilterOptimizer("timeConvert(col, 'DAYS', 'HOURS') BETWEEN 450230 AND 450254",
        new Range(18759L, false, 18760L, true));
    testPredicateFilterOptimizer("timeConvert(col, 'SECONDS', 'DAYS') = 18759",
  ...
  public void testEpochToEpochDateTimeConvert() {
    ...
    // Other output format
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MILLISECONDS:EPOCH', '1:MINUTES:EPOCH', '30:MINUTES')"
            + " > 27013846",
        new Range(1620831600000L, true, null, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MILLISECONDS:EPOCH', '10:MINUTES:EPOCH', '30:MINUTES') "
            + "< 2701528",
        new Range(null, false, 1620918000000L, false));
    testPredicateFilterOptimizer(
    ...
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MILLISECONDS:EPOCH', '30:MINUTES:EPOCH', '30:MINUTES') "
            + "> 900462",
        new Range(1620833400000L, true, null, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MILLISECONDS:EPOCH', '1:HOURS:EPOCH', '30:MINUTES') < 450255",
        new Range(null, false, 1620918000000L, false));
    testPredicateFilterOptimizer(
    ...
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MILLISECONDS:EPOCH', '1:DAYS:EPOCH', '30:MINUTES') = 18759",
        new Range(1620777600000L, true, 1620864000000L, false));

    // Other input format
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:SECONDS:EPOCH', '1:MINUTES:EPOCH', '30:MINUTES') > 27013846",
        new Range(1620831600L, true, null, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MINUTES:EPOCH', '10:MINUTES:EPOCH', '30:MINUTES') < 2701528",
    ...
    testPredicateFilterOptimizer(
        ...
        new Range(18759L, false, 18760L, true));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:SECONDS:EPOCH', '30:MINUTES:EPOCH', '30:MINUTES') > 900462",
        new Range(1620833400L, true, null, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:MINUTES:EPOCH', '1:HOURS:EPOCH', '30:MINUTES') < 450255",
        new Range(null, false, 27015300L, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:DAYS:EPOCH', '1:DAYS:EPOCH', '30:MINUTES') "
            + "BETWEEN 18759 AND 18760",
        new Range(18759L, true, 18761L, false));
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:DAYS:EPOCH', '1:DAYS:EPOCH', '30:MINUTES') = 18759",
  ...
  public void testSDFToEpochDateTimeConvert() {
    ...
    testPredicateFilterOptimizer("dateTimeConvert(col, '1:SECONDS:SIMPLE_DATE_FORMAT:yyyy-MM-dd HH:mm:ss', "
  ...
  /**
   * Helper method to test optimizing TIME_CONVERT/DATE_TIME_CONVERT/DATE_TRUNC on the given filter.
   */
  private void testPredicateFilterOptimizer(String filterString, Range expectedRange) {
    Expression originalExpression = CalciteSqlParser.compileToExpression(filterString);
    Expression optimizedFilterExpression = OPTIMIZER.optimize(CalciteSqlParser.compileToExpression(filterString));
