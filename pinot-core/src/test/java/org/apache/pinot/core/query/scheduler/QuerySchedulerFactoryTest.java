...
public class QuerySchedulerFactoryTest {
  ...
  public void testQuerySchedulerFactory() {
    ...
    QueryScheduler queryScheduler = QuerySchedulerFactory.create(config, instanceId, queryExecutor, latestQueryTime);
    ...
    queryScheduler = QuerySchedulerFactory.create(config, instanceId, queryExecutor, latestQueryTime);
