...
public class ArrayFunctionsTest {
  ...
  public Object[][] arrayFunctionsDataProvider() {
    ...
    inputs.add(new Object[]{
        "array_reverse_int(integerArray)", Collections.singletonList("integerArray"), row, new int[]{12, 1, 6, 10, 2, 3}
    });
    inputs.add(new Object[]{
        "array_reverse_int(stringArray)", Collections.singletonList("stringArray"), row, new int[]{12, 1, 6, 10, 2, 3}
    });

    inputs.add(new Object[]{
        "array_reverse_string(intArray)", Collections.singletonList("intArray"), row,
        new String[]{"12", "1", "6", "10", "2", "3"}
    });
    inputs.add(new Object[]{
        "array_reverse_string(integerArray)", Collections.singletonList("integerArray"), row,
        new String[]{"12", "1", "6", "10", "2", "3"}
    });
    inputs.add(new Object[]{
        "array_reverse_string(stringArray)", Collections.singletonList("stringArray"), row,
        new String[]{"12", "1", "6", "10", "2", "3"}
    });

    inputs.add(new Object[]{
        "array_sort_int(intArray)", Collections.singletonList("intArray"), row, new int[]{1, 2, 3, 6, 10, 12}
    });
    inputs.add(new Object[]{
        "array_sort_int(integerArray)", Collections.singletonList("integerArray"), row, new int[]{1, 2, 3, 6, 10, 12}
    });
    inputs.add(new Object[]{
        "array_sort_int(stringArray)", Collections.singletonList("stringArray"), row, new int[]{1, 2, 3, 6, 10, 12}
    });

    inputs.add(new Object[]{
        "array_sort_string(intArray)", Collections.singletonList("intArray"), row,
        new String[]{"1", "10", "12", "2", "3", "6"}
    });
    inputs.add(new Object[]{
        "array_sort_string(integerArray)", Collections.singletonList("integerArray"), row,
        new String[]{"1", "10", "12", "2", "3", "6"}
    });
    inputs.add(new Object[]{
        "array_sort_string(stringArray)", Collections.singletonList("stringArray"), row,
        new String[]{"1", "10", "12", "2", "3", "6"}
    });
    ...
    inputs.add(new Object[]{
        "array_distinct_int(intArray)", Collections.singletonList("intArray"), row, new int[]{3, 2, 10, 6, 1, 12}
    });
    inputs.add(new Object[]{
        "array_distinct_int(integerArray)", Collections.singletonList("integerArray"), row,
        new int[]{3, 2, 10, 6, 1, 12}
    });
    inputs.add(new Object[]{
        "array_distinct_string(stringArray)", Collections.singletonList("stringArray"), row,
        new String[]{"3", "2", "10", "6", "1", "12"}
    });

    inputs.add(new Object[]{
        "array_remove_int(intArray, 2)", Collections.singletonList("intArray"), row, new int[]{3, 10, 6, 1, 12}
    });
    inputs.add(new Object[]{
        "array_remove_int(integerArray, 2)", Collections.singletonList("integerArray"), row, new int[]{3, 10, 6, 1, 12}
    });
    inputs.add(new Object[]{
        "array_remove_string(stringArray, 2)", Collections.singletonList("stringArray"), row,
