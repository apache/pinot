...
public class DistinctEarlyTerminationContextTest {
  ...
  @Test
  public void testSetTimeSupplierPreservesRemainingBudget() {
    AtomicLong time1 = new AtomicLong(100);
    LongSupplier supplier1 = time1::get;
    AtomicLong time2 = new AtomicLong(1000);
    LongSupplier supplier2 = time2::get;

    DistinctEarlyTerminationContext context = new DistinctEarlyTerminationContext();
    context.setTimeSupplier(supplier1);
    context.setRemainingTimeNanos(10);

    time1.set(105);
    context.setTimeSupplier(supplier2);
    assertEquals(context.getRemainingTimeNanos(), 5);
