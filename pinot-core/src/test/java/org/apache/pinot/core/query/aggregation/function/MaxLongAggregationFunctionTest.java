...
public class MaxLongAggregationFunctionTest extends AbstractAggregationFunctionTest {
  ...
  void aggregationGroupByMV(DataTypeScenario scenario) {
    FluentQueryTest.withBaseDir(_baseDir)
        ...
        .whenQueryWithNullHandlingEnabled("select tags, maxlong(value) from testTable group by tags order by tags")
        .thenResultIs(
            "STRING | LONG",
            "tag1    | -1",
            "tag2    | -1",
