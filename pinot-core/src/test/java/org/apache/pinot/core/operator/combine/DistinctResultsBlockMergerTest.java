...
public class DistinctResultsBlockMergerTest {
  ...
  public void shouldStopOnTimeLimitAcrossSegments() {
...

    {
      ...
      timedOut.setEarlyTerminationReason(BaseResultsBlock.EarlyTerminationReason.TIME_LIMIT);
...

    {
      ...
      assertEquals(merged.getEarlyTerminationReason(), BaseResultsBlock.EarlyTerminationReason.TIME_LIMIT);
  ...
  public void shouldStopOnTimeLimitBudgetAcrossSegments() {
...

    {
      ...
      assertEquals(block.getEarlyTerminationReason(), BaseResultsBlock.EarlyTerminationReason.TIME_LIMIT);
    }
