...
public class DateTimeFunctionsTest {
  ...
  public Object[][] dateTimeFunctionsDataProvider() {
    ...
    inputs.add(new Object[]{
        "to_epoch_seconds_bucket(\"timestamp\", 10)", Lists.newArrayList("timestamp"), row1_2, 157868518L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochDaysBucket(sevenDaysSinceEpoch, 7)", Lists.newArrayList("sevenDaysSinceEpoch"), row5_1, 1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochHoursBucket(twoHoursSinceEpoch, 2)", Lists.newArrayList("twoHoursSinceEpoch"), row6_1, 1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochMinutes(minutesSinceEpoch)", Lists.newArrayList("minutesSinceEpoch"), row7_0, 1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochMinutesBucket(fifteenMinutesSinceEpoch, 15)", Lists.newArrayList("fifteenMinutesSinceEpoch"), row7_1,
        1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochSeconds(secondsSinceEpoch)", Lists.newArrayList("secondsSinceEpoch"), row8_0, 1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "fromEpochSecondsBucket(tenSecondsSinceEpoch, 10)", Lists.newArrayList("tenSecondsSinceEpoch"), row8_1,
        1209600000000L
    });
    ...
    inputs.add(new Object[]{
        "toEpochDays(fromEpochHours(hoursSinceEpoch))", Lists.newArrayList("hoursSinceEpoch"), row9_0, 14000L
    });
    ...
    inputs.add(new Object[]{
        ...
        Lists.newArrayList("fifteenSecondsSinceEpoch"), row9_1, 2016000L
    });
    ...
    inputs.add(new Object[]{
        "toDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", Lists.newArrayList("dateTime"), row10_1, "02/2009/13 23:31:30"
    });
    ...
    inputs.add(new Object[]{
        "toDateTime(dateTime, 'EEE MMM dd HH:mm:ss ZZZ yyyy')", Lists.newArrayList("dateTime"), row10_2,
    ...
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", Lists.newArrayList("dateTime"), row11_1, 1234539090000L
    });
    ...
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'EEE MMM dd HH:mm:ss ZZZ yyyy')", Lists.newArrayList("dateTime"), row11_2,
        1251142606000L
    });
