...
public class DateTimeFunctionsTest {
  ...
  public Object[][] dateTimeFunctionsDataProvider() {
    ...
    inputs.add(new Object[]{"round(\"timestamp\", 900000)", List.of("timestamp"), row00, 1578684600000L});

    // toEpochSeconds (with type conversion)
    GenericRow row10 = new GenericRow();
    row10.putValue("timestamp", 1578685189000.0);
    inputs.add(new Object[]{"toEpochSeconds(\"timestamp\")", List.of("timestamp"), row10, 1578685189L});

    // toEpochSeconds w/ rounding (with type conversion)
    GenericRow row11 = new GenericRow();
    row11.putValue("timestamp", "1578685189000");
    inputs.add(
        new Object[]{"toEpochSecondsRounded(\"timestamp\", 10)", List.of("timestamp"), row11, 1578685180L});
    ...
    inputs.add(
        new Object[]{"fromEpochHours(hoursSinceEpoch)", List.of("hoursSinceEpoch"), row60, 1209600000000L});

    // fromEpochHours w/ bucketing
    GenericRow row61 = new GenericRow();
    row61.putValue("twoHoursSinceEpoch", 168000);
    inputs.add(new Object[]{
        "fromEpochHoursBucket(twoHoursSinceEpoch, 2)", List.of(
    ...
    inputs.add(new Object[]{
        "fromEpochMinutes(minutesSinceEpoch)", List.of(
    ...
    inputs.add(new Object[]{
        "fromEpochMinutesBucket(fifteenMinutesSinceEpoch, 15)", List.of(
    ...
    inputs.add(new Object[]{
        "fromEpochSeconds(secondsSinceEpoch)", List.of(
    ...
    inputs.add(new Object[]{
        "fromEpochSecondsBucket(tenSecondsSinceEpoch, 10)", List.of(
    ...
    inputs.add(new Object[]{
        "toEpochDays(fromEpochHours(hoursSinceEpoch))", List.of(
    ...
    inputs.add(
        new Object[]{
            ...
            List.of("fifteenSecondsSinceEpoch"), row91, 2016000L
        });

    // toDateTime simple
    GenericRow row100 = new GenericRow();
    row100.putValue("dateTime", 98697600000L);
    inputs.add(new Object[]{"toDateTime(dateTime, 'yyyyMMdd')", List.of("dateTime"), row100, "19730216"});

    // toDateTime complex
    GenericRow row101 = new GenericRow();
    row101.putValue("dateTime", 1234567890000L);
    inputs.add(new Object[]{
        "toDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", List.of(
    ...
    inputs.add(new Object[]{
        "toDateTime(dateTime, 'EEE MMM dd HH:mm:ss ZZZ yyyy')", List.of(
    ...
    inputs.add(new Object[]{
        "toDateTime(dateTime, 'yyyy-MM-dd ZZZ', tz)", List.of("dateTime",
    ...
    inputs.add(
        new Object[]{"fromDateTime(dateTime, 'yyyyMMdd')", List.of("dateTime"), row110, 98668800000L});

    // fromDateTime complex
    GenericRow row111 = new GenericRow();
    row111.putValue("dateTime", "02/2009/13 15:31:30");
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'MM/yyyy/dd HH:mm:ss')", List.of(
    ...
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'EEE MMM dd HH:mm:ss ZZZ yyyy')", List.of(
    ...
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'yyyy-MM-dd''T''HH:mm:ss.SSS''Z''')", List.of("dateTime"), row113, null
    });
    ...
    inputs.add(new Object[]{
        "fromDateTime(dateTime, 'yyyy-MM-dd''T''HH:mm:ss.SSS''Z''', 'UTC', -1)", List.of("dateTime"),
        row114, -1L
    });
    ...
    inputs.add(new Object[]{"ago(duration)", List.of("duration"), row140, null});

    GenericRow row141 = new GenericRow();
    row141.putValue("timezoneId", null);
    inputs.add(new Object[]{"timezoneHour(timezoneId)", List.of("timezoneId"), row141, null});
  ...
  public void testDateTrunc() {
    ...
    List<String> arguments = List.of("epochMillis");
    ...
    arguments = List.of("epochSeconds");
    ...
    arguments = List.of("epochMinutes");
