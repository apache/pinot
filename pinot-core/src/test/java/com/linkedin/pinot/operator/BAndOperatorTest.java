...
public class BAndOperatorTest {
  ...
  public void simpleAndTest() {
    ...
    SingleBlockDataSource dsA = new SingleBlockDataSource(dataA, invertedIndexA, dictionaryA);
    ...
    SingleBlockDataSource dsB = new SingleBlockDataSource(dataB, invertedIndexB, dictionaryB);
