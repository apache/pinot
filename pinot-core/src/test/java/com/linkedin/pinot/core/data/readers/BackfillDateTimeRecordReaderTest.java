...
public class BackfillDateTimeRecordReaderTest {
  ...
  public Object[][] getDataForTestBackfillRecordReader() throws Exception {
    ...
    List<GenericRow> inputData = null;
    Schema inputSchema = null;
    TestRecordReader inputRecordReader = null;
    TimeFieldSpec timeFieldSpec = null;
    ...
    dateTimeFieldSpec = new DateTimeFieldSpec("timestampInEpoch", DataType.LONG, "1:MILLISECONDS:EPOCH", "1:HOURS", DateTimeType.PRIMARY);
    ...
    inputSchema = createPinotSchemaWithTimeSpec(timeFieldSpec);
    inputRecordReader = new TestRecordReader(inputData, inputSchema);
    dateTimeFieldSpec = new DateTimeFieldSpec("timestampInEpoch", DataType.LONG, "1:DAYS:SIMPLE_DATE_FORMAT:yyyyMMdd", "1:HOURS", DateTimeType.PRIMARY);
    wrapperSchema = createPinotSchemaWrapperWithDateTimeSpec(inputSchema, dateTimeFieldSpec);
    entries.add(new Object[] {
        inputRecordReader, timeFieldSpec, dateTimeFieldSpec, wrapperSchema
    });
    ...
    inputSchema = createPinotSchemaWithTimeSpec(timeFieldSpec);
    inputRecordReader = new TestRecordReader(inputData, inputSchema);
    dateTimeFieldSpec = new DateTimeFieldSpec("timestampInEpoch", DataType.LONG, "1:HOURS:EPOCH", "1:HOURS", DateTimeType.PRIMARY);
    wrapperSchema = createPinotSchemaWrapperWithDateTimeSpec(inputSchema, dateTimeFieldSpec);
    entries.add(new Object[] {
        inputRecordReader, timeFieldSpec, dateTimeFieldSpec, wrapperSchema
    });
    ...
    inputSchema = createPinotSchemaWithTimeSpec(timeFieldSpec);
    inputRecordReader = new TestRecordReader(inputData, inputSchema);
    dateTimeFieldSpec = new DateTimeFieldSpec("timestampInEpoch", DataType.LONG, "5:MILLISECONDS:EPOCH", "1:HOURS", DateTimeType.PRIMARY);
    wrapperSchema = createPinotSchemaWrapperWithDateTimeSpec(inputSchema, dateTimeFieldSpec);
    entries.add(new Object[] {
        inputRecordReader, timeFieldSpec, dateTimeFieldSpec, wrapperSchema
    });
    ...
    inputRecordReader = new TestRecordReader(inputData, inputSchema);
    entries.add(new Object[] {
        inputRecordReader, timeFieldSpec, dateTimeFieldSpec, inputSchema
    });
