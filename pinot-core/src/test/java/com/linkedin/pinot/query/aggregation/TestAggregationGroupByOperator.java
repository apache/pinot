...
public class TestAggregationGroupByOperator {
  ...
  public void testAggregationGroupBys() {
    ...
    MAggregationFunctionGroupByOperator aggregationFunctionGroupByOperator =
        new MAggregationFunctionGroupByOperator(_aggregationInfos.get(0), _groupBy, dataSourceOpsList);
    ...
    aggregationFunctionGroupByOperator =
        new MAggregationFunctionGroupByOperator(_aggregationInfos.get(1), _groupBy, dataSourceOpsList);
    aggregationFunctionGroupByOperatorList.add(aggregationFunctionGroupByOperator);
    ...
    dataSourceOpsList.add(_indexSegment.getDataSource("met_impressionCount", new UReplicatedDocIdSetOperator(
        docIdSetOperator)));
    aggregationFunctionGroupByOperator =
        new MAggregationFunctionGroupByOperator(_aggregationInfos.get(2), _groupBy, dataSourceOpsList);
    aggregationFunctionGroupByOperatorList.add(aggregationFunctionGroupByOperator);
    ...
    dataSourceOpsList.add(_indexSegment.getDataSource("met_impressionCount", new UReplicatedDocIdSetOperator(
        docIdSetOperator)));
    aggregationFunctionGroupByOperator =
        new MAggregationFunctionGroupByOperator(_aggregationInfos.get(3), _groupBy, dataSourceOpsList);
    aggregationFunctionGroupByOperatorList.add(aggregationFunctionGroupByOperator);
