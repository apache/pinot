...
/**
 * Unit test for the MaxAggregationFunction class.
...
public class MaxAggregationFunctionTest {
  ...
  /**
   * Tests the method that performs 'max' aggregation.
   */
  @Test
  void testAggregate() {
  ...
  /**
   * Tests the method that performs 'max' aggregation group-by.
   * - Input is randomly generated values that are assigned randomly generated group keys.
   * - Aggregation group-by performed using the 'MaxAggregationFunction', and compared against
