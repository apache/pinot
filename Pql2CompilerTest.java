...
public class Pql2CompilerTest {
  ...
  public void testMaxSelectionBehavior() {
        ...
        brokerRequest =
                COMPILER.compileToBrokerRequest("select * from vegetables LIMIT 1000001");
        Assert.assertEquals(brokerRequest.getLimit(), 100000);
        brokerRequest =
               COMPILER.compileToBrokerRequest("select * from vegetables LIMIT 1000000");
        Assert.assertEquals(brokerRequest.getLimit(), 100000);
