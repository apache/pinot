...
///
/// The CRC is exposed as a LONG, matching how it is stored everywhere else in Pinot. It reads as NULL for CONSUMING
/// segments, which have no CRC until they are committed. Grouping by `$segmentName` and `$crc` is a convenient way to
