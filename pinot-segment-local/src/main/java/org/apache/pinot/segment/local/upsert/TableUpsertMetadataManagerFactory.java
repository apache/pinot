...
public class TableUpsertMetadataManagerFactory {
  ...
  public static TableUpsertMetadataManager create(PinotConfiguration instanceUpsertConfig, TableConfig tableConfig,
      Schema schema, TableDataManager tableDataManager, SegmentOperationsThrottlerSet segmentOperationsThrottlerSet) {
    ...
    metadataManager.init(instanceUpsertConfig, tableConfig, schema, tableDataManager, segmentOperationsThrottlerSet);
