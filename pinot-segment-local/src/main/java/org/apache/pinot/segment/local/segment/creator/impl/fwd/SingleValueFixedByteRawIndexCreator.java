...
public class SingleValueFixedByteRawIndexCreator implements ForwardIndexCreator {
   ...
   * @throws IOException
   */
  public SingleValueFixedByteRawIndexCreator(File baseIndexDir, ChunkCompressionType compressionType, String column, int totalDocs,
      DataType valueType)
      throws IOException {
  ...
  public SingleValueFixedByteRawIndexCreator(File baseIndexDir, ChunkCompressionType compressionType, String column, int totalDocs,
    ...
    _indexWriter =
        new FixedByteChunkSVForwardIndexWriter(file, compressionType, totalDocs, NUM_DOCS_PER_CHUNK, valueType.size(), writerVersion);
