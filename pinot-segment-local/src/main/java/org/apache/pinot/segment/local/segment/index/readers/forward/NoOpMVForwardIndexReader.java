...
public class NoOpMVForwardIndexReader implements ForwardIndexReader<ForwardIndexReaderContext> {
  ...
  public int getDictIdMV(int docId, int[] dictIdBuffer, ForwardIndexReaderContext context) {
    throw new UnsupportedOperationException("Forward index is disabled, cannot read MV dictIds for docId list");
  }

  @Override
  public int[] getDictIdMV(int docId, ForwardIndexReaderContext context) {
    throw new UnsupportedOperationException("Forward index is disabled, cannot read MV dictIds for docId");
  }

  @Override
  public int getNumValuesMV(int docId, ForwardIndexReaderContext context) {
    throw new UnsupportedOperationException("Forward index is disabled, cannot get num MV values for docId");
  }
