...
///
/// The singleton [#DEFAULT] instance is pre-populated with all built-in codecs and is
/// immutable after class-loading; calling [#register()] on it will throw.
///
/// Custom registries (e.g. in tests) should be created with [#CodecRegistry()] and
/// populated via [#register()] before use.  The custom registry instance itself is not
