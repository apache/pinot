...
public final class FixedBitIntReaderWriterV2 implements Closeable {
  ...
  /// The difference between this and previous array based API [#readInt(int, int, int[])]
  ...
  ///
  /// [PinotDataBitSetV2] implements efficient bulk contiguous API
  /// [PinotDataBitSetV2#readInt(long, int, int[])]
