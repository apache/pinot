...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    builder.setStorageFormat(config
        .getString(V1Constants.MetadataKeys.Column.getKeyFor(column, V1Constants.MetadataKeys.Column.STORAGE_FORMAT),
  ...
  public static class Builder {
    ...
    public Builder setColumnName(String columnName) {
      ...
      this.storageFormat = V1Constants.Str.STORAGE_FORMAT_DEFAULT_VALUE; // Default storage format for any column.
      return this;
    }
    ...
    public ColumnMetadata build() {
      return new ColumnMetadata(columnName, cardinality, totalDocs, dataType, storageFormat, bitsPerElement, columnMaxLength,
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalDocs, DataType dataType, String storageFormat, int bitsPerElement,
  ...
  public boolean equals(Object object) {
    ...
    if (object instanceof ColumnMetadata) {
      ...
      boolean result =
          getColumnName() == columnMetadata.getColumnName() && getCardinality() == columnMetadata.getCardinality()
              && getTotalDocs() == columnMetadata.getTotalDocs() && getDataType().equals(columnMetadata.getDataType())
              && getStorageFormat().equals(columnMetadata.getStorageFormat()) && getBitsPerElement() == columnMetadata
              .getBitsPerElement() && getFieldSpec().equals(columnMetadata.getFieldSpec())
              && isSorted() == columnMetadata.isSorted() && hasNulls() == columnMetadata.hasNulls()
              && hasDictionary() == columnMetadata.hasDictionary() && hasInvertedIndex() == columnMetadata
              .hasInvertedIndex() && isSingleValue() == columnMetadata.isSingleValue() && isVirtual() == columnMetadata
              .isVirtual() && getMaxNumberOfMultiValues() == columnMetadata.getMaxNumberOfMultiValues()
              && getTotalNumberOfEntries() == columnMetadata.getTotalNumberOfEntries()
              && isAutoGenerated() == columnMetadata.isAutoGenerated() && getDefaultNullValueString()
              .equals(columnMetadata.getDefaultNullValueString()) && getTimeUnit() == (columnMetadata.getTimeUnit())
              && getPaddingCharacter() == columnMetadata.getPaddingCharacter() && minValue == (columnMetadata
              .getMinValue()) && maxValue == (columnMetadata.getMaxValue()) && getPartitionFunction() == (columnMetadata
