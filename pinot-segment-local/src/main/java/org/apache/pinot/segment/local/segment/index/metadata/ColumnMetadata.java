...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    builder.setHasDictionary(config.getBoolean(
    ...
    builder.setHasFSTIndex(config.getBoolean(
        V1Constants.MetadataKeys.Column.getKeyFor(column, V1Constants.MetadataKeys.Column.HAS_FST_INDEX), false));
    ...
    builder.setTextIndexType(config.getString(
        V1Constants.MetadataKeys.Column.getKeyFor(column, V1Constants.MetadataKeys.Column.TEXT_INDEX_TYPE),
    ...
    String dateTimeFormat = config.getString(
        V1Constants.MetadataKeys.Column.getKeyFor(column, V1Constants.MetadataKeys.Column.DATETIME_FORMAT), null);
  ...
  public boolean equals(Object object) {
    ...
    if (object instanceof ColumnMetadata) {
      ...
      return getColumnName() == columnMetadata.getColumnName() && getCardinality() == columnMetadata.getCardinality()
          ...
          && hasInvertedIndex() == columnMetadata.hasInvertedIndex()
          && isSingleValue() == columnMetadata.isSingleValue() && isVirtual() == columnMetadata.isVirtual()
          && getMaxNumberOfMultiValues() == columnMetadata.getMaxNumberOfMultiValues()
          && getTotalNumberOfEntries() == columnMetadata.getTotalNumberOfEntries()
          && isAutoGenerated() == columnMetadata.isAutoGenerated()
          && getDefaultNullValueString() == columnMetadata.getDefaultNullValueString()
          && getTimeUnit() == (columnMetadata.getTimeUnit())
          && getPaddingCharacter() == columnMetadata.getPaddingCharacter() && minValue == (columnMetadata.getMinValue())
          && maxValue == (columnMetadata.getMaxValue())
          && getPartitionFunction() == (columnMetadata.getPartitionFunction())
          && getNumPartitions() == columnMetadata.getNumPartitions()
          && getPartitions() == (columnMetadata.getPartitions())
          && getDateTimeFormat() == (columnMetadata.getDateTimeFormat())
          && getDateTimeGranularity() == (columnMetadata.getDateTimeGranularity())
          && hasFSTIndex() == columnMetadata.hasFSTIndex()
