...
public class DataTypeTransformer implements RecordTransformer {
  ...
  public void transform(GenericRow record) {
    for (Map.Entry<String, PinotDataType> entry : _dataTypes.entrySet()) {
      ...
      try {
        ...
        // Use the extracted utility method for conversion
  ...
  /**
   * Converts a value to the target PinotDataType following the same logic as the DataTypeTransformer.
   * This utility method can be reused by other components that need data type conversion without
   * requiring a GenericRow.
   *
  ...
  public static Object convertValue(Object value, PinotDataType dest, String columnName) {
    ...
    // Convert data type if necessary (same logic as DataTypeTransformer)
