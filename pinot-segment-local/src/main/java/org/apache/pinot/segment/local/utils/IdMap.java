...
public interface IdMap<Key> extends Closeable {
  ...
  ///
  ///   If key does not exist in the map, it is inserted into the map with a new id which is equal to number of
  ...
  ///
  ///   Returns [IdMap#INVALID_ID] if the key does not exist in the map.
  ///
