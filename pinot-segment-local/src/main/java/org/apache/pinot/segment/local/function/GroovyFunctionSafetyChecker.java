...
public class GroovyFunctionSafetyChecker implements GroovyCodeVisitor {
  ArrayList<String> _blockedMethods;

  public GroovyFunctionSafetyChecker() {
    _blockedMethods = new ArrayList<>(List.of("execute", "invoke"));
  }
