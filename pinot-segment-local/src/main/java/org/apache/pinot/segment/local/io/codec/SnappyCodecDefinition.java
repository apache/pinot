...
///
/// Snappy is a [CodecKind#COMPRESSION] stage. Compression stages may be chained after all
/// transforms.
///
...
final class SnappyCodecDefinition implements ChunkCodecHandler<SnappyCodecDefinition.Options> {
