...
public class ColumnarValueNormalizerTest {
  ...
  public void testNullVariantReturnsDefaultSentinelWithoutDecoding() {
    FieldSpec fieldSpec = new DimensionFieldSpec(COLUMN, DataType.VARIANT, true);

    Object result = ColumnarValueNormalizer.normalize(COLUMN, fieldSpec, PinotDataType.VARIANT, null);
