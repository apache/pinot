...
/**
 * Tests for T004: verify the {@code compressionStatsEnabled} flag propagates from
 * {@link TableConfig} through to {@link SegmentGeneratorConfig}.
 */
public class SegmentGeneratorConfigPropagationTest {

  /**
   * When {@code compressionStatsEnabled} is explicitly set to {@code true} on the
   * {@link TableConfig}'s indexing config, the resulting {@link SegmentGeneratorConfig}
  ...
  /**
   * When {@code compressionStatsEnabled} is never set on the {@link TableConfig}, the
   * resulting {@link SegmentGeneratorConfig} should default to {@code false}.
   */
  @Test
