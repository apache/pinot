...
public class CodecPipelineValidatorTest {
  ...
  // -------------------------------------------------------------------------
  // Valid: chaining — N typed-layout transforms → optional packing transform → N compressions
  // -------------------------------------------------------------------------

  /// Multiple typed-layout-preserving transforms may be chained, optionally followed by compression.
  @Test
  public void testMultipleTypedLayoutTransformsAllowed() {
  ...
  /// A typed-layout-preserving transform may precede a packing transform, which may precede compression(s).
  @Test
