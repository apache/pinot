...
public class CompressionCodecMigrationRoundtripTest implements PinotBuffersAfterMethodCheckRule {
  ...
  public static Object[][] legacyCodecs() {
    return new Object[][]{
        ...
        {CompressionCodec.DELTA, DataType.INT},
        {CompressionCodec.DELTA, DataType.LONG},
        {CompressionCodec.DELTADELTA, DataType.INT},
        {CompressionCodec.DELTADELTA, DataType.LONG},
    };
  }
