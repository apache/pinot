...
public class SegmentPreProcessorTest {
  ...
  private void validateIndex(ColumnIndexType indexType, String column, int cardinality, int bits, Schema schema,
    ...
    assertEquals(columnMetadata.forwardIndexDisabled(), forwardIndexDisabled);
  ...
  public void testForwardIndexDisabledOnNewColumnsSV()
    ...
    _indexLoadingConfig.setSortedColumns(new ArrayList<>(forwardIndexDisabledColumns));
    ...
    _indexLoadingConfig.setSortedColumns(existingSortedColumns);
