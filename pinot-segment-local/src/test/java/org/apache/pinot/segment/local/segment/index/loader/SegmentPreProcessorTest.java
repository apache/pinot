...
public class SegmentPreProcessorTest {
  ...
  public void testEnableFSTIndexOnExistingColumnRaw()
    ...
    constructV3Segment();
    SegmentPreProcessor v3Processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, _newColumnsSchema4);
    Assert.expectThrows(UnsupportedOperationException.class, () -> v3Processor.process());

    constructV1Segment();
    SegmentPreProcessor v1Processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, _newColumnsSchema4);
  ...
  private ColumnMetadata checkIndexCreation(ColumnIndexType indexType, String column, int cardinality, int bits,
      ...
      throws Exception {
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, schema)) {
      processor.process();
      SegmentMetadataImpl segmentMetadata = new SegmentMetadataImpl(_indexDir);
  ...
  private void checkInvertedIndexCreation(boolean reCreate)
    ...
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, null)) {
      processor.process();
    }
  ...
  public void testV1UpdateDefaultColumns()
    ...
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, _newColumnsSchema3)) {
      processor.process();
    }
  ...
  private void checkUpdateDefaultColumns()
    ...
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, _newColumnsSchema1)) {
      processor.process();
    }
    SegmentMetadataImpl segmentMetadata = new SegmentMetadataImpl(_indexDir);
    ...
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, _indexLoadingConfig, _newColumnsSchema2)) {
      processor.process();
    }
    segmentMetadata = new SegmentMetadataImpl(_indexDir);
  ...
  public void testColumnMinMaxValue()
    ...
    try (SegmentPreProcessor processor = new SegmentPreProcessor(_segmentDirectory, indexLoadingConfig, null)) {
      processor.process();
    }
    SegmentMetadataImpl segmentMetadata = new SegmentMetadataImpl(_indexDir);
