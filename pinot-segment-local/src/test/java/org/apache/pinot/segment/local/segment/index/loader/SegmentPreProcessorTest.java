...
public class SegmentPreProcessorTest {
  ...
  private static final String NEWLY_ADDED_STRING_MULTI_COL_RAW = "newTextColMultiRaw";
  private static final String NEWLY_ADDED_STRING_MULTI_COL_DICT = "newTextColMultiDict";
  ...
  public void testEnableTextIndexOnNewColumnRaw()
    ...
    textIndexColumns.add(NEWLY_ADDED_STRING_MULTI_COL_RAW);
    ...
    _indexLoadingConfig.getNoDictionaryColumns().add(NEWLY_ADDED_STRING_MULTI_COL_RAW);
    ...
    checkTextIndexCreation(NEWLY_ADDED_STRING_MULTI_COL_RAW, 1, 1, _newColumnsSchemaWithText, true, true, false, 4,
        false, 1);
  ...
  public void testEnableTextIndexOnNewColumnDictEncoded()
    ...
    textIndexColumns.add(NEWLY_ADDED_STRING_MULTI_COL_DICT);
    _indexLoadingConfig.setTextIndexColumns(textIndexColumns);
    ...
    checkTextIndexCreation(NEWLY_ADDED_STRING_MULTI_COL_DICT, 1, 1, _newColumnsSchemaWithText, true, true,
        false, 4, false, 1);
  ...
  private void checkTextIndexCreation(String column, int cardinality, int bits, Schema schema, boolean isAutoGenerated,
      boolean hasDictionary, boolean isSorted, int dictionaryElementSize, boolean isSingleValue, int maxNumberOfMultiValues)
      throws Exception {
    checkIndexCreation(ColumnIndexType.TEXT_INDEX, column, cardinality, bits, schema, isAutoGenerated, hasDictionary,
  ...
  private void checkIndexCreation(ColumnIndexType indexType, String column, int cardinality, int bits, Schema schema,
      boolean isAutoGenerated, boolean hasDictionary, boolean isSorted, int dictionaryElementSize, boolean isSingleValued,
