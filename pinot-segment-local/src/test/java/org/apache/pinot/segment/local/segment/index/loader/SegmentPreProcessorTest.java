...
public class SegmentPreProcessorTest {
  ...
  public void testForwardIndexDisabledOnExistingColumnDictEncoded()
    ...
    try {
      ...
      assertEquals(e.getMessage(), "Must enable dictionary for disabling the forward index on column: column5");
    }
    ...
    try {
      ...
      assertEquals(e.getMessage(), "Must enable inverted index for disabling the forward index on column: column5");
    }
  ...
  public void testForwardIndexDisabledOnExistingColumnRaw()
    ...
    try {
      ...
      assertEquals(e.getMessage(), "Must enable dictionary for disabling the forward index on column: column4");
    }
    ...
    try {
      ...
      assertEquals(e.getMessage(), "Must enable inverted index for disabling the forward index on column: column4");
    }
