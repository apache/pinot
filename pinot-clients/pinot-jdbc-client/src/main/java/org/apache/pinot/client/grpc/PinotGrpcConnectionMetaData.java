...
public class PinotGrpcConnectionMetaData extends AbstractBaseConnectionMetaData {
  private static final Logger LOGGER = LoggerFactory.getLogger(PinotGrpcConnectionMetaData.class);

  private final PinotGrpcConnection _connection;
  private final PinotControllerTransport _controllerTransport;
  private final String _controllerURL;

  public PinotGrpcConnectionMetaData(PinotGrpcConnection connection) {
    this(connection, null, null);
  }

  public PinotGrpcConnectionMetaData(PinotGrpcConnection connection, String controllerURL,
