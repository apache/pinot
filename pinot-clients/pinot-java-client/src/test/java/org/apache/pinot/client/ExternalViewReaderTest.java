...
public class ExternalViewReaderTest {
  ...
  public void testGetLiveBrokers() throws IOException {
    ...
    when(mockZkClient.readData(Mockito.anyString(), Mockito.anyBoolean())).thenReturn("json".getBytes());
  ...
  public void testGetLiveBrokersExceptionState() throws IOException {
    ...
    when(mockZkClient.readData(Mockito.anyString(), Mockito.anyBoolean())).thenThrow(IOException.class);
