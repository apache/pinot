...
/// [org.apache.pinot.client.ConnectionFactory] class' utility methods to create connections to a Pinot cluster
...
/// [org.apache.pinot.client.Connection#execute(String)] and
/// [org.apache.pinot.client.Connection#executeAsync(String)] methods of
...
/// ```
///
/// Queries can also use a [org.apache.pinot.client.PreparedStatement] to escape query parameters:
///
/// ```
...
/// ```
///
/// In the case of a selection query, results can be obtained with the various `get` methods in the first
/// [org.apache.pinot.client.ResultSet], obtained through the
/// [org.apache.pinot.client.ResultSetGroup#getResultSet(int)] method:
///
/// ```
...
/// [org.apache.pinot.client.ResultSet]:
///
/// ```
...
/// ```
///
/// There can be more than one [org.apache.pinot.client.ResultSet], each of which can contain multiple results
