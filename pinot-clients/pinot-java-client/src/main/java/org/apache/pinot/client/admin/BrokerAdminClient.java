...
public class BrokerAdminClient extends BaseServiceAdminClient {
  ...
  public <T> T getBrokers(@Nullable String state, Class<T> responseType)
      throws PinotAdminException {
    Map<String, String> queryParams = state != null ? Map.of("state", state) : null;
    JsonNode response = _transport.executeGet(_controllerAddress, "/brokers", queryParams, _headers);
    try {
      ...
      throw new PinotAdminException("Failed to deserialize brokers response", e);
    }
  }
  ...
  public <T> T getBrokerTenants(@Nullable String state, Class<T> responseType)
      throws PinotAdminException {
    Map<String, String> queryParams = state != null ? Map.of("state", state) : null;
    JsonNode response = _transport.executeGet(_controllerAddress, "/brokers/tenants", queryParams, _headers);
    try {
      ...
      throw new PinotAdminException("Failed to deserialize broker tenants response", e);
    }
  }
  ...
  public <T> T getBrokerTenant(String tenant, @Nullable String state, Class<T> responseType)
      throws PinotAdminException {
    Map<String, String> queryParams = state != null ? Map.of("state", state) : null;
    JsonNode response =
        _transport.executeGet(_controllerAddress, "/brokers/tenants/" + tenant, queryParams, _headers);
    try {
      ...
      throw new PinotAdminException("Failed to deserialize broker tenant response for tenant: " + tenant, e);
    }
  }
  ...
  public <T> T getBrokerTables(@Nullable String state, Class<T> responseType)
      throws PinotAdminException {
    Map<String, String> queryParams = state != null ? Map.of("state", state) : null;
    JsonNode response = _transport.executeGet(_controllerAddress, "/brokers/tables", queryParams, _headers);
    try {
      ...
      throw new PinotAdminException("Failed to deserialize broker tables response", e);
    }
  }
  ...
  public <T> T getBrokerTable(String tableName, @Nullable String tableType, @Nullable String state,
    ...
    try {
      ...
      throw new PinotAdminException("Failed to deserialize broker table response for table: " + tableName, e);
    }
  }
}
