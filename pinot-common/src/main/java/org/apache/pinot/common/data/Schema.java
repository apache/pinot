 ...
 * ({@link DimensionFieldSpec}, {@link org.apache.pinot.common.data.MetricFieldSpec},
...
public final class Schema {
   ...
   * <ul>
   *   <li>For dimension, time, date time fields, support {@link FieldSpec.DataType}: INT, LONG, FLOAT, DOUBLE, STRING</li>
   *   <li>For non-derived metric fields, support {@link FieldSpec.DataType}: INT, LONG, FLOAT, DOUBLE</li>
   * </ul>
   *
  ...
  public static class SchemaBuilder {
    ...
    public SchemaBuilder addMetric(@Nonnull String name, @Nonnull FieldSpec.DataType dataType, int fieldSize,
    ...
    public SchemaBuilder addTime(@Nonnull String incomingName, @Nonnull TimeUnit incomingTimeUnit,
        @Nonnull FieldSpec.DataType incomingDataType) {
      _schema.addField(new TimeFieldSpec(incomingName, incomingDataType, incomingTimeUnit));
      return this;
    }

    public SchemaBuilder addTime(@Nonnull String incomingName, @Nonnull TimeUnit incomingTimeUnit,
        @Nonnull FieldSpec.DataType incomingDataType, @Nonnull Object defaultNullValue) {
      _schema.addField(new TimeFieldSpec(incomingName, incomingDataType, incomingTimeUnit, defaultNullValue));
      return this;
    }

    public SchemaBuilder addTime(@Nonnull String incomingName, @Nonnull TimeUnit incomingTimeUnit,
        @Nonnull FieldSpec.DataType incomingDataType, @Nonnull String outgoingName, @Nonnull TimeUnit outgoingTimeUnit,
        @Nonnull FieldSpec.DataType outgoingDataType) {
      _schema.addField(
    ...
    public SchemaBuilder addTime(@Nonnull String incomingName, @Nonnull TimeUnit incomingTimeUnit,
        @Nonnull FieldSpec.DataType incomingDataType, @Nonnull String outgoingName, @Nonnull TimeUnit outgoingTimeUnit,
        @Nonnull FieldSpec.DataType outgoingDataType, @Nonnull Object defaultNullValue) {
      _schema.addField(
          new TimeFieldSpec(incomingName, incomingDataType, incomingTimeUnit, outgoingName, outgoingDataType,
    ...
    public SchemaBuilder addTime(@Nonnull String incomingName, int incomingTimeUnitSize,
        @Nonnull TimeUnit incomingTimeUnit, @Nonnull FieldSpec.DataType incomingDataType) {
      _schema.addField(new TimeFieldSpec(incomingName, incomingDataType, incomingTimeUnitSize, incomingTimeUnit));
      return this;
    }

    public SchemaBuilder addTime(@Nonnull String incomingName, int incomingTimeUnitSize,
        @Nonnull TimeUnit incomingTimeUnit, @Nonnull FieldSpec.DataType incomingDataType, @Nonnull Object defaultNullValue) {
      _schema.addField(
    ...
    public SchemaBuilder addTime(@Nonnull String incomingName, int incomingTimeUnitSize,
        @Nonnull TimeUnit incomingTimeUnit, @Nonnull FieldSpec.DataType incomingDataType, @Nonnull String outgoingName,
        int outgoingTimeUnitSize, @Nonnull TimeUnit outgoingTimeUnit, @Nonnull FieldSpec.DataType outgoingDataType) {
      _schema.addField(
    ...
    public SchemaBuilder addDateTime(@Nonnull String name, @Nonnull FieldSpec.DataType dataType, @Nonnull String format,
