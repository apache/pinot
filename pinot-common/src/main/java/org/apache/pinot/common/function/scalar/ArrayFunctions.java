...
public class ArrayFunctions {
  ...
  /**
   * Returns the cardinality (number of unique values) of the array. This is the standard SQL function name.
   */
  @ScalarFunction
  public static long cardinalityInt(int[] arr) {
    ...
    return new IntLinkedOpenHashSet(arr).size();
  }
  ...
  public static long cardinalityFloat(float[] arr) {
    ...
    ObjectSet<Float> set = new ObjectLinkedOpenHashSet<>();
    for (float value : arr) {
      set.add(value);
    }
    return set.size();
  ...
  public static long cardinalityDouble(double[] arr) {
    ...
    ObjectSet<Double> set = new ObjectLinkedOpenHashSet<>();
  ...
  public static long cardinalityString(String[] arr) {
    ...
    return new ObjectLinkedOpenHashSet<>(arr).size();
  }
