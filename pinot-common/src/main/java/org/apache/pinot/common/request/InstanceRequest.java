...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.15.0)", date = "2023-11-08")
public class InstanceRequest implements org.apache.thrift.TBase<InstanceRequest, InstanceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<InstanceRequest> {
  ...
  private static final org.apache.thrift.protocol.TField OPTIONAL_SEGMENTS_FIELD_DESC = new org.apache.thrift.protocol.TField("optionalSegments", org.apache.thrift.protocol.TType.SET, (short)6);
  ...
  private @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.String> optionalSegments; // optional
  ...
  public InstanceRequest(InstanceRequest other) {
    ...
    if (other.isSetOptionalSegments()) {
      java.util.Set<java.lang.String> __this__optionalSegments = new java.util.HashSet<java.lang.String>(other.optionalSegments);
  ...
  public void addToOptionalSegments(java.lang.String elem) {
    if (this.optionalSegments == null) {
      this.optionalSegments = new java.util.HashSet<java.lang.String>();
    }
    this.optionalSegments.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Set<java.lang.String> getOptionalSegments() {
    return this.optionalSegments;
  }

  public void setOptionalSegments(@org.apache.thrift.annotation.Nullable java.util.Set<java.lang.String> optionalSegments) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case OPTIONAL_SEGMENTS:
      if (value == null) {
        ...
        setOptionalSegments((java.util.Set<java.lang.String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.optionalSegments = new java.util.HashSet<java.lang.String>(2*_set3.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InstanceRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.optionalSegments != null) {
        if (struct.isSetOptionalSegments()) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.optionalSegments.size()));
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.optionalSegments = new java.util.HashSet<java.lang.String>(2*_set13.size);
