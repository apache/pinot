...
public class ZKMetadataProvider {
  ...
  private static final String PROPERTYSTORE_DATASET_PREFIX = "/CONFIGS/DATASET";

  private static final String PROPERTYSTORE_DATASET_METADATA_ZNODE = "metadata";
  ...
  public static String constructPropertyStorePathForDatasetMetadata(String datasetNameWithType) {
    return StringUtil
        .join("/", PROPERTYSTORE_DATASET_PREFIX, datasetNameWithType, PROPERTYSTORE_DATASET_METADATA_ZNODE);
  }
