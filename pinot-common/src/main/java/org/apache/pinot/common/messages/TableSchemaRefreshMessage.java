...
public class TableSchemaRefreshMessage extends Message {
  public static final String REFRESH_TABLE_SCHEMA_MSG_SUB_TYPE = "REFRESH_TABLE_SCHEMA";
  ...
  public TableSchemaRefreshMessage(String tableNameWithType) {
    ...
    setMsgSubType(REFRESH_TABLE_SCHEMA_MSG_SUB_TYPE);
  ...
  public TableSchemaRefreshMessage(Message message) {
    ...
    if (!message.getMsgSubType().equals(REFRESH_TABLE_SCHEMA_MSG_SUB_TYPE)) {
