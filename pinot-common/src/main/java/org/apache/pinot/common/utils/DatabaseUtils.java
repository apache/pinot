...
public class DatabaseUtils {
  ...
  ///
  /// Throws [IllegalArgumentException] if `tableName` contains more than 1 dot
  ///
  /// Throws [DatabaseConflictException] if `tableName` has database prefix,
  /// and it does not match with `databaseName`
  ...
  /// Checks if the fully qualified `tableName` belongs to the provided `databaseName`
  ...
  /// Removes the provided `databaseName` from the fully qualified `tableName`.
  ...
  ///
  /// If database context is not provided at all return [CommonConstants#DEFAULT_DATABASE].
  ///
