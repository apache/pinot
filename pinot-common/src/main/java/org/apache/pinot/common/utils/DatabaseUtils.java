  ...
  public static String translateTableName(String tableName, @Nullable String databaseName, boolean ignoreCase) {
    ...
    switch (tableSplit.length) {
      ...
      case 2:
         ...
         *
         * Security note: system tables are intentionally exempt from database-scoped access control; broader Pinot
         * security is handled by AccessControl implementations (see org.apache.pinot.spi.security.AccessControl) and
         * the Pinot security model documentation. New system tables should be vetted for sensitive content.
         */
