...
public class SegmentQueryCacheFactory {
  ...
  /**
   * Removes and returns the query cache for the given table. Should be called during table shutdown/deletion
   * to prevent memory leaks.
   *
   * @param tableName The name of the table
   * @return The removed query cache, or null if no cache existed
   */
  public static SegmentQueryCache removeQueryCache(String tableName) {
    return CACHE_MAP.remove(tableName);
  }
}
