 ...
 */
@ScalarFunction
public class BitMaskScalarFunction extends PolymorphicUnaryIntegralScalarFunction {
  ...
  static {
    try {
      INT_FUNCTION_INFO =
          new FunctionInfo(BitMaskScalarFunction.class.getMethod("intBitMask", int.class), BitMaskScalarFunction.class,
              false);
      LONG_FUNCTION_INFO = new FunctionInfo(BitMaskScalarFunction.class.getMethod("longBitMask", long.class),
          BitMaskScalarFunction.class, false);
