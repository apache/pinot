...
public class QueryCacheFactory {
   ...
   */
  public static QueryCache createQueryCache(String table, String cacheType) {
    return CACHE_MAP.computeIfAbsent(table, key -> createCache(cacheType));
  }

  private static QueryCache createCache(String cacheType) {
    switch (cacheType) {
      case "InMemory":
