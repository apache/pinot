...
public final class InMemorySystemTableSegment implements IndexSegment {
  ...
  @Nullable
  @Override
  public org.apache.pinot.segment.spi.index.mutable.ThreadSafeMutableRoaringBitmap getValidDocIds() {
    return null;
  }

  @Nullable
  @Override
  public org.apache.pinot.segment.spi.index.mutable.ThreadSafeMutableRoaringBitmap getQueryableDocIds() {
    return null;
  }
