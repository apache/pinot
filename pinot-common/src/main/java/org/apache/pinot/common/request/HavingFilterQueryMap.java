...
public class HavingFilterQueryMap implements org.apache.thrift.TBase<HavingFilterQueryMap, HavingFilterQueryMap._Fields>, java.io.Serializable, Cloneable, Comparable<HavingFilterQueryMap> {
  ...
  public HavingFilterQueryMap(HavingFilterQueryMap other) {
    if (other.isSetFilterQueryMap()) {
      java.util.Map<java.lang.Integer,HavingFilterQuery> __this__filterQueryMap = new java.util.HashMap<java.lang.Integer,HavingFilterQuery>(other.filterQueryMap.size());
  ...
  public int compareTo(HavingFilterQueryMap other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFilterQueryMap(), other.isSetFilterQueryMap());
    if (lastComparison != 0) {
  ...
  private static class HavingFilterQueryMapStandardScheme extends org.apache.thrift.scheme.StandardScheme<HavingFilterQueryMap> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                int _key43;
                @org.apache.thrift.annotation.Nullable HavingFilterQuery _val44;
  ...
  private static class HavingFilterQueryMapTupleScheme extends org.apache.thrift.scheme.TupleScheme<HavingFilterQueryMap> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HavingFilterQueryMap struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map48 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.filterQueryMap = new java.util.HashMap<java.lang.Integer,HavingFilterQuery>(2*_map48.size);
          int _key49;
          @org.apache.thrift.annotation.Nullable HavingFilterQuery _val50;
