...
///
/// Example usage:
/// `SELECT SHA(bytesColumn) FROM baseballStats LIMIT 10`
/// `SELECT SHA256(bytesColumn) FROM baseballStats LIMIT 10`
/// `SELECT SHA512(bytesColumn) FROM baseballStats LIMIT 10`
/// `SELECT MD5(bytesColumn) FROM baseballStats LIMIT 10`
