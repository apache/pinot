 ...
 *
 */
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2020-04-16")
public class AggregationInfo implements org.apache.thrift.TBase<AggregationInfo, AggregationInfo._Fields>, java.io.Serializable, Cloneable, Comparable<AggregationInfo> {
  ...
  private static final org.apache.thrift.protocol.TField AGGREGATION_FUNCTION_ARGS_FIELD_DESC = new org.apache.thrift.protocol.TField("aggregationFunctionArgs", org.apache.thrift.protocol.TType.LIST, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> aggregationFunctionArgs; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    AGGREGATION_FUNCTION_ARGS((short)4, "aggregationFunctionArgs");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // AGGREGATION_FUNCTION_ARGS
          return AGGREGATION_FUNCTION_ARGS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.AGGREGATION_TYPE,_Fields.AGGREGATION_PARAMS,_Fields.IS_IN_SELECT_LIST,_Fields.AGGREGATION_FUNCTION_ARGS};
  ...
  static {
    ...
    tmpMap.put(_Fields.AGGREGATION_FUNCTION_ARGS, new org.apache.thrift.meta_data.FieldMetaData("aggregationFunctionArgs", org.apache.thrift.TFieldRequirementType.OPTIONAL,
  ...
  public AggregationInfo(AggregationInfo other) {
    ...
    if (other.isSetAggregationFunctionArgs()) {
      java.util.List<java.lang.String> __this__aggregationFunctionArgs = new java.util.ArrayList<java.lang.String>(other.aggregationFunctionArgs);
      this.aggregationFunctionArgs = __this__aggregationFunctionArgs;
    }
  }
  ...
  public void clear() {
    ...
    this.aggregationFunctionArgs = null;
  }
  ...
  public int getAggregationFunctionArgsSize() {
    return (this.aggregationFunctionArgs == null) ? 0 : this.aggregationFunctionArgs.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getAggregationFunctionArgsIterator() {
    return (this.aggregationFunctionArgs == null) ? null : this.aggregationFunctionArgs.iterator();
  }

  public void addToAggregationFunctionArgs(java.lang.String elem) {
    if (this.aggregationFunctionArgs == null) {
      this.aggregationFunctionArgs = new java.util.ArrayList<java.lang.String>();
    }
    this.aggregationFunctionArgs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.String> getAggregationFunctionArgs() {
    return this.aggregationFunctionArgs;
  }

  public AggregationInfo setAggregationFunctionArgs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> aggregationFunctionArgs) {
    this.aggregationFunctionArgs = aggregationFunctionArgs;
    return this;
  }

  public void unsetAggregationFunctionArgs() {
    this.aggregationFunctionArgs = null;
  }

  /** Returns true if field aggregationFunctionArgs is set (has been assigned a value) and false otherwise */
  public boolean isSetAggregationFunctionArgs() {
    return this.aggregationFunctionArgs != null;
  }

  public void setAggregationFunctionArgsIsSet(boolean value) {
    if (!value) {
      this.aggregationFunctionArgs = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case AGGREGATION_FUNCTION_ARGS:
      if (value == null) {
        unsetAggregationFunctionArgs();
      } else {
        setAggregationFunctionArgs((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case AGGREGATION_FUNCTION_ARGS:
      return getAggregationFunctionArgs();
  ...
  public boolean isSet(_Fields field) {
    ...
    case AGGREGATION_FUNCTION_ARGS:
      return isSetAggregationFunctionArgs();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(AggregationInfo that) {
    ...
    boolean this_present_aggregationFunctionArgs = true && this.isSetAggregationFunctionArgs();
    boolean that_present_aggregationFunctionArgs = true && that.isSetAggregationFunctionArgs();
    if (this_present_aggregationFunctionArgs || that_present_aggregationFunctionArgs) {
      if (!(this_present_aggregationFunctionArgs && that_present_aggregationFunctionArgs))
        return false;
      if (!this.aggregationFunctionArgs.equals(that.aggregationFunctionArgs))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetAggregationFunctionArgs()) ? 131071 : 524287);
    if (isSetAggregationFunctionArgs())
      hashCode = hashCode * 8191 + aggregationFunctionArgs.hashCode();
  ...
  public int compareTo(AggregationInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAggregationFunctionArgs()).compareTo(other.isSetAggregationFunctionArgs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAggregationFunctionArgs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aggregationFunctionArgs, other.aggregationFunctionArgs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetAggregationFunctionArgs()) {
      if (!first) sb.append(", ");
      sb.append("aggregationFunctionArgs:");
      if (this.aggregationFunctionArgs == null) {
        sb.append("null");
      } else {
        sb.append(this.aggregationFunctionArgs);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class AggregationInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<AggregationInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregationFunctionArgs = new java.util.ArrayList<java.lang.String>(_list56.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.aggregationFunctionArgs.add(_elem57);
                }
                iprot.readListEnd();
              }
              struct.setAggregationFunctionArgsIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AggregationInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.aggregationFunctionArgs != null) {
        if (struct.isSetAggregationFunctionArgs()) {
          oprot.writeFieldBegin(AGGREGATION_FUNCTION_ARGS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.aggregationFunctionArgs.size()));
            for (java.lang.String _iter60 : struct.aggregationFunctionArgs)
            {
  ...
  private static class AggregationInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<AggregationInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, AggregationInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAggregationFunctionArgs()) {
        {
          oprot.writeI32(struct.aggregationFunctionArgs.size());
          for (java.lang.String _iter62 : struct.aggregationFunctionArgs)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.aggregationFunctionArgs = new java.util.ArrayList<java.lang.String>(_list67.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem68;
          for (int _i69 = 0; _i69 < _list67.size; ++_i69)
          {
            _elem68 = iprot.readString();
            struct.aggregationFunctionArgs.add(_elem68);
          }
        }
        struct.setAggregationFunctionArgsIsSet(true);
      }
