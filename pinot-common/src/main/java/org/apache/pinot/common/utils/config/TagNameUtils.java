...
/// The `TagNameUtils` class handles the conversion between tenant and tag. For single-tenant cluster, use
/// [#DEFAULT_TENANT_NAME] ("DefaultTenant") as the tenant name.
///
/// Example:
///
