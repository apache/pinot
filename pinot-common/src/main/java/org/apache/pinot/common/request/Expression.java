...
public class Expression implements org.apache.thrift.TBase<Expression, Expression._Fields>, java.io.Serializable, Cloneable, Comparable<Expression> {
  ...
  private static final org.apache.thrift.protocol.TField INTERVAL_QUALIFIER_FIELD_DESC = new org.apache.thrift.protocol.TField("intervalQualifier", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  public @org.apache.thrift.annotation.Nullable IntervalQualifier intervalQualifier; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    INTERVAL_QUALIFIER((short)5, "intervalQualifier");
  ...
  private static final _Fields optionals[] = {_Fields.FUNCTION_CALL,_Fields.LITERAL,_Fields.IDENTIFIER,_Fields.INTERVAL_QUALIFIER};
  ...
  static {
    ...
    tmpMap.put(_Fields.INTERVAL_QUALIFIER, new org.apache.thrift.meta_data.FieldMetaData("intervalQualifier", org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "IntervalQualifier")));
  ...
  public Expression(Expression other) {
    ...
    if (other.isSetIntervalQualifier()) {
      this.intervalQualifier = new IntervalQualifier(other.intervalQualifier);
    }
  }
  ...
  public Expression setIntervalQualifier(@org.apache.thrift.annotation.Nullable IntervalQualifier intervalQualifier) {
    this.intervalQualifier = intervalQualifier;
    return this;
  }

  public void unsetIntervalQualifier() {
    this.intervalQualifier = null;
  }

  /** Returns true if field intervalQualifier is set (has been assigned a value) and false otherwise */
  public boolean isSetIntervalQualifier() {
    return this.intervalQualifier != null;
  }

  public void setIntervalQualifierIsSet(boolean value) {
    if (!value) {
      this.intervalQualifier = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    switch (field) {
      ...
      case INTERVAL_QUALIFIER:
        if (value == null) {
          unsetIntervalQualifier();
        } else {
          setIntervalQualifier((IntervalQualifier)value);
        }
        break;
  ...
  public boolean equals(Expression that) {
    ...
    boolean this_present_intervalQualifier = true && this.isSetIntervalQualifier();
    boolean that_present_intervalQualifier = true && that.isSetIntervalQualifier();
    if (this_present_intervalQualifier || that_present_intervalQualifier) {
      if (!(this_present_intervalQualifier && that_present_intervalQualifier))
        return false;
      if (!this.intervalQualifier.equals(that.intervalQualifier))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIntervalQualifier()) ? 131071 : 524287);
    if (isSetIntervalQualifier())
      hashCode = hashCode * 8191 + intervalQualifier.hashCode();
  ...
  public int compareTo(Expression other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIntervalQualifier(), other.isSetIntervalQualifier());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIntervalQualifier()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.intervalQualifier, other.intervalQualifier);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetIntervalQualifier()) {
      ...
      if (this.intervalQualifier == null) {
        sb.append("null");
      } else {
        sb.append(this.intervalQualifier);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class ExpressionStandardScheme extends org.apache.thrift.scheme.StandardScheme<Expression> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Expression struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // INTERVAL_QUALIFIER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.intervalQualifier = new IntervalQualifier();
              struct.intervalQualifier.read(iprot);
              struct.setIntervalQualifierIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Expression struct) throws org.apache.thrift.TException {
      ...
      if (struct.intervalQualifier != null) {
        if (struct.isSetIntervalQualifier()) {
          oprot.writeFieldBegin(INTERVAL_QUALIFIER_FIELD_DESC);
          struct.intervalQualifier.write(oprot);
          oprot.writeFieldEnd();
        }
      }
