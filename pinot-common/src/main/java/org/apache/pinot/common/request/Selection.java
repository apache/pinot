...
public class Selection implements org.apache.thrift.TBase<Selection, Selection._Fields>, java.io.Serializable, Cloneable, Comparable<Selection> {
  ...
  public int compareTo(Selection other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSelectionColumns(), other.isSetSelectionColumns());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSelectionSortSequence(), other.isSetSelectionSortSequence());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSelectionSortSequence()) {
