...
public class QueryOptionsUtils {
  ...
  public static boolean isSkipExpiredRecords(Map<String, String> queryOptions) {
    return Boolean.parseBoolean(queryOptions.get(QueryOptionKey.SKIP_EXPIRED_RECORDS));
  }
