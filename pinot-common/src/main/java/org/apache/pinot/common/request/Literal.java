...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.21.0)", date = "2026-08-13")
public class Literal extends org.apache.thrift.TUnion<Literal, Literal._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField BYTES_ARRAY_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("bytesArrayValue", org.apache.thrift.protocol.TType.LIST, (short)17);
  ...
  static {
    ...
    tmpMap.put(_Fields.STRING_ARRAY_VALUE, new org.apache.thrift.meta_data.FieldMetaData("stringArrayValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.BYTES_ARRAY_VALUE, new org.apache.thrift.meta_data.FieldMetaData("bytesArrayValue", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , true))));
  ...
  public static Literal bytesArrayValue(java.util.List<java.nio.ByteBuffer> value) {
    Literal x = new Literal();
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case BYTES_ARRAY_VALUE:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type java.util.List<java.nio.ByteBuffer> for field 'bytesArrayValue', but got " + value.getClass().getSimpleName());
      default:
        ...
        case INT_ARRAY_VALUE:
          if (field.type == INT_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Integer> intArrayValue;
            {
              ...
              intArrayValue = new java.util.ArrayList<java.lang.Integer>(_list60.size);
              int _elem61;
        ...
        case LONG_ARRAY_VALUE:
          if (field.type == LONG_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Long> longArrayValue;
            {
              ...
              longArrayValue = new java.util.ArrayList<java.lang.Long>(_list63.size);
              long _elem64;
        ...
        case FLOAT_ARRAY_VALUE:
          if (field.type == FLOAT_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Integer> floatArrayValue;
            {
              ...
              floatArrayValue = new java.util.ArrayList<java.lang.Integer>(_list66.size);
              int _elem67;
        ...
        case DOUBLE_ARRAY_VALUE:
          if (field.type == DOUBLE_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Double> doubleArrayValue;
            {
              ...
              doubleArrayValue = new java.util.ArrayList<java.lang.Double>(_list69.size);
              double _elem70;
        ...
        case STRING_ARRAY_VALUE:
          if (field.type == STRING_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.String> stringArrayValue;
            {
              ...
              stringArrayValue = new java.util.ArrayList<java.lang.String>(_list72.size);
        ...
        case BYTES_ARRAY_VALUE:
          if (field.type == BYTES_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.nio.ByteBuffer> bytesArrayValue;
            {
              ...
              bytesArrayValue = new java.util.ArrayList<java.nio.ByteBuffer>(_list75.size);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case STRING_ARRAY_VALUE:
        ...
        return;
      case BYTES_ARRAY_VALUE:
        java.util.List<java.nio.ByteBuffer> bytesArrayValue = (java.util.List<java.nio.ByteBuffer>)value_;
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, bytesArrayValue.size()));
      ...
      switch (setField) {
        ...
        case INT_ARRAY_VALUE:
          java.util.List<java.lang.Integer> intArrayValue;
          {
            ...
            intArrayValue = new java.util.ArrayList<java.lang.Integer>(_list84.size);
            int _elem85;
        ...
        case LONG_ARRAY_VALUE:
          java.util.List<java.lang.Long> longArrayValue;
          {
            ...
            longArrayValue = new java.util.ArrayList<java.lang.Long>(_list87.size);
            long _elem88;
        ...
        case FLOAT_ARRAY_VALUE:
          java.util.List<java.lang.Integer> floatArrayValue;
          {
            ...
            floatArrayValue = new java.util.ArrayList<java.lang.Integer>(_list90.size);
            int _elem91;
        ...
        case DOUBLE_ARRAY_VALUE:
          java.util.List<java.lang.Double> doubleArrayValue;
          {
            ...
            doubleArrayValue = new java.util.ArrayList<java.lang.Double>(_list93.size);
            double _elem94;
        ...
        case STRING_ARRAY_VALUE:
          java.util.List<java.lang.String> stringArrayValue;
          {
            ...
            stringArrayValue = new java.util.ArrayList<java.lang.String>(_list96.size);
        ...
        case BYTES_ARRAY_VALUE:
          java.util.List<java.nio.ByteBuffer> bytesArrayValue;
          {
            ...
            bytesArrayValue = new java.util.ArrayList<java.nio.ByteBuffer>(_list99.size);
  ...
  public java.util.List<java.nio.ByteBuffer> getBytesArrayValue() {
    if (getSetField() == _Fields.BYTES_ARRAY_VALUE) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'bytesArrayValue' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setBytesArrayValue(java.util.List<java.nio.ByteBuffer> value) {
    setField_ = _Fields.BYTES_ARRAY_VALUE;
    value_ = java.util.Objects.requireNonNull(value,"_Fields.BYTES_ARRAY_VALUE");
  }
