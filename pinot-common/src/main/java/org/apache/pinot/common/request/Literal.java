        ...
        case INT_ARRAY_VALUE:
          if (field.type == INT_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Integer> intArrayValue;
            {
              ...
              intArrayValue = new java.util.ArrayList<java.lang.Integer>(_list52.size);
              int _elem53;
              for (int _i54 = 0; _i54 < _list52.size; ++_i54)
              {
                _elem53 = iprot.readI32();
                intArrayValue.add(_elem53);
              }
              iprot.readListEnd();
            }
        ...
        case LONG_ARRAY_VALUE:
          if (field.type == LONG_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Long> longArrayValue;
            {
              ...
              longArrayValue = new java.util.ArrayList<java.lang.Long>(_list55.size);
              long _elem56;
              for (int _i57 = 0; _i57 < _list55.size; ++_i57)
              {
                _elem56 = iprot.readI64();
                longArrayValue.add(_elem56);
              }
              iprot.readListEnd();
            }
        ...
        case FLOAT_ARRAY_VALUE:
          if (field.type == FLOAT_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Integer> floatArrayValue;
            {
              ...
              floatArrayValue = new java.util.ArrayList<java.lang.Integer>(_list58.size);
              int _elem59;
              for (int _i60 = 0; _i60 < _list58.size; ++_i60)
              {
                _elem59 = iprot.readI32();
                floatArrayValue.add(_elem59);
              }
              iprot.readListEnd();
            }
        ...
        case DOUBLE_ARRAY_VALUE:
          if (field.type == DOUBLE_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.Double> doubleArrayValue;
            {
              ...
              doubleArrayValue = new java.util.ArrayList<java.lang.Double>(_list61.size);
              double _elem62;
              for (int _i63 = 0; _i63 < _list61.size; ++_i63)
              {
                _elem62 = iprot.readDouble();
                doubleArrayValue.add(_elem62);
              }
              iprot.readListEnd();
            }
        ...
        case STRING_ARRAY_VALUE:
          if (field.type == STRING_ARRAY_VALUE_FIELD_DESC.type) {
            java.util.List<java.lang.String> stringArrayValue;
            {
              ...
              stringArrayValue = new java.util.ArrayList<java.lang.String>(_list64.size);
              @org.apache.thrift.annotation.Nullable java.lang.String _elem65;
              for (int _i66 = 0; _i66 < _list64.size; ++_i66)
              {
                _elem65 = iprot.readString();
                stringArrayValue.add(_elem65);
              }
              iprot.readListEnd();
            }
    ...
    switch (setField_) {
      ...
      case LONG_ARRAY_VALUE:
        java.util.List<java.lang.Long> longArrayValue = (java.util.List<java.lang.Long>)value_;
        {
          ...
          for (long _iter68 : longArrayValue)
          {
      ...
      case FLOAT_ARRAY_VALUE:
        java.util.List<java.lang.Integer> floatArrayValue = (java.util.List<java.lang.Integer>)value_;
        {
          ...
          for (int _iter69 : floatArrayValue)
          {
      ...
      case DOUBLE_ARRAY_VALUE:
        java.util.List<java.lang.Double> doubleArrayValue = (java.util.List<java.lang.Double>)value_;
        {
          ...
          for (double _iter70 : doubleArrayValue)
          {
      ...
      case STRING_ARRAY_VALUE:
        java.util.List<java.lang.String> stringArrayValue = (java.util.List<java.lang.String>)value_;
        {
          ...
          for (java.lang.String _iter71 : stringArrayValue)
          {
      ...
      switch (setField) {
        ...
        case INT_ARRAY_VALUE:
          java.util.List<java.lang.Integer> intArrayValue;
          {
            ...
            intArrayValue = new java.util.ArrayList<java.lang.Integer>(_list72.size);
            int _elem73;
            for (int _i74 = 0; _i74 < _list72.size; ++_i74)
            {
              _elem73 = iprot.readI32();
              intArrayValue.add(_elem73);
            }
            iprot.readListEnd();
          }
          return intArrayValue;
        case LONG_ARRAY_VALUE:
          java.util.List<java.lang.Long> longArrayValue;
          {
            ...
            longArrayValue = new java.util.ArrayList<java.lang.Long>(_list75.size);
            long _elem76;
            for (int _i77 = 0; _i77 < _list75.size; ++_i77)
            {
              _elem76 = iprot.readI64();
              longArrayValue.add(_elem76);
            }
            iprot.readListEnd();
          }
          return longArrayValue;
        case FLOAT_ARRAY_VALUE:
          java.util.List<java.lang.Integer> floatArrayValue;
          {
            ...
            floatArrayValue = new java.util.ArrayList<java.lang.Integer>(_list78.size);
            int _elem79;
            for (int _i80 = 0; _i80 < _list78.size; ++_i80)
            {
              _elem79 = iprot.readI32();
              floatArrayValue.add(_elem79);
            }
            iprot.readListEnd();
          }
          return floatArrayValue;
        case DOUBLE_ARRAY_VALUE:
          java.util.List<java.lang.Double> doubleArrayValue;
          {
            ...
            doubleArrayValue = new java.util.ArrayList<java.lang.Double>(_list81.size);
            double _elem82;
            for (int _i83 = 0; _i83 < _list81.size; ++_i83)
            {
              _elem82 = iprot.readDouble();
              doubleArrayValue.add(_elem82);
            }
            iprot.readListEnd();
          }
          return doubleArrayValue;
        case STRING_ARRAY_VALUE:
          java.util.List<java.lang.String> stringArrayValue;
          {
            ...
            stringArrayValue = new java.util.ArrayList<java.lang.String>(_list84.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem85;
            for (int _i86 = 0; _i86 < _list84.size; ++_i86)
            {
              _elem85 = iprot.readString();
              stringArrayValue.add(_elem85);
            }
            iprot.readListEnd();
          }
          return stringArrayValue;
  ...
  protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case LONG_ARRAY_VALUE:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, longArrayValue.size()));
          for (long _iter88 : longArrayValue)
          {
      ...
      case FLOAT_ARRAY_VALUE:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, floatArrayValue.size()));
          for (int _iter89 : floatArrayValue)
          {
      ...
      case DOUBLE_ARRAY_VALUE:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, doubleArrayValue.size()));
          for (double _iter90 : doubleArrayValue)
          {
      ...
      case STRING_ARRAY_VALUE:
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, stringArrayValue.size()));
          for (java.lang.String _iter91 : stringArrayValue)
          {
