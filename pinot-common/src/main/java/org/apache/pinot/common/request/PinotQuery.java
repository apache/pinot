...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.15.0)", date = "2022-06-26")
public class PinotQuery implements org.apache.thrift.TBase<PinotQuery, PinotQuery._Fields>, java.io.Serializable, Cloneable, Comparable<PinotQuery> {
  ...
  private static final org.apache.thrift.protocol.TField NULL_HANDLING_ENABLED_FIELD_DESC = new org.apache.thrift.protocol.TField("nullHandlingEnabled", org.apache.thrift.protocol.TType.BOOL, (short)14);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> debugOptions; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> queryOptions; // optional
  ...
  public boolean nullHandlingEnabled; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NULL_HANDLING_ENABLED((short)14, "nullHandlingEnabled");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 14: // NULL_HANDLING_ENABLED
          return NULL_HANDLING_ENABLED;
        default:
          return null;
      }
    }
  ...
  private static final int __NULLHANDLINGENABLED_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.DATA_SOURCE,_Fields.SELECT_LIST,_Fields.FILTER_EXPRESSION,_Fields.GROUP_BY_LIST,_Fields.ORDER_BY_LIST,_Fields.HAVING_EXPRESSION,_Fields.LIMIT,_Fields.OFFSET,_Fields.DEBUG_OPTIONS,_Fields.QUERY_OPTIONS,_Fields.EXPLAIN,_Fields.EXPRESSION_OVERRIDE_HINTS,_Fields.NULL_HANDLING_ENABLED};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXPRESSION_OVERRIDE_HINTS, new org.apache.thrift.meta_data.FieldMetaData("expressionOverrideHints", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"))));
    tmpMap.put(_Fields.NULL_HANDLING_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("nullHandlingEnabled", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public PinotQuery(PinotQuery other) {
    ...
    if (other.isSetDebugOptions()) {
      java.util.Map<String, String> __this__debugOptions = new java.util.HashMap<String, String>(other.debugOptions);
      this.debugOptions = __this__debugOptions;
    }
    if (other.isSetQueryOptions()) {
      java.util.Map<String, String> __this__queryOptions = new java.util.HashMap<String, String>(other.queryOptions);
    ...
    this.nullHandlingEnabled = other.nullHandlingEnabled;
  }
  ...
  public void clear() {
    ...
    setNullHandlingEnabledIsSet(false);
    this.nullHandlingEnabled = false;
  }
  ...
  public void putToDebugOptions(String key, String val) {
    if (this.debugOptions == null) {
      this.debugOptions = new java.util.HashMap<String, String>();
    }
    this.debugOptions.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<String, String> getDebugOptions() {
    return this.debugOptions;
  }

  public PinotQuery setDebugOptions(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> debugOptions) {
  ...
  public void putToQueryOptions(String key, String val) {
    if (this.queryOptions == null) {
      this.queryOptions = new java.util.HashMap<String, String>();
    }
    this.queryOptions.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<String, String> getQueryOptions() {
    return this.queryOptions;
  }

  public PinotQuery setQueryOptions(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> queryOptions) {
  ...
  public boolean isNullHandlingEnabled() {
    return this.nullHandlingEnabled;
  }

  public PinotQuery setNullHandlingEnabled(boolean nullHandlingEnabled) {
    this.nullHandlingEnabled = nullHandlingEnabled;
    setNullHandlingEnabledIsSet(true);
    return this;
  }

  public void unsetNullHandlingEnabled() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __NULLHANDLINGENABLED_ISSET_ID);
  }

  /** Returns true if field nullHandlingEnabled is set (has been assigned a value) and false otherwise */
  public boolean isSetNullHandlingEnabled() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __NULLHANDLINGENABLED_ISSET_ID);
  }

  public void setNullHandlingEnabledIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __NULLHANDLINGENABLED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case DEBUG_OPTIONS:
      if (value == null) {
        ...
        setDebugOptions((java.util.Map<String, String>)value);
      }
      break;
    ...
    case QUERY_OPTIONS:
      if (value == null) {
        ...
        setQueryOptions((java.util.Map<String, String>)value);
      }
      break;
    ...
    case NULL_HANDLING_ENABLED:
      if (value == null) {
        unsetNullHandlingEnabled();
      } else {
        setNullHandlingEnabled((Boolean)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case NULL_HANDLING_ENABLED:
      return isSetNullHandlingEnabled();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(PinotQuery that) {
    ...
    boolean this_present_nullHandlingEnabled = true && this.isSetNullHandlingEnabled();
    boolean that_present_nullHandlingEnabled = true && that.isSetNullHandlingEnabled();
    if (this_present_nullHandlingEnabled || that_present_nullHandlingEnabled) {
      if (!(this_present_nullHandlingEnabled && that_present_nullHandlingEnabled))
        return false;
      if (this.nullHandlingEnabled != that.nullHandlingEnabled)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetNullHandlingEnabled()) ? 131071 : 524287);
    if (isSetNullHandlingEnabled())
      hashCode = hashCode * 8191 + ((nullHandlingEnabled) ? 131071 : 524287);
  ...
  public int compareTo(PinotQuery other) {
    ...
    lastComparison = Boolean.compare(isSetDataSource(), other.isSetDataSource());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataSource()) {
    ...
    lastComparison = Boolean.compare(isSetSelectList(), other.isSetSelectList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSelectList()) {
    ...
    lastComparison = Boolean.compare(isSetFilterExpression(), other.isSetFilterExpression());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFilterExpression()) {
    ...
    lastComparison = Boolean.compare(isSetGroupByList(), other.isSetGroupByList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGroupByList()) {
    ...
    lastComparison = Boolean.compare(isSetOrderByList(), other.isSetOrderByList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOrderByList()) {
    ...
    lastComparison = Boolean.compare(isSetHavingExpression(), other.isSetHavingExpression());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHavingExpression()) {
    ...
    lastComparison = Boolean.compare(isSetDebugOptions(), other.isSetDebugOptions());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDebugOptions()) {
    ...
    lastComparison = Boolean.compare(isSetQueryOptions(), other.isSetQueryOptions());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueryOptions()) {
    ...
    lastComparison = Boolean.compare(isSetExplain(), other.isSetExplain());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExplain()) {
    ...
    lastComparison = Boolean.compare(isSetExpressionOverrideHints(), other.isSetExpressionOverrideHints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpressionOverrideHints()) {
    ...
    lastComparison = Boolean.compare(isSetNullHandlingEnabled(), other.isSetNullHandlingEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNullHandlingEnabled()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nullHandlingEnabled, other.nullHandlingEnabled);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetNullHandlingEnabled()) {
      if (!first) sb.append(", ");
      sb.append("nullHandlingEnabled:");
      sb.append(this.nullHandlingEnabled);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class PinotQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<PinotQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.debugOptions = new java.util.HashMap<String, String>(2*_map9.size);
                @org.apache.thrift.annotation.Nullable String _key10;
                @org.apache.thrift.annotation.Nullable String _val11;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.queryOptions = new java.util.HashMap<String, String>(2*_map13.size);
          ...
          case 14: // NULL_HANDLING_ENABLED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.nullHandlingEnabled = iprot.readBool();
              struct.setNullHandlingEnabledIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.debugOptions != null) {
        if (struct.isSetDebugOptions()) {
          oprot.writeFieldBegin(DEBUG_OPTIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter24 : struct.debugOptions.entrySet())
            {
      ...
      if (struct.queryOptions != null) {
        if (struct.isSetQueryOptions()) {
          oprot.writeFieldBegin(QUERY_OPTIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter25 : struct.queryOptions.entrySet())
            {
      ...
      if (struct.isSetNullHandlingEnabled()) {
        oprot.writeFieldBegin(NULL_HANDLING_ENABLED_FIELD_DESC);
        oprot.writeBool(struct.nullHandlingEnabled);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.isSetDebugOptions()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter30 : struct.debugOptions.entrySet())
          {
      ...
      if (struct.isSetQueryOptions()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter31 : struct.queryOptions.entrySet())
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.debugOptions = new java.util.HashMap<String, String>(2*_map42.size);
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.queryOptions = new java.util.HashMap<String, String>(2*_map46.size);
