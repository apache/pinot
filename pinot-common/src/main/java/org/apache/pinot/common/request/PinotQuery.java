...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.21.0)", date = "2025-04-24")
public class PinotQuery implements org.apache.thrift.TBase<PinotQuery, PinotQuery._Fields>, java.io.Serializable, Cloneable, Comparable<PinotQuery> {
  ...
  private static final org.apache.thrift.protocol.TField SELECT_STAR_QUERY_FIELD_DESC = new org.apache.thrift.protocol.TField("selectStarQuery", org.apache.thrift.protocol.TType.BOOL, (short)14);
  ...
  public boolean selectStarQuery; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SELECT_STAR_QUERY((short)14, "selectStarQuery");
  ...
  private static final int __SELECTSTARQUERY_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.DATA_SOURCE,_Fields.SELECT_LIST,_Fields.FILTER_EXPRESSION,_Fields.GROUP_BY_LIST,_Fields.ORDER_BY_LIST,_Fields.HAVING_EXPRESSION,_Fields.LIMIT,_Fields.OFFSET,_Fields.QUERY_OPTIONS,_Fields.EXPLAIN,_Fields.EXPRESSION_OVERRIDE_HINTS,_Fields.SELECT_STAR_QUERY};
  ...
  public PinotQuery(PinotQuery other) {
    ...
    this.selectStarQuery = other.selectStarQuery;
  }
  ...
  public void clear() {
    ...
    setSelectStarQueryIsSet(false);
    this.selectStarQuery = false;
  }
  ...
  public boolean isSelectStarQuery() {
    return this.selectStarQuery;
  }

  public PinotQuery setSelectStarQuery(boolean selectStarQuery) {
    this.selectStarQuery = selectStarQuery;
    setSelectStarQueryIsSet(true);
    return this;
  }

  public void unsetSelectStarQuery() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SELECTSTARQUERY_ISSET_ID);
  }

  /** Returns true if field selectStarQuery is set (has been assigned a value) and false otherwise */
  public boolean isSetSelectStarQuery() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SELECTSTARQUERY_ISSET_ID);
  }

  public void setSelectStarQueryIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SELECTSTARQUERY_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SELECT_STAR_QUERY:
      if (value == null) {
        unsetSelectStarQuery();
      } else {
        setSelectStarQuery((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(PinotQuery that) {
    ...
    boolean this_present_selectStarQuery = true && this.isSetSelectStarQuery();
    boolean that_present_selectStarQuery = true && that.isSetSelectStarQuery();
    if (this_present_selectStarQuery || that_present_selectStarQuery) {
      if (!(this_present_selectStarQuery && that_present_selectStarQuery))
        return false;
      if (this.selectStarQuery != that.selectStarQuery)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSelectStarQuery()) ? 131071 : 524287);
    if (isSetSelectStarQuery())
      hashCode = hashCode * 8191 + ((selectStarQuery) ? 131071 : 524287);
  ...
  public int compareTo(PinotQuery other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSelectStarQuery(), other.isSetSelectStarQuery());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSelectStarQuery()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.selectStarQuery, other.selectStarQuery);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSelectStarQuery()) {
      if (!first) sb.append(", ");
      sb.append("selectStarQuery:");
      sb.append(this.selectStarQuery);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class PinotQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<PinotQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 14: // SELECT_STAR_QUERY
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.selectStarQuery = iprot.readBool();
              struct.setSelectStarQueryIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSelectStarQuery()) {
        oprot.writeFieldBegin(SELECT_STAR_QUERY_FIELD_DESC);
        oprot.writeBool(struct.selectStarQuery);
        oprot.writeFieldEnd();
      }
