...
public class PinotQuery implements org.apache.thrift.TBase<PinotQuery, PinotQuery._Fields>, java.io.Serializable, Cloneable, Comparable<PinotQuery> {
  ...
  private static final org.apache.thrift.protocol.TField ARRAY_JOIN_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("arrayJoinList", org.apache.thrift.protocol.TType.LIST, (short)15);
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<ArrayJoinSpec> arrayJoinList; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ARRAY_JOIN_LIST((short)15, "arrayJoinList");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 15: // ARRAY_JOIN_LIST
          return ARRAY_JOIN_LIST;
        default:
          return null;
      }
    }
  ...
  private static final _Fields[] optionals = {_Fields.VERSION,_Fields.DATA_SOURCE,_Fields.SELECT_LIST,_Fields.FILTER_EXPRESSION,_Fields.GROUP_BY_LIST,_Fields.ORDER_BY_LIST,_Fields.HAVING_EXPRESSION,_Fields.LIMIT,_Fields.OFFSET,_Fields.QUERY_OPTIONS,_Fields.EXPLAIN,_Fields.EXPRESSION_OVERRIDE_HINTS,_Fields.GROUPING_SET_MASKS,_Fields.ARRAY_JOIN_LIST};
  ...
  static {
    ...
    tmpMap.put(_Fields.GROUPING_SET_MASKS, new org.apache.thrift.meta_data.FieldMetaData("groupingSetMasks", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.ARRAY_JOIN_LIST, new org.apache.thrift.meta_data.FieldMetaData("arrayJoinList", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ArrayJoinSpec.class))));
  ...
  public PinotQuery(PinotQuery other) {
    ...
    if (other.isSetArrayJoinList()) {
      java.util.List<ArrayJoinSpec> __this__arrayJoinList = new java.util.ArrayList<ArrayJoinSpec>(other.arrayJoinList.size());
      for (ArrayJoinSpec other_element : other.arrayJoinList) {
        __this__arrayJoinList.add(new ArrayJoinSpec(other_element));
      }
      this.arrayJoinList = __this__arrayJoinList;
    }
  }
  ...
  public int getArrayJoinListSize() {
    return (this.arrayJoinList == null) ? 0 : this.arrayJoinList.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<ArrayJoinSpec> getArrayJoinListIterator() {
    return (this.arrayJoinList == null) ? null : this.arrayJoinList.iterator();
  }

  public void addToArrayJoinList(ArrayJoinSpec elem) {
    if (this.arrayJoinList == null) {
      this.arrayJoinList = new java.util.ArrayList<ArrayJoinSpec>();
    }
    this.arrayJoinList.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<ArrayJoinSpec> getArrayJoinList() {
    return this.arrayJoinList;
  }

  public void setArrayJoinList(@org.apache.thrift.annotation.Nullable java.util.List<ArrayJoinSpec> arrayJoinList) {
    this.arrayJoinList = arrayJoinList;
  }

  public void unsetArrayJoinList() {
    this.arrayJoinList = null;
  }

  /** Returns true if field arrayJoinList is set (has been assigned a value) and false otherwise */
  public boolean isSetArrayJoinList() {
    return this.arrayJoinList != null;
  }

  public void setArrayJoinListIsSet(boolean value) {
    if (!value) {
      this.arrayJoinList = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ARRAY_JOIN_LIST:
      if (value == null) {
        unsetArrayJoinList();
      } else {
        setArrayJoinList((java.util.List<ArrayJoinSpec>)value);
      }
      break;
  ...
  public boolean equals(PinotQuery that) {
    ...
    boolean this_present_arrayJoinList = true && this.isSetArrayJoinList();
    boolean that_present_arrayJoinList = true && that.isSetArrayJoinList();
    if (this_present_arrayJoinList || that_present_arrayJoinList) {
      if (!(this_present_arrayJoinList && that_present_arrayJoinList))
        return false;
      if (!this.arrayJoinList.equals(that.arrayJoinList))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetArrayJoinList()) ? 131071 : 524287);
    if (isSetArrayJoinList())
      hashCode = hashCode * 8191 + arrayJoinList.hashCode();
  ...
  public int compareTo(PinotQuery other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetArrayJoinList(), other.isSetArrayJoinList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArrayJoinList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.arrayJoinList, other.arrayJoinList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetArrayJoinList()) {
      if (!first) sb.append(", ");
      sb.append("arrayJoinList:");
      if (this.arrayJoinList == null) {
        sb.append("null");
      } else {
        sb.append(this.arrayJoinList);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class PinotQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<PinotQuery> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arrayJoinList = new java.util.ArrayList<ArrayJoinSpec>(_list20.size);
                @org.apache.thrift.annotation.Nullable ArrayJoinSpec _elem21;
                for (int _i22 = 0; _i22 < _list20.size; ++_i22)
                {
                  _elem21 = new ArrayJoinSpec();
                  _elem21.read(iprot);
                  struct.arrayJoinList.add(_elem21);
                }
                iprot.readListEnd();
              }
              struct.setArrayJoinListIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.selectList != null) {
        if (struct.isSetSelectList()) {
          oprot.writeFieldBegin(SELECT_LIST_FIELD_DESC);
          {
            ...
            for (Expression _iter23 : struct.selectList)
            {
              _iter23.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.groupByList != null) {
        if (struct.isSetGroupByList()) {
          oprot.writeFieldBegin(GROUP_BY_LIST_FIELD_DESC);
          {
            ...
            for (Expression _iter24 : struct.groupByList)
            {
              _iter24.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.expressionOverrideHints != null) {
        if (struct.isSetExpressionOverrideHints()) {
          oprot.writeFieldBegin(EXPRESSION_OVERRIDE_HINTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<Expression, Expression> _iter27 : struct.expressionOverrideHints.entrySet())
            {
      ...
      if (struct.groupingSetMasks != null) {
        if (struct.isSetGroupingSetMasks()) {
          oprot.writeFieldBegin(GROUPING_SET_MASKS_FIELD_DESC);
          {
            ...
            for (int _iter28 : struct.groupingSetMasks)
            {
      ...
      if (struct.arrayJoinList != null) {
        if (struct.isSetArrayJoinList()) {
          oprot.writeFieldBegin(ARRAY_JOIN_LIST_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.arrayJoinList.size()));
            for (ArrayJoinSpec _iter29 : struct.arrayJoinList)
            {
              _iter29.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class PinotQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<PinotQuery> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSelectList()) {
        {
          ...
          for (Expression _iter30 : struct.selectList)
          {
            _iter30.write(oprot);
          }
        }
      ...
      if (struct.isSetGroupByList()) {
        {
          ...
          for (Expression _iter31 : struct.groupByList)
          {
            _iter31.write(oprot);
          }
        }
      ...
      if (struct.isSetQueryOptions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter33 : struct.queryOptions.entrySet())
          {
      ...
      if (struct.isSetExpressionOverrideHints()) {
        {
          ...
          for (java.util.Map.Entry<Expression, Expression> _iter34 : struct.expressionOverrideHints.entrySet())
          {
      ...
      if (struct.isSetGroupingSetMasks()) {
        {
          ...
          for (int _iter35 : struct.groupingSetMasks)
          {
      ...
      if (struct.isSetArrayJoinList()) {
        {
          oprot.writeI32(struct.arrayJoinList.size());
          for (ArrayJoinSpec _iter36 : struct.arrayJoinList)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.selectList = new java.util.ArrayList<Expression>(_list37.size);
          @org.apache.thrift.annotation.Nullable Expression _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new Expression();
            _elem38.read(iprot);
            struct.selectList.add(_elem38);
          }
        }
        struct.setSelectListIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.groupByList = new java.util.ArrayList<Expression>(_list40.size);
          @org.apache.thrift.annotation.Nullable Expression _elem41;
          for (int _i42 = 0; _i42 < _list40.size; ++_i42)
          {
            _elem41 = new Expression();
            _elem41.read(iprot);
            struct.groupByList.add(_elem41);
          }
        }
        struct.setGroupByListIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.orderByList = new java.util.ArrayList<Expression>(_list43.size);
          @org.apache.thrift.annotation.Nullable Expression _elem44;
          for (int _i45 = 0; _i45 < _list43.size; ++_i45)
          {
            _elem44 = new Expression();
            _elem44.read(iprot);
            struct.orderByList.add(_elem44);
          }
        }
        struct.setOrderByListIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.groupingSetMasks = new java.util.ArrayList<java.lang.Integer>(_list54.size);
          int _elem55;
          for (int _i56 = 0; _i56 < _list54.size; ++_i56)
          {
            _elem55 = iprot.readI32();
            struct.groupingSetMasks.add(_elem55);
          }
        }
        struct.setGroupingSetMasksIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.arrayJoinList = new java.util.ArrayList<ArrayJoinSpec>(_list57.size);
          @org.apache.thrift.annotation.Nullable ArrayJoinSpec _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new ArrayJoinSpec();
            _elem58.read(iprot);
            struct.arrayJoinList.add(_elem58);
          }
        }
        struct.setArrayJoinListIsSet(true);
      }
