...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.16.0)", date = "2024-03-06")
public class PinotQuery implements org.apache.thrift.TBase<PinotQuery, PinotQuery._Fields>, java.io.Serializable, Cloneable, Comparable<PinotQuery> {
  ...
  private static final org.apache.thrift.protocol.TField SHOW_TABLES_FIELD_DESC = new org.apache.thrift.protocol.TField("showTables", org.apache.thrift.protocol.TType.BOOL, (short)14);
  private static final org.apache.thrift.protocol.TField DESCRIBE_TABLE_FIELD_DESC = new org.apache.thrift.protocol.TField("describeTable", org.apache.thrift.protocol.TType.BOOL, (short)15);
  ...
  private boolean showTables; // optional
  private boolean describeTable; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SHOW_TABLES((short)14, "showTables"),
    DESCRIBE_TABLE((short)15, "describeTable");
  ...
  private static final int __SHOWTABLES_ISSET_ID = 4;
  private static final int __DESCRIBETABLE_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.DATA_SOURCE,_Fields.SELECT_LIST,_Fields.FILTER_EXPRESSION,_Fields.GROUP_BY_LIST,_Fields.ORDER_BY_LIST,_Fields.HAVING_EXPRESSION,_Fields.LIMIT,_Fields.OFFSET,_Fields.DEBUG_OPTIONS,_Fields.QUERY_OPTIONS,_Fields.EXPLAIN,_Fields.EXPRESSION_OVERRIDE_HINTS,_Fields.SHOW_TABLES,_Fields.DESCRIBE_TABLE};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXPRESSION_OVERRIDE_HINTS, new org.apache.thrift.meta_data.FieldMetaData("expressionOverrideHints", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"))));
    tmpMap.put(_Fields.SHOW_TABLES, new org.apache.thrift.meta_data.FieldMetaData("showTables", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.DESCRIBE_TABLE, new org.apache.thrift.meta_data.FieldMetaData("describeTable", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public PinotQuery(PinotQuery other) {
    ...
    this.showTables = other.showTables;
    this.describeTable = other.describeTable;
  }
  ...
  public void clear() {
    ...
    setShowTablesIsSet(false);
    this.showTables = false;
    setDescribeTableIsSet(false);
    this.describeTable = false;
  }
  ...
  public void setShowTables(boolean showTables) {
    ...
    setShowTablesIsSet(true);
  }

  public void unsetShowTables() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SHOWTABLES_ISSET_ID);
  }

  /** Returns true if field showTables is set (has been assigned a value) and false otherwise */
  public boolean isSetShowTables() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SHOWTABLES_ISSET_ID);
  }

  public void setShowTablesIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SHOWTABLES_ISSET_ID, value);
  }
  ...
  public void setDescribeTable(boolean describeTable) {
    ...
    setDescribeTableIsSet(true);
  }

  public void unsetDescribeTable() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __DESCRIBETABLE_ISSET_ID);
  }

  /** Returns true if field describeTable is set (has been assigned a value) and false otherwise */
  public boolean isSetDescribeTable() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __DESCRIBETABLE_ISSET_ID);
  }

  public void setDescribeTableIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __DESCRIBETABLE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SHOW_TABLES:
      if (value == null) {
        ...
        setShowTables((java.lang.Boolean)value);
      }
      break;
    ...
    case DESCRIBE_TABLE:
      if (value == null) {
        ...
        setDescribeTable((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case SHOW_TABLES:
      return isSetShowTables();
    case DESCRIBE_TABLE:
      return isSetDescribeTable();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(PinotQuery that) {
    ...
    boolean this_present_showTables = true && this.isSetShowTables();
    boolean that_present_showTables = true && that.isSetShowTables();
    if (this_present_showTables || that_present_showTables) {
      if (!(this_present_showTables && that_present_showTables))
        return false;
      if (this.showTables != that.showTables)
        return false;
    }

    boolean this_present_describeTable = true && this.isSetDescribeTable();
    boolean that_present_describeTable = true && that.isSetDescribeTable();
    if (this_present_describeTable || that_present_describeTable) {
      if (!(this_present_describeTable && that_present_describeTable))
        return false;
      if (this.describeTable != that.describeTable)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetShowTables()) ? 131071 : 524287);
    if (isSetShowTables())
      hashCode = hashCode * 8191 + ((showTables) ? 131071 : 524287);

    hashCode = hashCode * 8191 + ((isSetDescribeTable()) ? 131071 : 524287);
    if (isSetDescribeTable())
      hashCode = hashCode * 8191 + ((describeTable) ? 131071 : 524287);
  ...
  public int compareTo(PinotQuery other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetShowTables(), other.isSetShowTables());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShowTables()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.showTables, other.showTables);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.compare(isSetDescribeTable(), other.isSetDescribeTable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDescribeTable()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.describeTable, other.describeTable);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetShowTables()) {
      ...
      sb.append(this.showTables);
      first = false;
    }
    if (isSetDescribeTable()) {
      if (!first) sb.append(", ");
      sb.append("describeTable:");
      sb.append(this.describeTable);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class PinotQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<PinotQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 14: // SHOW_TABLES
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.showTables = iprot.readBool();
              struct.setShowTablesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 15: // DESCRIBE_TABLE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.describeTable = iprot.readBool();
              struct.setDescribeTableIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetShowTables()) {
        oprot.writeFieldBegin(SHOW_TABLES_FIELD_DESC);
        oprot.writeBool(struct.showTables);
        oprot.writeFieldEnd();
      }
      if (struct.isSetDescribeTable()) {
        oprot.writeFieldBegin(DESCRIBE_TABLE_FIELD_DESC);
        oprot.writeBool(struct.describeTable);
        oprot.writeFieldEnd();
      }
