...
public class TimeGranularitySpec {
  ...
  public TimeGranularitySpec(@Nonnull FieldSpec.DataType dataType, @Nonnull TimeUnit timeType, @Nonnull String timeFormat,
      @Nonnull String name) {
    Preconditions.checkNotNull(timeType);
    Preconditions.checkNotNull(name);
  ...
  public TimeGranularitySpec(@Nonnull FieldSpec.DataType dataType, int timeUnitSize, @Nonnull TimeUnit timeType,
      @Nonnull String name) {
    Preconditions.checkNotNull(timeType);
    Preconditions.checkNotNull(name);
