...
public class Function implements org.apache.thrift.TBase<Function, Function._Fields>, java.io.Serializable, Cloneable, Comparable<Function> {
  ...
  private static final org.apache.thrift.protocol.TField AGGREGATION_BINDING_FIELD_DESC = new org.apache.thrift.protocol.TField("aggregationBinding", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  ...
  private @org.apache.thrift.annotation.Nullable AggregationFunctionBinding aggregationBinding; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    OPERATOR((short)1, "operator"),
    OPERANDS((short)2, "operands"),
    AGGREGATION_BINDING((short)3, "aggregationBinding");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // OPERANDS
          return OPERANDS;
        case 3: // AGGREGATION_BINDING
          return AGGREGATION_BINDING;
        default:
          return null;
      }
    }
  ...
  private static final _Fields[] optionals = {_Fields.OPERANDS,_Fields.AGGREGATION_BINDING};
  ...
  static {
    ...
    tmpMap.put(_Fields.AGGREGATION_BINDING, new org.apache.thrift.meta_data.FieldMetaData("aggregationBinding", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, AggregationFunctionBinding.class)));
  ...
  public Function(Function other) {
    ...
    if (other.isSetAggregationBinding()) {
      this.aggregationBinding = new AggregationFunctionBinding(other.aggregationBinding);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public AggregationFunctionBinding getAggregationBinding() {
    return this.aggregationBinding;
  }

  public void setAggregationBinding(@org.apache.thrift.annotation.Nullable AggregationFunctionBinding aggregationBinding) {
    this.aggregationBinding = aggregationBinding;
  }

  public void unsetAggregationBinding() {
    this.aggregationBinding = null;
  }

  /** Returns true if field aggregationBinding is set (has been assigned a value) and false otherwise */
  public boolean isSetAggregationBinding() {
    return this.aggregationBinding != null;
  }

  public void setAggregationBindingIsSet(boolean value) {
    if (!value) {
      this.aggregationBinding = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case AGGREGATION_BINDING:
      if (value == null) {
        unsetAggregationBinding();
      } else {
        setAggregationBinding((AggregationFunctionBinding)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case AGGREGATION_BINDING:
      return isSetAggregationBinding();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(Function that) {
    ...
    boolean this_present_aggregationBinding = true && this.isSetAggregationBinding();
    boolean that_present_aggregationBinding = true && that.isSetAggregationBinding();
    if (this_present_aggregationBinding || that_present_aggregationBinding) {
      if (!(this_present_aggregationBinding && that_present_aggregationBinding))
        return false;
      if (!this.aggregationBinding.equals(that.aggregationBinding))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetAggregationBinding()) ? 131071 : 524287);
    if (isSetAggregationBinding())
      hashCode = hashCode * 8191 + aggregationBinding.hashCode();
  ...
  public int compareTo(Function other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAggregationBinding(), other.isSetAggregationBinding());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAggregationBinding()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aggregationBinding, other.aggregationBinding);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetAggregationBinding()) {
      if (!first) sb.append(", ");
      sb.append("aggregationBinding:");
      if (this.aggregationBinding == null) {
        sb.append("null");
      } else {
        sb.append(this.aggregationBinding);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (aggregationBinding != null) {
      aggregationBinding.validate();
    }
  }
  ...
  private static class FunctionStandardScheme extends org.apache.thrift.scheme.StandardScheme<Function> {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.operands = new java.util.ArrayList<Expression>(_list108.size);
                  @org.apache.thrift.annotation.Nullable Expression _elem109;
                  for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                  {
                    _elem109 = new Expression();
                    _elem109.read(iprot);
                    struct.operands.add(_elem109);
                  }
                  iprot.readListEnd();
                }
            ...
            case 3: // AGGREGATION_BINDING
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.aggregationBinding = new AggregationFunctionBinding();
                struct.aggregationBinding.read(iprot);
                struct.setAggregationBindingIsSet(true);
              } else {
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Function struct) throws org.apache.thrift.TException {
      ...
      if (struct.operands != null) {
        if (struct.isSetOperands()) {
          oprot.writeFieldBegin(OPERANDS_FIELD_DESC);
          {
            ...
            for (Expression _iter111 : struct.operands)
            {
      ...
      if (struct.aggregationBinding != null) {
        if (struct.isSetAggregationBinding()) {
          oprot.writeFieldBegin(AGGREGATION_BINDING_FIELD_DESC);
          struct.aggregationBinding.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      ...
      if (struct.isSetOperands()) {
        {
          ...
          for (Expression _iter112 : struct.operands)
          {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.operands = new java.util.ArrayList<Expression>(_list113.size);
            @org.apache.thrift.annotation.Nullable Expression _elem114;
            for (int _i115 = 0; _i115 < _list113.size; ++_i115)
            {
              _elem114 = new Expression();
              _elem114.read(iprot);
              struct.operands.add(_elem114);
            }
          }
          struct.setOperandsIsSet(true);
        }
