...
/// segmentSelector - [TierSegmentSelector] strategy used by the tier to select eligible segments of a table
/// storage - [TierStorage] used by the tier as storage for the eligible segments
public class Tier {
