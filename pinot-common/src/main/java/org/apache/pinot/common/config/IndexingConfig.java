...
public class IndexingConfig {
  ...
  @ConfigKey("textIndexColumns")
  private List<String> _textIndexColumns; // list of columns on which text search is enabled
  ...
  public void setTextIndexColumns(List<String> textIndexColumns) {
