...
/**
 * This class implements the BrokerResponse interface using JSONObjects as fields.
 *
 */
public class BrokerResponseJSON implements BrokerResponse {
  ...
  public static final BrokerResponseJSON EMPTY_RESULT;
  public static final BrokerResponseJSON NO_TABLE_RESULT;


  static {
    EMPTY_RESULT = new BrokerResponseJSON();
    EMPTY_RESULT.setTimeUsedMs(0);

    NO_TABLE_RESULT = new BrokerResponseJSON();
  ...
  public static BrokerResponseJSON fromJson(JSONObject retJsonObject) throws JSONException {
  ...
  public BrokerResponseFactory.ResponseType getResponseType() {
    return BrokerResponseFactory.ResponseType.BROKER_RESPONSE_TYPE_JSON;
  }

  public static BrokerResponseJSON getNullBrokerResponse() {
    return NO_TABLE_RESULT;
  }

  public static BrokerResponseJSON getEmptyBrokerResponse() {
    return EMPTY_RESULT;
  }
}
