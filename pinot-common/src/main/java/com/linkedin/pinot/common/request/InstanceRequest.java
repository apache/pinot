            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.searchSegments = new ArrayList<String>(_list78.size);
                String _elem79;
                for (int _i80 = 0; _i80 < _list78.size; ++_i80)
                {
                  _elem79 = iprot.readString();
                  struct.searchSegments.add(_elem79);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.searchSegments != null) {
        if (struct.isSetSearchSegments()) {
          oprot.writeFieldBegin(SEARCH_SEGMENTS_FIELD_DESC);
          {
            ...
            for (String _iter81 : struct.searchSegments)
            {
      ...
      if (struct.isSetSearchSegments()) {
        {
          ...
          for (String _iter82 : struct.searchSegments)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.searchSegments = new ArrayList<String>(_list83.size);
          String _elem84;
          for (int _i85 = 0; _i85 < _list83.size; ++_i85)
          {
            _elem84 = iprot.readString();
            struct.searchSegments.add(_elem84);
          }
        }
        struct.setSearchSegmentsIsSet(true);
      }
