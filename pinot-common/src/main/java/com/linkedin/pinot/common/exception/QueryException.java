...
public class QueryException {
  ...
  public static final int ACESS_DENIED_ERROR_CODE = 180;
  ...
  public static final ProcessingException ACCESS_DENIED_ERROR = new ProcessingException(ACESS_DENIED_ERROR_CODE);
