            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.debugOptions = new HashMap<String,String>(2*_map71.size);
                String _key72;
                String _val73;
                for (int _i74 = 0; _i74 < _map71.size; ++_i74)
                {
                  ...
                  struct.debugOptions.put(_key72, _val73);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.queryOptions = new HashMap<String,String>(2*_map75.size);
                String _key76;
                String _val77;
                for (int _i78 = 0; _i78 < _map75.size; ++_i78)
                {
                  ...
                  struct.queryOptions.put(_key76, _val77);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.aggregationsInfo != null) {
        if (struct.isSetAggregationsInfo()) {
          oprot.writeFieldBegin(AGGREGATIONS_INFO_FIELD_DESC);
          {
            ...
            for (AggregationInfo _iter79 : struct.aggregationsInfo)
            {
              _iter79.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.debugOptions != null) {
        if (struct.isSetDebugOptions()) {
          oprot.writeFieldBegin(DEBUG_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter80 : struct.debugOptions.entrySet())
            {
      ...
      if (struct.queryOptions != null) {
        if (struct.isSetQueryOptions()) {
          oprot.writeFieldBegin(QUERY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter81 : struct.queryOptions.entrySet())
            {
      ...
      if (struct.isSetAggregationsInfo()) {
        {
          ...
          for (AggregationInfo _iter82 : struct.aggregationsInfo)
          {
            _iter82.write(oprot);
          }
        }
      ...
      if (struct.isSetDebugOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter83 : struct.debugOptions.entrySet())
          {
      ...
      if (struct.isSetQueryOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter84 : struct.queryOptions.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.aggregationsInfo = new ArrayList<AggregationInfo>(_list85.size);
          AggregationInfo _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new AggregationInfo();
            _elem86.read(iprot);
            struct.aggregationsInfo.add(_elem86);
          }
        }
        struct.setAggregationsInfoIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.debugOptions = new HashMap<String,String>(2*_map88.size);
          String _key89;
          String _val90;
          for (int _i91 = 0; _i91 < _map88.size; ++_i91)
          {
            ...
            struct.debugOptions.put(_key89, _val90);
          }
        }
        struct.setDebugOptionsIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.queryOptions = new HashMap<String,String>(2*_map92.size);
          String _key93;
          String _val94;
          for (int _i95 = 0; _i95 < _map92.size; ++_i95)
          {
            ...
            struct.queryOptions.put(_key93, _val94);
          }
        }
        struct.setQueryOptionsIsSet(true);
      }
