            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.debugOptions = new HashMap<String,String>(2*_map63.size);
                String _key64;
                String _val65;
                for (int _i66 = 0; _i66 < _map63.size; ++_i66)
                {
                  ...
                  struct.debugOptions.put(_key64, _val65);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.aggregationsInfo != null) {
        if (struct.isSetAggregationsInfo()) {
          oprot.writeFieldBegin(AGGREGATIONS_INFO_FIELD_DESC);
          {
            ...
            for (AggregationInfo _iter67 : struct.aggregationsInfo)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.debugOptions != null) {
        if (struct.isSetDebugOptions()) {
          oprot.writeFieldBegin(DEBUG_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter68 : struct.debugOptions.entrySet())
            {
      ...
      if (struct.isSetAggregationsInfo()) {
        {
          ...
          for (AggregationInfo _iter69 : struct.aggregationsInfo)
          {
            _iter69.write(oprot);
          }
        }
      ...
      if (struct.isSetDebugOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter70 : struct.debugOptions.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.aggregationsInfo = new ArrayList<AggregationInfo>(_list71.size);
          AggregationInfo _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new AggregationInfo();
            _elem72.read(iprot);
            struct.aggregationsInfo.add(_elem72);
          }
        }
        struct.setAggregationsInfoIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.debugOptions = new HashMap<String,String>(2*_map74.size);
          String _key75;
          String _val76;
          for (int _i77 = 0; _i77 < _map74.size; ++_i77)
          {
            ...
            struct.debugOptions.put(_key75, _val76);
          }
        }
        struct.setDebugOptionsIsSet(true);
      }
