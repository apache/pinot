      ...
      if (struct.aggregationsInfo != null) {
        if (struct.isSetAggregationsInfo()) {
          oprot.writeFieldBegin(AGGREGATIONS_INFO_FIELD_DESC);
          {
            ...
            for (AggregationInfo _iter75 : struct.aggregationsInfo)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.debugOptions != null) {
        if (struct.isSetDebugOptions()) {
          oprot.writeFieldBegin(DEBUG_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter76 : struct.debugOptions.entrySet())
            {
      ...
      if (struct.isSetAggregationsInfo()) {
        {
          ...
          for (AggregationInfo _iter77 : struct.aggregationsInfo)
          {
            _iter77.write(oprot);
          }
        }
      ...
      if (struct.isSetDebugOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter78 : struct.debugOptions.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.aggregationsInfo = new ArrayList<AggregationInfo>(_list79.size);
          AggregationInfo _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new AggregationInfo();
            _elem80.read(iprot);
            struct.aggregationsInfo.add(_elem80);
          }
        }
        struct.setAggregationsInfoIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.debugOptions = new HashMap<String,String>(2*_map82.size);
          String _key83;
          String _val84;
          for (int _i85 = 0; _i85 < _map82.size; ++_i85)
          {
            ...
            struct.debugOptions.put(_key83, _val84);
          }
        }
        struct.setDebugOptionsIsSet(true);
      }
