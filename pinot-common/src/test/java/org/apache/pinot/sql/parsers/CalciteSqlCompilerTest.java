...
public class CalciteSqlCompilerTest {
  ...
  public void testSqlDistinctQueryCompilation() {
    ...
    Assert.assertEquals(aggregationInfo.getAggregationFunctionArgs().get(0), "c1");
    ...
    Assert.assertEquals(aggregationInfo.getAggregationType(), AggregationFunctionType.DISTINCT.getName());
    Assert.assertEquals(aggregationInfo.getAggregationFunctionArgs(), Arrays.asList("c1", "c2"));
    ...
    aggregationInfo = aggregationInfos.get(0);
    Assert.assertEquals(aggregationInfo.getAggregationType(), AggregationFunctionType.DISTINCT.getName());
    Assert.assertEquals(aggregationInfo.getAggregationFunctionArgs(), Arrays.asList("c1", "c2", "c3"));
    ...
    aggregationInfo = aggregationInfos.get(0);
    Assert.assertEquals(aggregationInfo.getAggregationType(), AggregationFunctionType.DISTINCT.getName());
    Assert.assertEquals(aggregationInfo.getAggregationFunctionArgs().get(0), "add(col1,col2)");
    ...
    aggregationInfo = aggregationInfos.get(0);
    Assert.assertEquals(aggregationInfo.getAggregationType(), AggregationFunctionType.DISTINCT.getName());
    Assert.assertEquals(aggregationInfo.getAggregationFunctionArgs(),
