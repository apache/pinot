...
public class RoundRobinURIProviderTest {
  ...
  public void testHostAddressRoundRobin()
    ...
    TestCase[] testCases = new TestCase[]{
        ...
        new TestCase("http://localhost", new String[]{"http://localhost"}),
        new TestCase("http://localhost/", new String[]{"http://localhost/"}),
        new TestCase("http://localhost/?", new String[]{"http://localhost/?"}),
        new TestCase("http://localhost/?it=5", new String[]{"http://localhost/?it=5"}),
        new TestCase("http://localhost/me/out?it=5", new String[]{"http://localhost/me/out?it=5"}),
        new TestCase("http://localhost:20000", new String[]{"http://localhost:20000"}),
        new TestCase("http://localhost:20000/", new String[]{"http://localhost:20000/"}),
        new TestCase("http://localhost:20000/?", new String[]{"http://localhost:20000/?"}),
        new TestCase("http://localhost:20000/?it=5", new String[]{"http://localhost:20000/?it=5"}),
        new TestCase("http://localhost:20000/me/out?it=5", new String[]{"http://localhost:20000/me/out?it=5"}),
        ...
        new TestCase("https://localhost", new String[]{"https://localhost"}),
        new TestCase("https://localhost/", new String[]{"https://localhost/"}),
        new TestCase("https://localhost/?", new String[]{"https://localhost/?"}),
        new TestCase("https://localhost/?it=5", new String[]{"https://localhost/?it=5"}),
        new TestCase("https://localhost/me/out?it=5", new String[]{"https://localhost/me/out?it=5"}),
        new TestCase("https://localhost:20000", new String[]{"https://localhost:20000"}),
        new TestCase("https://localhost:20000/", new String[]{"https://localhost:20000/"}),
        new TestCase("https://localhost:20000/?", new String[]{"https://localhost:20000/?"}),
        new TestCase("https://localhost:20000/?it=5", new String[]{"https://localhost:20000/?it=5"}),
        new TestCase("https://localhost:20000/me/out?it=5",
            new String[]{"https://localhost:20000/me/out?it=5"}),
