...
public class QueryFingerprintVisitorTest {
  ...
  public void testInClause() throws Exception {
    String sql = "SELECT col1 FROM table1 WHERE col2 IN (100, 200, 300)";
    String expected = "SELECT `col1` FROM `table1` WHERE `col2` IN (?, ?, ?)";
    String actual = generateFingerprint(sql);
    assertEquals(actual, expected, "IN clause literals should be replaced with ?");
  }
  ...
  public void testComplexQuery() throws Exception {
    ...
    String actual = generateFingerprint(sql);
    assertEquals(actual, expected, "Complex query should preserve structure and replace all literals with ?");
  }
  ...
  public void testArrayConstructor() throws Exception {
    ...
    String expected = "SELECT `col1` FROM `table1` WHERE `col2` IN (?, ?, ?, ?, ?)";
    String actual = generateFingerprint(sql);
    assertEquals(actual, expected, "IN clause with multiple values should have all literals replaced with ?");
  }
