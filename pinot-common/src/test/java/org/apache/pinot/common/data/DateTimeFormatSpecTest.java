...
public class DateTimeFormatSpecTest {
  ...
  public void testConstructFormatPipe(String dateTimeFormat, TimeUnit timeUnit, String columnTimeFormat, int size, String timeZone,
    ...
    try {
      formatActual1 = new DateTimeFormatSpec(dateTimeFormat, timeUnit.toString(), size);
    } catch (Exception e) {
      // invalid arguments
    }
    ...
    try {
      formatActual2 = new DateTimeFormatSpec(dateTimeFormat, columnTimeFormat, timeZone);
    } catch (Exception e) {
      // invalid arguments
    }
  ...
  @DataProvider(name = "testConstructFormatDataProviderPipe")
  public Object[][] provideTestConstructFormatDataPipe() {
