...
public class FileUploadDownloadClientTest {
  ...
  private static class testSegmentUploadHandler implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
      ...
      FileUploadDownloadClient.FileUploadType uploadType = FileUploadDownloadClient.FileUploadType.valueOf(uploadTypeStr);

      String downloadUri = null;
      String crypter = null;

      if (uploadType == FileUploadDownloadClient.FileUploadType.JSON) {
      ...
      } else if (uploadType == FileUploadDownloadClient.FileUploadType.URI) {
