...
public final class FSA5Test extends TestBase {
  ...
  public void testVersion5WithNumbers() throws IOException {
    final FSA fsa = FSA.read(this.getClass().getResourceAsStream("/resources/abc-numbers.fsa"));
  ...
  public void testArcsAndNodes() throws IOException {
    final FSA fsa1 = FSA.read(this.getClass().getResourceAsStream("/resources/abc.fsa"));
    final FSA fsa2 = FSA.read(this.getClass().getResourceAsStream("/resources/abc-numbers.fsa"));
