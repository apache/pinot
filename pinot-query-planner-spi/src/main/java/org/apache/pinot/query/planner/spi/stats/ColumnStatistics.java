...
public class ColumnStatistics {
  ...
  ///
  /// [#columnName(String)] is required; every other field is optional. Default values: string
  /// fields default to `null`, numeric fields to `-1` (unknown), confidence fields to
  ...
  public static class Builder {
    ...
    ///
    /// @throws NullPointerException if no column name was set; [#getColumnName()] is declared
    ///     non-null, so a nameless instance would hand callers a null they cannot see coming.
