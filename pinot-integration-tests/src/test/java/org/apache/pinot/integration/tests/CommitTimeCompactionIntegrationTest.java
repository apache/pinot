...
public class CommitTimeCompactionIntegrationTest extends BaseClusterIntegrationTest {
  ...
  protected void forceCommit(String tableName1, String tableName2, String tableName3)
      throws Exception {
    sendPostRequest(getAdminUrlBuilder().forTableForceCommit(tableName1));
    sendPostRequest(getAdminUrlBuilder().forTableForceCommit(tableName2));
    sendPostRequest(getAdminUrlBuilder().forTableForceCommit(tableName3));
  }
