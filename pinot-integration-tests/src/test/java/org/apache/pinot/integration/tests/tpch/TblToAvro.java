...
public final class TblToAvro {
  ...
  private static final Map<String, String[]> TABLE_NAME_FIELDS_MAP = Map.of(
      ...
      "customer",
      new String[]{
          "c_custkey", LONG_TYPE, "c_name", STRING_TYPE, "c_address", STRING_TYPE, "c_nationkey", LONG_TYPE,
          "c_phone", STRING_TYPE, "c_acctbal", DOUBLE_TYPE, "c_mktsegment", STRING_TYPE, "c_comment", STRING_TYPE
      },
      ...
      "lineitem",
      new String[]{
          "l_orderkey", LONG_TYPE, "l_partkey", LONG_TYPE, "l_suppkey", LONG_TYPE, "l_linenumber", LONG_TYPE,
          "l_quantity",
          LONG_TYPE, "l_extendedprice", DOUBLE_TYPE, "l_discount", DOUBLE_TYPE, "l_tax", DOUBLE_TYPE,
          "l_returnflag",
          STRING_TYPE, "l_linestatus", STRING_TYPE, "l_shipdate", STRING_TYPE, "l_commitdate", STRING_TYPE,
          "l_receiptdate", STRING_TYPE, "l_shipinstruct", STRING_TYPE, "l_shipmode", STRING_TYPE, "l_comment",
          STRING_TYPE
      },
      ...
      "orders",
      new String[]{
          "o_orderkey", LONG_TYPE, "o_custkey", LONG_TYPE, "o_orderstatus", STRING_TYPE, "o_totalprice",
          DOUBLE_TYPE,
      ...
      "supplier",
      new String[]{
          "s_suppkey", LONG_TYPE, "s_name", STRING_TYPE, "s_address", STRING_TYPE, "s_nationkey", LONG_TYPE,
          "s_phone",
