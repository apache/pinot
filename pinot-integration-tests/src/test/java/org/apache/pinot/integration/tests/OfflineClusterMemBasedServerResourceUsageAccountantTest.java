 ...
 */
public class OfflineClusterMemBasedServerResourceUsageAccountantTest extends BaseClusterIntegrationTestSet {
  ...
  protected void overrideBrokerConf(PinotConfiguration brokerConf) {
    ...
    brokerConf.setProperty(prefix + Accounting.CONFIG_OF_ALARMING_LEVEL_HEAP_USAGE_RATIO, 0f);
    brokerConf.setProperty(prefix + Accounting.CONFIG_OF_CRITICAL_LEVEL_HEAP_USAGE_RATIO, 0.6f);
