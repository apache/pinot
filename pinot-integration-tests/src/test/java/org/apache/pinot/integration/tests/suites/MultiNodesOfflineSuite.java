...
/// Runs the focused multi-node offline scenarios with one shared cluster.
...
@SelectMethod(type = MultiNodesOfflineClusterIntegrationTest.class, name = "testConstantExpressionQuery")
public class MultiNodesOfflineSuite {
}
