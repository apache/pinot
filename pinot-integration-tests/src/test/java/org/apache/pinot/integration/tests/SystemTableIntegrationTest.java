...
public class SystemTableIntegrationTest extends BaseClusterIntegrationTestSet {
  ...
  public void testSystemTablesSize()
      throws Exception {
    JsonNode controllerSize = JsonUtils.stringToJsonNode(
        sendGetRequest(getControllerBaseApiUrl() + "/tables/mytable/size?verbose=true&includeReplacedSegments=false"));
