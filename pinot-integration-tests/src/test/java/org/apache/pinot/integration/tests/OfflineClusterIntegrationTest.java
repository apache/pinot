...
public class OfflineClusterIntegrationTest extends ClusterTest {
  ...
  public void testInvertedIndexTriggering()
    ...
    addInvertedIndex();
    long tableSizeAfterAddingIndexAgain = getTableSize(_testDataSet.getTableName());
    ...
    TestUtils.waitForCondition(aVoid -> {
      try {
        ...
        assertEquals(queryResponse.get("totalDocs").asLong(), numTotalDocs);
        return getTableSize(_testDataSet.getTableName()) < tableSizeAfterAddingIndexAgain;
      } catch (Exception e) {
        throw new RuntimeException(e);
      }
  ...
  protected static class OfflineClusterIntegrationTestDataSet extends DefaultIntegrationTestDataSet {
    ...
    public OfflineClusterIntegrationTestDataSet(OfflineClusterIntegrationTest clusterTest) {
      super(clusterTest);
