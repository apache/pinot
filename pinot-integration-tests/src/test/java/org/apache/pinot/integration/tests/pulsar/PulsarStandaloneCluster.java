package org.apache.pinot.integration.tests.pulsar;
...
public class PulsarStandaloneCluster {
  ...
  public static final String DEFAULT_STANDALONE_CONF = "pulsar/standalone.properties";
  ...
  public void start()
      throws Exception {
    URL file = PulsarStandaloneCluster.class.getClassLoader().getResource(DEFAULT_STANDALONE_CONF);
    final File clusterConfigFile = new File(file.toURI());
    ...
    if (config.getZookeeperServers() != null) {
      _pulsarStandalone.setZkPort(2191);
    }
