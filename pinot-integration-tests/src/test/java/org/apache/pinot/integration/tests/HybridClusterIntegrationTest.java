...
public class HybridClusterIntegrationTest extends BaseHybridClusterIntegrationTest {
  ...
  public void testUpdateBrokerResource()
    ...
    try {
      sendDeleteRequest(getOrCreateAdminClient().getControllerRequestURLBuilder().forInstance(brokerId));
    ...
    sendPutRequest(getOrCreateAdminClient().getControllerRequestURLBuilder()
  ...
  public void testSegmentMetadataApi()
      throws Exception {
    {
      String jsonOutputStr = sendGetRequest(getOrCreateAdminClient().getControllerRequestURLBuilder()
      ...
      jsonOutputStr = sendGetRequest(getOrCreateAdminClient().getControllerRequestURLBuilder()
