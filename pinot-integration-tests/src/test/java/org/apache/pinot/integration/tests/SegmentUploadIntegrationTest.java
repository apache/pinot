...
public class SegmentUploadIntegrationTest extends BaseClusterIntegrationTest {
  ...
  public void testUploadAndQuery()
    ...
    tableSpec.setTableConfigURI(
        getOrCreateAdminClient().getControllerRequestURLBuilder().forUpdateTableConfig(getTableName()));
  ...
  private long getNumDocs(String segmentName)
    ...
    return JsonUtils.stringToJsonNode(
            sendGetRequest(
                getOrCreateAdminClient().getControllerRequestURLBuilder().forSegmentMetadata(getTableName(),
                    segmentName)))
