...
public class UpsertTableIntegrationTest extends BaseClusterIntegrationTest {
  ...
  public void testUpsertCompaction()
    ...
    sendPostRequest(getOrCreateAdminClient().getControllerRequestURLBuilder().forPauseConsumption(tableName));
    waitForNumQueriedSegmentsToConverge(tableName, 600_000L, 3, 0);
    sendPostRequest(getOrCreateAdminClient().getControllerRequestURLBuilder().forResumeConsumption(tableName));
  ...
  public void testUpsertCompactionWithSoftDelete()
    ...
    sendPostRequest(getOrCreateAdminClient().getControllerRequestURLBuilder().forTableForceCommit(tableName));
