...
public class WindowFunnelTestBase extends CustomDataQueryClusterIntegrationTest {
  protected static final String DEFAULT_TABLE_NAME = "WindowFunnelTest";
  protected static final String URL_COLUMN = "url";
  protected static final String TIMESTAMP_COLUMN = "timestampCol";
  protected static final String USER_ID_COLUMN = "userId";
  protected static long _countStarResult = 0;
