...
///
/// This test uses a single Kafka partition. UUID primary keys must be in canonical lowercase form (enforced at
/// ingestion time by `DataTypeTransformer`) because Kafka partition routing is determined by the raw string value
