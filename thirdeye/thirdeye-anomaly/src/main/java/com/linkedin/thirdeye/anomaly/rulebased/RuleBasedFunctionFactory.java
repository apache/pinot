...
import com.linkedin.thirdeye.anomaly.function.AnomalyDetectionFunctionAbsoluteChange;
import com.linkedin.thirdeye.anomaly.function.AnomalyDetectionFunctionConsecutive;
import com.linkedin.thirdeye.anomaly.function.AnomalyDetectionFunctionCronDefinition;
import com.linkedin.thirdeye.anomaly.function.AnomalyDetectionFunctionPercentChange;
...
public class RuleBasedFunctionFactory extends AnomalyDetectionFunctionFactory {
  ...
  public AnomalyDetectionFunction getFunction(StarTreeConfig starTreeConfig, AnomalyDatabaseConfig dbconfig,
      FunctionTableRow functionTableRow) throws Exception {
    if (functionTableRow instanceof RuleBasedFunctionTableRow == false) {
      throw new InstantiationException("cannot build rule based function from row type");
    }
