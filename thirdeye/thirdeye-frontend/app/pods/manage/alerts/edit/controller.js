...
export default Ember.Controller.extend({
  ...
  // is granularity window or bucket unit
  granularity: Ember.computed.reads('model.windowUnit'),
  ...
  properties: Ember.computed('model.properties', function() {
    return this.get('model.properties')
      .split(';')
      .filter(prop => prop)
      .map(prop => prop.split('='))
  ...
  pattern: Ember.computed('properties', function() {
    const props = this.get('properties');

    return props.pattern;
  }),

  weeklyEffect: Ember.computed('properties', function() {
    const props = this.get('properties');
