...
public class TestThirdEyeClientConfig {
  ...
  public void fromSampleFile() throws Exception {
    ...
    ThirdEyeClientConfig pinotCacheDisabledConfig = clients.get(0);
    ...
    ThirdEyeClientConfig defaultCacheEnabledConfig = clients.get(1);
    ...
    ThirdEyeClientConfig customCacheConfigConfig = clients.get(2);
    ...
    ThirdEyeClientConfig cacheEnabledConfig = clients.get(3);
