...
public class IngraphMetricConfigBean extends AbstractBean {
  ...
  public String toString() {
    return "IngraphMetricConfigBean [rrdName=" + rrdName + ", metricName=" + metricName
        + ", dashboardName=" + dashboardName + ", metricDataType=" + metricDataType
        + ", metricSourceType=" + metricSourceType + ", container=" + container + "]";
  }
