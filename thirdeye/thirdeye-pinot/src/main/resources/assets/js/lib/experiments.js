var entityData;
var editor;
var adminUser = '21232f297a57a5a743894a0e4a801fc3';
var adminPass ='2f13610d2675823ed3e71970b4e97fc4';
...
function renderAdminLogin() {
  $('#admin').html('<label>User Name :</label> <input type="text" name="username" id="username"/> <label>Password :</label> <input type="password" name="password" id="password"/> <input type="button" value="Login" id="submit" onclick="validateLogin()"/>');
}

function renderAdminPage() {
  $('#admin').html("<h2>Welcome Thirdeye Admin!</h2>"
      ...
      + "<li class='uk-hidden'><a onclick='renderFunctionAnalyze()'>Test Anomaly Functions</a></li></ul></td>" + "<td id='admin-display-area'></td>"
      + "</tr></table>");
...
function validateLogin() {
  ...
  if (MD5(username) == adminUser && MD5(password) == adminPass) {
    renderAdminPage();
  } else {
     renderAdminLogin();
  }
