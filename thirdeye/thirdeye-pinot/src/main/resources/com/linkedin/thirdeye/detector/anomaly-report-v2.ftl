<table border="0" cellpadding="0" cellspacing="0"
  ...
  <tr>
    <td style="min-height: 30px; font-family: 'Proxima Nova','Arial', 'Helvetica Neue',Helvetica, sans-serif;font-size:16px;font-weight:300; width:100%;display:inline;">
      <p>Hello,</p>
      <p>You are receiving this email because you have subscribed to ThirdEye Anomaly alert
        service '${alertName}'.<br/></p>
    <#if (anomalyCount > 0)>
      <p> ThirdEye has analyzed your metrics for time range ${dateFormat(startTime)}
