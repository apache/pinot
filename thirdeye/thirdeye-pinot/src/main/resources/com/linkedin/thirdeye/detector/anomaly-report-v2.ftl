            ...
            <td style="padding: 24px;" colspan="2">
              <table style="width:100%; text-align: center; padding:0; margin:0; border-collapse: collapse; border: 1px solid #CCC" border="0" align="center">
                <tr>
                  ...
                  <td colspan="33%" style="border: 1px solid #CCC; width:33%; padding: 14px;"><div style="color: #737373;">${r.currentVal}</div><div style="font-weight:600;">Current</div></td>
                  <td colspan="33%" style="border: 1px solid #CCC; width:33%; padding: 14px;"><div style="color: #737373;">${r.baselineVal}</div><div style="font-weight:600;">Baseline</div></td>
                </tr>
                <tr>
