...
public class ConfigTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String id = "1";
    configDAO.create(collectionName + "_" + id, dashBoardConfig);

    String id2 = "2";
    configDAO.create(collectionName + "_" + id2, dashBoardConfig2);

    String id3 = "3";
    configDAO.create(collectionName + "_" + id3, dashBoardConfig3);

    DashboardConfig config = configDAO.findById(collectionName + "_" + id);
