...
public class TestThirdEyeQuery {
  ...
  public void beforeClass() {
    dimensions = ImmutableList.of(new DimensionSpec("A"), new DimensionSpec("B"), new DimensionSpec("C"));
  }
  @BeforeMethod
  ...
  public void testGetDimensionCombinations_oneCombination() {
    ...
    Assert.assertEquals(combinations.get(0), new String[] { "A1", "B1", "C1" });
  }
  ...
  public void testGetDimensionCombinations_crossProduct() {
    ...
    Assert.assertEquals(combinations.get(0), new String[] { "A1", "B1", "C1" });
    Assert.assertEquals(combinations.get(1), new String[] { "A1", "B2", "C1" });
    Assert.assertEquals(combinations.get(2), new String[] { "A2", "B1", "C1" });
    Assert.assertEquals(combinations.get(3), new String[] { "A2", "B2", "C1" });
 }
  ...
  public void testGetDimensionCombinations_someStar() {
    ...
    Assert.assertEquals(combinations.size(), 1);
    Assert.assertEquals(combinations.get(0), new String[] { "A1", "*", "*" });
  }
  ...
  public void testGetDimensionCombinations_someStarCrossProduct() {
    ...
    Assert.assertEquals(combinations.get(0), new String[] { "A1", "*", "*" });
    Assert.assertEquals(combinations.get(1), new String[] { "A2", "*", "*" });
  }
}
