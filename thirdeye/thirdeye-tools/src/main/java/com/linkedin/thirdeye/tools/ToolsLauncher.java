...
public class ToolsLauncher {
  ...
  static {
    TOOLS.add(
        new ToolSpec(DataLoadTool.class, "Pulls data from HDFS and installs into data directory"));
    ...
    TOOLS.add(new ToolSpec(StandAloneKafkaConsumer.class,
        "Consumes data from Kafka and writes into server dir"));
    TOOLS.add(new ToolSpec(FixedToVariableFormatConvertor.class,
        "Converts data from Fixed format to Variable Size"));
