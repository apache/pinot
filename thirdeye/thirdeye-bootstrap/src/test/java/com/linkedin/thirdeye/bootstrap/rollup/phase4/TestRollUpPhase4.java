...
public class TestRollUpPhase4
{
  ...
  public void setUp() throws Exception
  {
    ...
    configuration.set(RollupPhaseFourConstants.ROLLUP_PHASE4_CONFIG_PATH.toString(), ClassLoader.getSystemResource(CONF_FILE).toString());
...
class TestHelper
{
  public static MetricTimeSeries generateMetricTimeSeries(RollupPhaseFourConfig rollUpConfig, int value)
  {
