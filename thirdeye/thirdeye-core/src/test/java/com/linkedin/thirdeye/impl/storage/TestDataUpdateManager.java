...
public class TestDataUpdateManager {
  ...
  public void testExpireSegments() throws Exception {
    ...
    // Create hourly folders for 2015-05-31, 2015-06-01
      File dataDirHourly1 = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.HOURLY.name(), dataDirs[0][0], dataDirs[0][1]));
      FileUtils.forceMkdir(dataDirHourly1);
      File dataDirHourly2 = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.HOURLY.name(), dataDirs[1][0], dataDirs[1][1]));
      FileUtils.forceMkdir(dataDirHourly2);
      File dataDirHourly3 = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.HOURLY.name(), dataDirs[2][0], dataDirs[2][1]));
      ...
      File dataDirDaily1 = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.DAILY.name(), dataDirs[3][0], dataDirs[3][1]));
      ...
      File dataDirDaily2 = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.DAILY.name(), dataDirs[4][0], dataDirs[4][1]));
      FileUtils.forceMkdir(dataDirDaily2);
      // Create monthly folder for 2015-05
      File dataDirMonthly = new File(collectionDir,
          StorageUtils.getDataDirName(treeId, StarTreeConstants.Schedule.MONTHLY.name(), dataDirs[5][0], dataDirs[5][1]));
