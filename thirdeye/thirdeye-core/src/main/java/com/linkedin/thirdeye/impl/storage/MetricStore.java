...
public interface MetricStore {
  /**
   * @param id
   *          The dimension id, obtained from
   *          {@link DimensionStore#findMatchingKeys(com.linkedin.thirdeye.api.DimensionKey)}
   * @param timeSeries
   ...
   * @param timeRange
   *          The time range for which to get aggregate time series (if null, all time in the metric
   *          store)
   * @return
