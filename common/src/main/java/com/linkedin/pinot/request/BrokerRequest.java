            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  AggregationInfo _elem62;
                  _elem62 = new AggregationInfo();
                  _elem62.read(iprot);
                  struct.aggregationsInfo.add(_elem62);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(5)) {
        {
          ...
          {
            AggregationInfo _elem67;
            _elem67 = new AggregationInfo();
            _elem67.read(iprot);
            struct.aggregationsInfo.add(_elem67);
          }
        }
        struct.setAggregationsInfoIsSet(true);
      }
