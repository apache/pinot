...
public class PhysicalIntersect extends Intersect implements PRelNode {
  ...
  public PhysicalIntersect(RelOptCluster cluster, RelTraitSet traits, List<RelHint> hints, List<PRelNode> inputs,
  ...
  public PRelNode with(int newNodeId, List<PRelNode> newInputs, PinotDataDistribution newDistribution) {
    return new PhysicalIntersect(
        getCluster(), getTraitSet(), getHints(), newInputs, all, newNodeId, newDistribution);
  }
}
