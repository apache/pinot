...
/// `PlanNodeVisitor` is a skeleton class that allows for implementations of `PlanNode`
/// tree traversals using the [PlanNode#visit(PlanNodeVisitor, Object)] method. There is no
...
/// functionality (see [org.apache.pinot.query.planner.explain.PhysicalExplainPlanVisitor#explain(
...
/// @param <C> a Context that will be passed as the second parameter to `PlanNode#visit`,
...
public interface PlanNodeVisitor<T, C> {
  ...
  /// (see [#visitChildren(PlanNode, Object)]) and then returning the result of calling
  /// [#postChildren(PlanNode, Object)].
  ///
