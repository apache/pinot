...
public class QueryEnvironment {
  ...
  public QueryEnvironment(Config config, CrossClusterFederationProvider crossClusterFederationProvider) {
    _envConfig = config;
  ...
  private DispatchableSubPlan toDispatchableSubPlan(RelRoot relRoot, PlannerContext plannerContext,
    ...
    return pinotDispatchPlanner.createDispatchableSubPlan(plan, _crossClusterFederationProvider);
  }
