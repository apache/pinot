...
public class PinotDispatchPlanner {
  ...
  private void runValidations(PlanFragment planFragment, DispatchablePlanContext context) {
    ...
    if (rootPlanNode.getStageId() == 0) {
      RawVariantValidationVisitor.validateResultSchema(rootPlanNode.getDataSchema(),
    ...
    rootPlanNode.visit(RawVariantValidationVisitor.INSTANCE, null);
