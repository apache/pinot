...
/// methods like [#containsStage(MailboxSendNode)] are called.
///
/// The original reason to have this class was to group equivalent stages together, although it can be used for other
/// purposes.
///
/// Although the only implementation provided so far ([Mutable]) is mutable, the class is designed
...
public abstract class GroupedStages {
  ...
  /// A mutable version of [GroupedStages].
