...
public class DispatchablePlanVisitor implements PlanNodeVisitor<Void, DispatchablePlanContext> {
  ...
  public DispatchablePlanVisitor(TableCache tableCache, CrossClusterFederationProvider crossClusterFederationProvider) {
  ...
  public Void visitTableScan(TableScanNode node, DispatchablePlanContext context) {
    ...
    if (tableName == null) {
      ...
      LogicalTableRouteProvider tableRouteProvider = new LogicalTableRouteProvider(_crossClusterFederationProvider);
