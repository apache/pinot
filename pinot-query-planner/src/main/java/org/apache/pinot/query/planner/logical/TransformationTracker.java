...
/// [org.apache.pinot.core.plan.PinotExplainedRelNode] nodes returned by each server.
///
...
///
/// Trackers are, in deep, very similar to [java.util.Map#get(Object)] on a map from derived objects to creator
/// objects.
...
public interface TransformationTracker<D, C> {
  ...
  /// Builder for [TransformationTracker].
  ///
  ...
  ///
  /// While a [TransformationTracker] can be seen as the [java.util.Map#get(Object)] method of a map from
  /// derived objects to creator objects, the builder can be seen as the [java.util.Map#put(Object, Object)].
