...
public class QueryEnvironmentTestBase {
  ...
  static {
    TABLE_SCHEMAS.put("a_REALTIME", getSchemaBuilder().setSchemaName("a").build());
    TABLE_SCHEMAS.put("b_REALTIME", getSchemaBuilder().setSchemaName("b").build());
    TABLE_SCHEMAS.put("c_OFFLINE", getSchemaBuilder().setSchemaName("c").build());
    TABLE_SCHEMAS.put("d", getSchemaBuilder().setSchemaName("d").build());
    TABLE_SCHEMAS.put("e",
        getSchemaBuilder().addSingleValueDimension("$ts$MONTH", FieldSpec.DataType.LONG).setSchemaName("e").build());
  }

  /**
   * Get a new SchemaBuilder for testing with basic fields.
   */
  static Schema.SchemaBuilder getSchemaBuilder() {
