...
/// A factory used to create [PinotDataBuffer] instances.
///
/// Normal code should not use factories directly. [PinotDataBuffer] static methods should be used instead. These
/// static methods delegate on a factory and also accounts the amount of memory that is being reserved and export that
/// as a [org.apache.pinot.spi.metrics.PinotMetric].
