...
public interface IndexSegment {
  ...
  /// Returns the [SegmentMetadata] of the segment.
  ///
  ...
  /// Same as [#hasNoQueryableDocs], against [#getValidDocIds] instead.
  ...
  ///
  /// NOTE: don't use this method for high performance code. Use PinotSegmentRecordReader when reading multiple
  ...
  ///
  /// NOTE: don't use this method for high performance code. Use PinotSegmentColumnReader when reading multiple
