...
public enum AggregationFunctionType {
  ...
  COUNTMV("countMV", Collections.singletonList("count_MV"), SqlKind.OTHER_FUNCTION, SqlFunctionCategory.NUMERIC,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.explicit(SqlTypeName.BIGINT),
      ReturnTypes.explicit(SqlTypeName.BIGINT)),
  MINMV("minMV", Collections.singletonList("min_MV"), SqlKind.OTHER_FUNCTION, SqlFunctionCategory.SYSTEM,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.DOUBLE, ReturnTypes.explicit(SqlTypeName.DOUBLE)),
  MAXMV("maxMV", Collections.singletonList("max_MV"), SqlKind.OTHER_FUNCTION, SqlFunctionCategory.SYSTEM,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.DOUBLE, ReturnTypes.explicit(SqlTypeName.DOUBLE)),
  SUMMV("sumMV", Collections.singletonList("sum_MV"), SqlKind.OTHER_FUNCTION, SqlFunctionCategory.NUMERIC,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.DOUBLE, ReturnTypes.explicit(SqlTypeName.DOUBLE)),
  AVGMV("avgMV", Collections.singletonList("avg_MV"), SqlKind.AVG, SqlFunctionCategory.NUMERIC,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.DOUBLE, ReturnTypes.explicit(SqlTypeName.DOUBLE)),
  MINMAXRANGEMV("minMaxRangeMV", Collections.singletonList("minMaxRange_MV"), SqlKind.OTHER_FUNCTION, SqlFunctionCategory.NUMERIC,
      OperandTypes.family(SqlTypeFamily.ARRAY), ReturnTypes.explicit(SqlTypeName.OTHER), ReturnTypes.explicit(SqlTypeName.DOUBLE)),
