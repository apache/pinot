...
public enum AggregationFunctionType {
  ...
  MINLONG("minLong", ReturnTypes.BIGINT_FORCE_NULLABLE, OperandTypes.INTEGER),
  MAXLONG("maxLong", ReturnTypes.BIGINT_FORCE_NULLABLE, OperandTypes.INTEGER),
  SUM("sum", SqlTypeName.DOUBLE, SqlTypeName.DOUBLE),
  SUM0("$sum0", SqlTypeName.DOUBLE, SqlTypeName.DOUBLE),
  SUMINT("sumInt", ReturnTypes.BIGINT_FORCE_NULLABLE, OperandTypes.INTEGER),
  SUMLONG("sumLong", ReturnTypes.BIGINT_FORCE_NULLABLE, OperandTypes.INTEGER),
