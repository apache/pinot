...
public enum AggregationFunctionType {
  ...
  MINLONG("minLong", ReturnTypes.BIGINT, OperandTypes.INTEGER),
  MAXLONG("maxLong", ReturnTypes.BIGINT, OperandTypes.INTEGER),
  ...
  SUMLONG("sumLong", ReturnTypes.BIGINT, OperandTypes.INTEGER),
