...
public class ColumnMetadata {
  ...
  private final long columnTotalLength;
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    builder.setColumnTotalLength(
        config.getInt(V1Constants.MetadataKeys.Column.getKeyFor(column, V1Constants.MetadataKeys.Column.COLUMN_TOTAL_LENGTH)));
    int totalDocs =
  ...
  public static class Builder {
    ...
    private long columnTotalLength;
    ...
    public Builder setColumnTotalLength(int columnTotalLength) {
      this.columnTotalLength = columnTotalLength;
      return this;
    }
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalDocs, DataType dataType, int bitsPerElement,
      int columnMaxLength, long columnTotalLength, FieldType fieldType, boolean isSorted, boolean hasNulls, boolean hasDictionary,
  ...
  public long getColumnTotalLength() {
    return columnTotalLength;
  }
