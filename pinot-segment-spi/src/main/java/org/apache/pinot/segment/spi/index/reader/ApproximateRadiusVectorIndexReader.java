...
/// Extension of [VectorIndexReader] for backends that can evaluate a distance threshold
/// directly during ANN candidate generation.
///
/// The returned document set is approximate and backend-specific. Implementations may still miss
...
/// apply a correctness fallback when candidate limits are saturated.
public interface ApproximateRadiusVectorIndexReader extends VectorIndexReader {
  ...
  ///
  /// The backend may cap the number of candidates at `maxCandidates` for safety.
  ///
