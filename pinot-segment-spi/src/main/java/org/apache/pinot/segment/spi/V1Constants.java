...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Column {
      ...
      // Mandatory, treated as `DICTIONARY` when `hasDictionary=true`, `RAW` when `hasDictionary=false`
      ...
      // Optional legacy/raw transform function expression. New writers use TRANSFORM_FUNCTION_BASE64.
      public static final String TRANSFORM_FUNCTION = "transformFunction";
      // Optional Base64-encoded UTF-8 transform function expression used to generate the column.
      public static final String TRANSFORM_FUNCTION_BASE64 = "transformFunctionBase64";
      // Optional provenance version. Absent means the values predate transform provenance and must not be rewritten.
      public static final String TRANSFORM_FUNCTION_PROVENANCE_VERSION = "transformFunctionProvenanceVersion";
      // Optional dependency-aware fingerprint for the transform expression graph.
      public static final String TRANSFORM_FUNCTION_FINGERPRINT = "transformFunctionFingerprint";

      // Optional. The parent column name for columns materialized from an OPEN_STRUCT index.
