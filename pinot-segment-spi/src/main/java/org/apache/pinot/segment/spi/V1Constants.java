...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Column {
      ...
      // Optional. Transform function expression used to generate the column.
      public static final String TRANSFORM_FUNCTION = "transformFunction";
      // Optional. True when TRANSFORM_FUNCTION was written as a legacy-segment compatibility backfill and the
      // stored values were not regenerated from that expression.
