...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Column {
      ...
      // Optional. Transform function expression that actually produced the stored column values.
      public static final String TRANSFORM_FUNCTION = "transformFunction";
      // Optional. Transform function recorded for backward-compat on a legacy segment whose values were not
      // regenerated from that expression. Distinct from TRANSFORM_FUNCTION so a compatibility write cannot be
      // mistaken for a real persisted transform. Readers must also accept the boolean marker "true" written by an
      // earlier revision of this change, in which case the compat expression lives in TRANSFORM_FUNCTION.
      public static final String TRANSFORM_FUNCTION_BACKFILLED = "transformFunctionBackfilled";
