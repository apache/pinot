...
public class V1Constants {
  ...
  public static class MetadataKeys {
    ...
    public static class Column {
      ...
      // Optional. The parent OPEN_STRUCT column name for columns materialized from an OPEN_STRUCT index.
      // E.g. for column metrics$cpu with parent metrics:
      //   parentOpenStructColumn = metrics
      public static final String PARENT_OPEN_STRUCT_COLUMN = "parentOpenStructColumn";
