...
public abstract class SegmentDirectory implements Closeable {
  ...
  public abstract class Reader implements Closeable {
    ...
    /// index_map files, so access to its index data can be abstracted with SegmentDirectory.Reader interface too. In
    /// the
    /// future, if new kinds of multi-column index e.g. materialized views is added, this interface can be generalized
    /// to
    /// access them too.
    ///
    /// @param starTreeId to look for a specific index instance. The StarTree index can contain multiple index
    /// instances,
