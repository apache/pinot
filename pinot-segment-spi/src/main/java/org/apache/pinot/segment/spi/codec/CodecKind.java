...
public enum CodecKind {
  /// Reversible transformation over column-typed values. Typed-layout-preserving transforms (e.g.
  /// DELTA, DELTADELTA) may be chained; a packing transform (e.g. T64, GORILLA) emits bytes and
