...
public interface ColumnMetadata extends ColumnShape {
  ...
  /// Returns the transform function that actually produced the stored column values, if persisted.
  @Nullable
  String getTransformFunction();

  /// Returns the transform function recorded for backward-compat on a legacy segment, if any.
  /// Values were not regenerated from this expression, unlike [getTransformFunction].
  @Nullable
  String getTransformFunctionBackfilled();
