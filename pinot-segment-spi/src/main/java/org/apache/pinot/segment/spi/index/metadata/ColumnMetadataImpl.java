...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary,
      ...
      int totalNumberOfEntries, int maxNumberOfMultiValues, int bitsPerElement,
  ...
  public boolean equals(Object o) {
    ...
    return _totalDocs == that._totalDocs && _cardinality == that._cardinality && _hasDictionary == that._hasDictionary
        && _forwardIndexEncoding == that._forwardIndexEncoding && _sorted == that._sorted
        && _minMaxValueInvalid == that._minMaxValueInvalid && _lengthOfShortestElement == that._lengthOfShortestElement
  ...
  public String toString() {
    return "ColumnMetadataImpl{" + "_fieldSpec=" + _fieldSpec + ", _totalDocs=" + _totalDocs + ", _cardinality="
        ...
        + ", _sorted=" + _sorted + ", _minValue=" + _minValue + ", _maxValue=" + _maxValue
        + ", _minMaxValueInvalid=" + _minMaxValueInvalid + ", _lengthOfShortestElement=" + _lengthOfShortestElement
        + ", _lengthOfLongestElement=" + _lengthOfLongestElement + ", _isAscii=" + _isAscii
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(PropertiesConfiguration config, int totalDocs,
    ...
    if (partitionFunctionName != null || partitionFunctionExpr != null) {
      ...
      if (partitionFunctionExpr != null) {
        partitionFunction =
            PartitionFunctionExprCompiler.compilePartitionFunction(column, partitionFunctionExpr, numPartitions);
      } else {
        partitionFunction =
