...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary, boolean sorted,
  ...
  public String toString() {
    return "ColumnMetadataImpl{" + "_fieldSpec=" + _fieldSpec + ", _totalDocs=" + _totalDocs + ", _cardinality="
        + _cardinality + ", _hasDictionary=" + _hasDictionary + ", _sorted=" + _sorted + ", _minValue=" + _minValue
