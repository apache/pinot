...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private final int _transformFunctionProvenanceVersion;
  @Nullable
  private final String _transformFunctionFingerprint;
  @Nullable
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary,
      ...
      @Nullable String transformFunction, int transformFunctionProvenanceVersion,
      @Nullable String transformFunctionFingerprint, @Nullable String parentColumn, @Nullable List<String> sparseKeys,
    ...
    _transformFunctionProvenanceVersion = transformFunctionProvenanceVersion;
    _transformFunctionFingerprint = transformFunctionFingerprint;
  ...
  public int getTransformFunctionProvenanceVersion() {
    return _transformFunctionProvenanceVersion;
  }

  @Override
  public String getTransformFunctionFingerprint() {
    return _transformFunctionFingerprint;
  }
  ...
  public boolean equals(Object o) {
    ...
    return _totalDocs == that._totalDocs
        ...
        && _transformFunctionProvenanceVersion == that._transformFunctionProvenanceVersion
        ...
        && Objects.equals(_transformFunctionFingerprint, that._transformFunctionFingerprint)
  ...
  public int hashCode() {
    return Objects.hash(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding, _sorted, _nonNull,
        ...
        _partitions, _autoGenerated, _transformFunction, _transformFunctionProvenanceVersion,
        _transformFunctionFingerprint, _parentColumn, _sparseKeys, _compressionMetadata, _indexTypeSizes);
  }
  ...
  public String toString() {
    return "ColumnMetadataImpl{"
        ...
        + ", _transformFunction=" + _transformFunction
        + ", _transformFunctionProvenanceVersion=" + _transformFunctionProvenanceVersion
        + ", _transformFunctionFingerprint=" + _transformFunctionFingerprint
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(PropertiesConfiguration config, int totalDocs,
    ...
    Builder builder = new Builder()
        ...
        .setTransformFunction(extractTransformFunction(column, config))
        .setTransformFunctionProvenanceVersion(config.getInt(
            Column.getKeyFor(column, Column.TRANSFORM_FUNCTION_PROVENANCE_VERSION), UNAVAILABLE))
        .setTransformFunctionFingerprint(config.getString(
            Column.getKeyFor(column, Column.TRANSFORM_FUNCTION_FINGERPRINT), null))
        .setParentColumn(
  ...
  private static String extractTransformFunction(String column, PropertiesConfiguration config) {
    Object encodedProperty = config.getProperty(Column.getKeyFor(column, Column.TRANSFORM_FUNCTION_BASE64));
    if (encodedProperty != null) {
      try {
        byte[] bytes = Base64.getDecoder().decode(encodedProperty.toString());
        return new String(bytes, StandardCharsets.UTF_8);
      } catch (IllegalArgumentException e) {
        throw new IllegalStateException("Invalid Base64 transform function in metadata for column: " + column, e);
      }
    }
    // Use getProperty() rather than getString() so Commons Configuration does not interpolate `${...}`
    // (same reason min/max values are read with getProperty()). This fallback reads intermediate branch artifacts;
    // new writers use the Base64 key above so every Unicode expression is lossless.
    Object transformFunctionProperty = config.getProperty(Column.getKeyFor(column, Column.TRANSFORM_FUNCTION));
    String transformFunction = transformFunctionProperty != null ? transformFunctionProperty.toString() : null;
    return transformFunction != null
        ? CommonsConfigurationUtils.recoverSpecialCharacterInPropertyValue(transformFunction)
        : null;
  }
  ...
  public static class Builder {
    ...
    private int _transformFunctionProvenanceVersion = UNAVAILABLE;
    private String _transformFunctionFingerprint;
    ...
    public Builder setTransformFunctionProvenanceVersion(int transformFunctionProvenanceVersion) {
      _transformFunctionProvenanceVersion = transformFunctionProvenanceVersion;
      return this;
    }

    public Builder setTransformFunctionFingerprint(String transformFunctionFingerprint) {
      _transformFunctionFingerprint = transformFunctionFingerprint;
      return this;
    }
    ...
    public ColumnMetadataImpl build() {
      ...
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding,
          ...
          _bitsPerElement, _partitionFunction, _partitions, _autoGenerated, _transformFunction,
          _transformFunctionProvenanceVersion, _transformFunctionFingerprint, _parentColumn, _sparseKeys,
