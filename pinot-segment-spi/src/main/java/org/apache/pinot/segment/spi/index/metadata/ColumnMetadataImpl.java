...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private final long _uncompressedForwardIndexSizeBytes;
  private final String _compressionCodec;
  private final long _dictColumnRawIngestSizeBytes;
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary,
      ...
      @Nullable String parentColumn, long uncompressedForwardIndexSizeBytes, @Nullable String compressionCodec,
      long dictColumnRawIngestSizeBytes) {
    ...
    _uncompressedForwardIndexSizeBytes = uncompressedForwardIndexSizeBytes;
    _compressionCodec = compressionCodec;
    _dictColumnRawIngestSizeBytes = dictColumnRawIngestSizeBytes;
  }
  ...
  /// Returns {@code true} if this column is a materialized column produced from an OPEN_STRUCT parent column.
  public boolean isMaterializedChild() {
    return _parentColumn != null;
  }

  /// Returns the name of the parent OPEN_STRUCT column, or {@code null} if this is not a materialized column.
  @Nullable
  ...
  @Override
  public long getDictColumnRawIngestSizeBytes() {
    return _dictColumnRawIngestSizeBytes;
  }
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(PropertiesConfiguration config, int totalDocs,
    ...
    Builder builder = new Builder()
        ...
        .setMaxRowLengthInBytes(
            config.getInt(Column.getKeyFor(column, Column.MAX_ROW_LENGTH_IN_BYTES), UNAVAILABLE))
    ...
    builder.setUncompressedForwardIndexSizeBytes(
        config.getLong(Column.getKeyFor(column, Column.FORWARD_INDEX_UNCOMPRESSED_SIZE), UNAVAILABLE));
    builder.setCompressionCodec(
        config.getString(Column.getKeyFor(column, Column.FORWARD_INDEX_COMPRESSION_CODEC), null));
    builder.setDictColumnRawIngestSizeBytes(
        config.getLong(Column.getKeyFor(column, Column.DICT_COLUMN_RAW_INGEST_SIZE), UNAVAILABLE));
  ...
  public static class Builder {
    ...
    private long _uncompressedForwardIndexSizeBytes = UNAVAILABLE;
    private String _compressionCodec;
    private long _dictColumnRawIngestSizeBytes = UNAVAILABLE;
    ...
    public Builder setUncompressedForwardIndexSizeBytes(long uncompressedForwardIndexSizeBytes) {
      _uncompressedForwardIndexSizeBytes = uncompressedForwardIndexSizeBytes;
      return this;
    }

    public Builder setCompressionCodec(@Nullable String compressionCodec) {
      _compressionCodec = compressionCodec;
      return this;
    }

    public Builder setDictColumnRawIngestSizeBytes(long dictColumnRawIngestSizeBytes) {
      _dictColumnRawIngestSizeBytes = dictColumnRawIngestSizeBytes;
      return this;
    }
    ...
    public ColumnMetadataImpl build() {
      ...
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding,
          ...
          _isAscii, _totalNumberOfEntries, _maxNumberOfMultiValues, _maxRowLengthInBytes, _bitsPerElement,
          _partitionFunction, _partitions, _autoGenerated, _parentColumn, _uncompressedForwardIndexSizeBytes,
          _compressionCodec, _dictColumnRawIngestSizeBytes);
    }
  }
}
