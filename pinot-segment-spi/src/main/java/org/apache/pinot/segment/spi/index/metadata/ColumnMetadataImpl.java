...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean sorted,
      ...
      IndexCreationContext.ForwardIndexEncoding forwardIndexEncoding, int columnMaxLength, int bitsPerElement,
      int maxNumberOfMultiValues, int totalNumberOfEntries,
  ...
  public boolean equals(Object o) {
    ...
    return _totalDocs == that._totalDocs && _cardinality == that._cardinality && _sorted == that._sorted
        && _hasDictionary == that._hasDictionary && _forwardIndexEncoding == that._forwardIndexEncoding
        && _columnMaxLength == that._columnMaxLength
  ...
  public int hashCode() {
    return Objects.hash(_fieldSpec, _totalDocs, _cardinality, _sorted, _minValue, _maxValue, _hasDictionary,
        _forwardIndexEncoding, _columnMaxLength, _bitsPerElement, _maxNumberOfMultiValues, _totalNumberOfEntries,
  ...
  public String toString() {
    return "ColumnMetadataImpl{" + "_fieldSpec=" + _fieldSpec + ", _totalDocs=" + _totalDocs + ", _cardinality="
        ...
        + ", _hasDictionary=" + _hasDictionary + ", _forwardIndexEncoding=" + _forwardIndexEncoding
        + ", _columnMaxLength=" + _columnMaxLength + ", _bitsPerElement=" + _bitsPerElement
        + ", _maxNumberOfMultiValues=" + _maxNumberOfMultiValues + ", _totalNumberOfEntries="
  ...
  public static class Builder {
    ...
    private LongArrayList _indexSizeList = new LongArrayList(2);
    ...
    public void setIndexSizeMap(Map<IndexType<?, ?, ?>, Long> indexSizeMap) {
      throw new UnsupportedOperationException("Use setIndexSizeList()");
    }

    public void setIndexSizeList(LongArrayList indexSizeList) {
      _indexSizeList = indexSizeList;
    }
    ...
    public ColumnMetadataImpl build() {
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _sorted, _minValue, _maxValue,
          _minMaxValueInvalid, _hasDictionary, _forwardIndexEncoding, _columnMaxLength, _bitsPerElement,
          _maxNumberOfMultiValues, _totalNumberOfEntries, _partitionFunction, _partitions, _indexSizeList,
          _autoGenerated);
    }
