...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    if (minString != null || maxString != null) {
      builder.setColumnMinMaxValues(builder, storedType, column, minString, maxString);
    }
  ...
  public static class Builder {
    ...
    private void setColumnMinMaxValues(Builder builder, DataType storedType, String column,
        String minString, String maxString) {
      if (minString != null) {
