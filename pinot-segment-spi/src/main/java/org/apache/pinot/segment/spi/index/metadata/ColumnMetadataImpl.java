...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private final List<Object> _childColumns;
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean sorted,
      ...
      Map<IndexType<?, ?, ?>, Long> indexSizeMap, boolean autoGenerated, @Nullable List<Object> childColumns) {
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    Builder builder = new Builder().setTotalDocs(config.getInt(Column.getKeyFor(column, Column.TOTAL_DOCS)))
        ...
        .setChildColumns(config.getList(Column.getKeyFor(column, Column.CHILDCOLUMNS_PROPS_KEY_PREFIX)));
  ...
  public static class Builder {
    ...
    private List<Object> _childColumns;

    public Builder setChildColumns(List<Object> childColumns) {
      _childColumns = childColumns;
      return this;
    }
    ...
    public ColumnMetadataImpl build() {
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _sorted, _minValue, _maxValue,
          ...
          _totalNumberOfEntries, _partitionFunction, _partitions, _indexSizeMap, _autoGenerated, _childColumns);
    }
