...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  /// Boolean marker written by an earlier revision of this change. That revision stored the compat
  /// expression in [Column.TRANSFORM_FUNCTION] and set [Column.TRANSFORM_FUNCTION_BACKFILLED] to
  /// `"true"`. Readers keep accepting that shape so a mixed-version reload cannot lose the expression.
  private static final String LEGACY_TRANSFORM_FUNCTION_BACKFILL_MARKER = "true";
  ...
  @Nullable
  private final String _transformFunctionBackfilled;
  @Nullable
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary,
      ...
      @Nullable String transformFunction, @Nullable String transformFunctionBackfilled, @Nullable String parentColumn,
      @Nullable List<String> sparseKeys, @Nullable CompressionMetadata compressionMetadata) {
    ...
    _transformFunctionBackfilled = transformFunctionBackfilled;
  ...
  public String getTransformFunctionBackfilled() {
    return _transformFunctionBackfilled;
  }
  ...
  public boolean equals(Object o) {
    ...
    return _totalDocs == that._totalDocs
        ...
        && Objects.equals(_transformFunctionBackfilled, that._transformFunctionBackfilled)
  ...
  public int hashCode() {
    return Objects.hash(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding, _sorted, _nonNull,
        ...
        _partitions, _autoGenerated, _transformFunction, _transformFunctionBackfilled, _parentColumn, _sparseKeys,
  ...
  public String toString() {
    return "ColumnMetadataImpl{"
        ...
        + ", _transformFunctionBackfilled=" + _transformFunctionBackfilled
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(PropertiesConfiguration config, int totalDocs,
    ...
    Builder builder = new Builder()
        ...
        .setTransformFunctionBackfilled(extractTransformFunctionBackfilled(column, config))
  ...
  private static String extractTransformFunction(String column, PropertiesConfiguration config) {
    if (isLegacyBooleanBackfillMarker(column, config)) {
      return null;
    }
    return extractEscapedString(config, Column.getKeyFor(column, Column.TRANSFORM_FUNCTION));
  }

  @Nullable
  private static String extractTransformFunctionBackfilled(String column, PropertiesConfiguration config) {
    if (isLegacyBooleanBackfillMarker(column, config)) {
      return extractEscapedString(config, Column.getKeyFor(column, Column.TRANSFORM_FUNCTION));
    }
    return extractEscapedString(config, Column.getKeyFor(column, Column.TRANSFORM_FUNCTION_BACKFILLED));
  }

  private static boolean isLegacyBooleanBackfillMarker(String column, PropertiesConfiguration config) {
    String rawBackfilled = config.getString(Column.getKeyFor(column, Column.TRANSFORM_FUNCTION_BACKFILLED), null);
    if (rawBackfilled == null || !LEGACY_TRANSFORM_FUNCTION_BACKFILL_MARKER.equalsIgnoreCase(rawBackfilled)) {
      return false;
    }
  ...
  public static class Builder {
    ...
    @Nullable
    private String _transformFunctionBackfilled;
    ...
    public Builder setTransformFunction(@Nullable String transformFunction) {
      _transformFunction = transformFunction;
      return this;
    }

    public Builder setTransformFunctionBackfilled(@Nullable String transformFunctionBackfilled) {
      _transformFunctionBackfilled = transformFunctionBackfilled;
      return this;
    }
    ...
    public ColumnMetadataImpl build() {
      ...
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding,
          ...
          _transformFunctionBackfilled, _parentColumn, _sparseKeys,
