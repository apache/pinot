...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private ColumnMetadataImpl(FieldSpec fieldSpec, int totalDocs, int cardinality, boolean hasDictionary,
      @Nullable EncodingType forwardIndexEncoding, boolean sorted, @Nullable Comparable minValue,
      ...
      @Nullable String parentColumn, @Nullable CompressionMetadata compressionMetadata) {
  ...
  public int hashCode() {
    return Objects.hash(_fieldSpec, _totalDocs, _cardinality, _hasDictionary, _forwardIndexEncoding, _sorted,
        ...
        _partitions, _autoGenerated, _parentColumn, _compressionMetadata, _indexTypeSizeList);
  }
