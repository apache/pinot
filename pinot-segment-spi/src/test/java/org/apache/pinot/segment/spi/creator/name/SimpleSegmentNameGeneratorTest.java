...
public class SimpleSegmentNameGeneratorTest {
  ...
  public void testWithoutSegmentNamePostfix() {
    ...
    assertEquals(segmentNameGenerator.generateSegmentName(INVALID_SEQUENCE_ID, MIN_TIME_VALUE, MAX_TIME_VALUE), "testTable_1234_5678");
    assertEquals(segmentNameGenerator.generateSegmentName(VALID_SEQUENCE_ID, null, null), "testTable_0");
    assertEquals(segmentNameGenerator.generateSegmentName(VALID_SEQUENCE_ID, MIN_TIME_VALUE, MAX_TIME_VALUE), "testTable_1234_5678_0");
  }
  ...
  public void testWithSegmentNamePostfix() {
    ...
    assertEquals(segmentNameGenerator.toString(), "SimpleSegmentNameGenerator: tableName=testTable, segmentNamePostfix=postfix");
