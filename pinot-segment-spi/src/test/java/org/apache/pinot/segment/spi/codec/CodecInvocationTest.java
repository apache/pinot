...
/// Tests for [CodecInvocation] construction invariants.
public class CodecInvocationTest {
  ...
  @Test
  public void testRejectsInvalidNames() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new CodecInvocation("ŽSTD", List.of()));
    assertThrows(IllegalArgumentException.class,
        () -> new CodecInvocation("A".repeat(CodecSpecParser.MAX_IDENTIFIER_LENGTH + 1), List.of()));
  }
  ...
  public void testRejectsInvalidArguments() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new CodecInvocation("ZSTD", List.of("०")));
    assertThrows(IllegalArgumentException.class,
        () -> new CodecInvocation("ZSTD", List.of("1".repeat(CodecSpecParser.MAX_ARG_LENGTH + 1))));
    assertThrows(IllegalArgumentException.class,
        () -> new CodecInvocation("ZSTD", Collections.nCopies(
            CodecSpecParser.MAX_ARGS_PER_STAGE + 1, "1")));
  }
}
