...
-->
# Pinot Spark 4 Connector Example: Reading from Pinot via Proxy with Auth Token

This example demonstrates how to use the Pinot Spark 4 Connector to read data from a Pinot cluster via a proxy with authentication token support.

## Prerequisites

- Apache Spark 4.x installed and `spark-shell` available in your PATH.
