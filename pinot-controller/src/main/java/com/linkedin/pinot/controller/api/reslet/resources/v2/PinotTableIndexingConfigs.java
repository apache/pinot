...
public class PinotTableIndexingConfigs extends ServerResource {
  ...
  public Representation put(Representation entity) {
    ...
    try {
      ...
      config =
          AbstractTableConfig.loadIndexingConfig(new ObjectMapper().readTree(o.getJSONObject("tableIndexConfig")
              .toString()));
