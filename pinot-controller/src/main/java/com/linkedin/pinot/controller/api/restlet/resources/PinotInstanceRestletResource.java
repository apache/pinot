...
public class PinotInstanceRestletResource extends PinotRestletResourceBase {
  ...
  public Representation post(Representation entity) {
    ...
    try {
      ...
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_INTERNAL_ERROR, 1L);
  ...
  public Representation get() {
    ...
    try {
      ...
      presentation = new StringRepresentation(e.getMessage() + "\n" + ExceptionUtils.getStackTrace(e));
      LOGGER.error("Caught exception while processing post request", e);
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_INSTANCE_GET_ERROR, 1L);
      setStatus(Status.SERVER_ERROR_INTERNAL);
    }
    return presentation;
  }
