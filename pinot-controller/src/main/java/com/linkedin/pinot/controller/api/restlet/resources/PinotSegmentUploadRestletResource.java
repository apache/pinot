...
public class PinotSegmentUploadRestletResource extends PinotRestletResourceBase {
  ...
  public Representation get() {
    ...
    try {
      ...
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SEGMENT_GET_ERROR, 1L);
  ...
  public Representation post(Representation entity) {
    ...
    try {
      ...
      if (found) {
        ...
        ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SEGMENT_UPLOAD_ERROR, 1L);
        setStatus(Status.SERVER_ERROR_INTERNAL);
      }
    } catch (final Exception e) {
  ...
  public Representation delete() {
    ...
    try {
      ...
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SEGMENT_DELETE_ERROR, 1L);
      setStatus(Status.SERVER_ERROR_INTERNAL);
    }
    return rep;
  }
