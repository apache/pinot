...
public class BalanceLatencySegmentAssignmentStrategy implements SegmentAssignmentStrategy {
    ...
    public List<String> getAssignedInstances(PinotHelixResourceManager helixResourceManager, HelixAdmin helixAdmin,
        ...
        //We create a SegmentSizeMetric and pass it to BalanceLoadSegmentAssignmentStrategy
        //This means BalanceSizeSegmentAssignmentStrategy
