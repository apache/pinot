...
public class PinotSchemaRestletResource extends PinotRestletResourceBase {
  ...
  public Representation get() {
    try {
      ...
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SCHEMA_GET_ERROR, 1L);
  ...
  private Representation uploadNewSchema()
    ...
    if (dataFile != null) {
      ...
      try {
        ...
        LOGGER.error("Caught exception in file upload", e);
        setStatus(Status.SERVER_ERROR_INTERNAL);
        ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SCHEMA_UPLOAD_ERROR, 1L);
        return PinotSegmentUploadRestletResource.exceptionToStringRepresentation(e);
      }
    } else {
  ...
  public Representation delete() {
    ...
    try {
      ...
      ControllerRestApplication.getControllerMetrics().addMeteredValue(null, ControllerMeter.CONTROLLER_SCHEMA_DELETE_ERROR, 1L);
      setStatus(Status.SERVER_ERROR_INTERNAL);
