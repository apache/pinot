...
public class AutoAddInvertedIndex {
  ...
  public AutoAddInvertedIndex(String zkAddress, String clusterName, String controllerAddress, String brokerAddress,
  ...
  public void overrideDefaultSettings(String tableNamePattern, long tableSizeThreshold, long cardinalityThreshold,
      int maxNumInvertedIndex) {
