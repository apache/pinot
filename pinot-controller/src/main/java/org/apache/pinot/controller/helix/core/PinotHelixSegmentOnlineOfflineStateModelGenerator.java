...
public class PinotHelixSegmentOnlineOfflineStateModelGenerator {
  ...
  public static StateModelDefinition generatePinotStateModelDefinition() {
    ...
    builder.addTransition(CONSUMING_STATE, ONLINE_STATE, DEFAULT_TRANSITION_PRIORITY);
    builder.addTransition(OFFLINE_STATE, ONLINE_STATE, DEFAULT_TRANSITION_PRIORITY);
    builder.addTransition(OFFLINE_STATE, CONSUMING_STATE, OFFLINE_TO_CONSUMING_TRANSITION_PRIORITY);
    builder.addTransition(CONSUMING_STATE, OFFLINE_STATE, DEFAULT_TRANSITION_PRIORITY);
    builder.addTransition(ONLINE_STATE, OFFLINE_STATE, DEFAULT_TRANSITION_PRIORITY);
    builder.addTransition(OFFLINE_STATE, DROPPED_STATE, DEFAULT_TRANSITION_PRIORITY);
