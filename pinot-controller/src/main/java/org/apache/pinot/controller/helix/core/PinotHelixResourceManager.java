...
import org.apache.pinot.common.dataset.DatasetMetadataUtil;
...
public class PinotHelixResourceManager {
  ...
  private void updateDatasetMetadataAndBootstrapDataForOfflineTable(TableConfig tableConfig) {
    ...
    datasetMetadata.addDatasetToTableMapping(tableNameWithType);
    ...
    LOGGER.warn("segment metadata : {}", segmentZKMetadataList);
  ...
  private void removeDatasetTableMapping(TableConfig tableConfig) {
    ...
    String tableNameWithType = tableConfig.getTableName();
    DatasetMetadata datasetMetadata = DatasetMetadataUtil.fetchDatasetMetadata(_propertyStore, datasetNameWithType);
    datasetMetadata.removeDatasetToTableMapping(tableNameWithType);
  ...
  public void addNewSegment(@Nonnull SegmentMetadata segmentMetadata, @Nonnull String downloadUrl) {
    Map<String, List<String>> assignedInstancesMapping = getAssignedInstancesMappingForSegment(segmentMetadata);
    addNewSegment(segmentMetadata, downloadUrl, null, assignedInstancesMapping);
  }

  public void addNewSegment(@Nonnull SegmentMetadata segmentMetadata, @Nonnull String downloadUrl, String crypter,
      @Nonnull Map<String, List<String>> assignedInstancesMapping) {
    Preconditions.checkNotNull(assignedInstancesMapping, "Assigned Instances should not be null!");
    ...
    addNewOfflineSegment(segmentMetadata, assignedInstancesMapping);
   ...
   */
  public Map<String, List<String>> getAssignedInstancesMappingForSegment(SegmentMetadata segmentMetadata) {
   ...
   */
  // NOTE: method should be thread-safe
  private void addNewOfflineSegment(SegmentMetadata segmentMetadata, Map<String, List<String>> assignedInstancesMapping) {
//    String offlineTableName = TableNameBuilder.OFFLINE.tableNameWithType(segmentMetadata.getTableName());
    String segmentName = segmentMetadata.getName();
//    String datasetName = DatasetMetadataUtil.getDatasetNameFromSegmentMetadata(segmentMetadata);
//    String datasetNameWithType =
...
//  private void addNewOfflineSegmentForDatasetSharedTable(String segmentName, List<String> assignedInstances) {
//    HelixHelper.addSegmentToIdealState(_helixZkManager, );
//  }
