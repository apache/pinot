  ...
  private String validateConfig(TableConfigs tableConfigs, @Nullable String typesToSkip) {
    ...
    try {
      ...
      if (offlineTableConfig != null) {
        ...
        TableConfigUtils.validate(offlineTableConfig, schema, typesToSkip, _controllerConf.getDisableGroovy());
      }
      if (realtimeTableConfig != null) {
        ...
        TableConfigUtils.validate(realtimeTableConfig, schema, typesToSkip, _controllerConf.getDisableGroovy());
      }
