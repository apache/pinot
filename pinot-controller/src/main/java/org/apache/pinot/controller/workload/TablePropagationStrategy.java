...
/**
 * Propagation strategy for table based workload propagation.
 * This strategy propagates the workload refresh message to the instances that serve the given tables.
 * For non-leaf nodes, the message is propagated to the broker instances that serve the given tables.
 * For leaf nodes, the message is propagated to the server instances that serve the given tables.
 */
public class TablePropagationStrategy implements PropagationStrategy {
  private final PinotHelixResourceManager _pinotHelixResourceManager;

  public TablePropagationStrategy(PinotHelixResourceManager pinotHelixResourceManager) {
