...
export const rebalanceServerOptions: RebalanceServerOption[] = [
    ...
    },
    {
        ...
        "description": "Batch size of segments to add per server in each rebalance step. For non-strict replica group this serves as the maximum per server, for strict replica group since a partition is moved as a whole, this serves as best efforts. Defaults to -1 to disable batching. Recommendation: Run Dry Run and check how many segments are to be moved, if this number is > 1000, enable batching by setting this to about 100 - 200, otherwise leave it at the default",
        "isAdvancedConfig": false,
        "isStatsGatheringConfig": false,
        "markWithWarningIcon": false
    },
