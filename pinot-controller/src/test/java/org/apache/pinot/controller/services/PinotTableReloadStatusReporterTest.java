...
public class PinotTableReloadStatusReporterTest {
  ...
  public void testGetServerToSegments() {
    ...
    Map<String, List<String>> serverToSegmentsMap = _instance.getServerToSegments(tableName, null, null);
    assertEquals(serverToSegmentsMap, fullServerToSegmentsMap);

    // Get all segments on svr02.
    serverToSegmentsMap = _instance.getServerToSegments(tableName, null, "svr02");
    assertEquals(serverToSegmentsMap, Map.of("svr02", List.of("seg02", "seg03")));

    // Get all servers with seg01.
    serverToSegmentsMap = _instance.getServerToSegments(tableName, "seg01", null);
    ...
    serverToSegmentsMap = _instance.getServerToSegments(tableName, "seg01", "svr01");
    assertEquals(serverToSegmentsMap, Map.of("svr01", List.of("seg01")));
    serverToSegmentsMap = _instance.getServerToSegments(tableName, "anySegment", "anyServer");
