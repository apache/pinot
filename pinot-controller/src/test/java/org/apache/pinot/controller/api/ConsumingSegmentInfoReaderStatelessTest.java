...
public class ConsumingSegmentInfoReaderStatelessTest {
  ...
  public void setUp()
    ...
    FakeConsumingInfoServer s0 = new FakeConsumingInfoServer(Lists
        .newArrayList(new SegmentConsumerInfo(SEGMENT_NAME_PARTITION_0, "CONSUMING", 0, partitionToOffset0, Collections.emptyMap()),
            new SegmentConsumerInfo(SEGMENT_NAME_PARTITION_1, "CONSUMING", 0, partitionToOffset1, Collections.emptyMap())));
    ...
    FakeConsumingInfoServer s2 = new FakeConsumingInfoServer(Lists
        .newArrayList(new SegmentConsumerInfo(SEGMENT_NAME_PARTITION_0, "NOT_CONSUMING", 0, partitionToOffset0, Collections.emptyMap()),
            new SegmentConsumerInfo(SEGMENT_NAME_PARTITION_1, "CONSUMING", 0, partitionToOffset1, Collections.emptyMap())));
    ...
    FakeConsumingInfoServer s3 = new FakeConsumingInfoServer(
        Lists.newArrayList(new SegmentConsumerInfo(SEGMENT_NAME_PARTITION_1, "CONSUMING", 0, partitionToOffset1, Collections.emptyMap())));
