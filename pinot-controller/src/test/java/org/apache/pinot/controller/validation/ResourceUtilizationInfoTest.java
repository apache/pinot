...
public class ResourceUtilizationInfoTest {
  ...
  public void setUp() {
    ...
    // Clear existing data before each test (ensuring test isolation)
    ResourceUtilizationInfo.setDiskUsageInfo(INSTANCE_ID_1, null);
    ResourceUtilizationInfo.setDiskUsageInfo(INSTANCE_ID_2, null);
  }

  @Test
  public void testDiskUsageInfo() {
    // Set disk usage info for multiple instances
    ResourceUtilizationInfo.setDiskUsageInfo(INSTANCE_ID_1, _diskUsageInfo1);
    ResourceUtilizationInfo.setDiskUsageInfo(INSTANCE_ID_2, _diskUsageInfo2);
