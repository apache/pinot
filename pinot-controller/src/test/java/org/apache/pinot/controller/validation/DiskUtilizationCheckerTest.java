...
public class DiskUtilizationCheckerTest {
  ...
  public void testIsDiskUtilizationWithinLimitsValidOfflineTable() {
    ...
    ResourceUtilizationInfo.setDiskUsageInfo("server1", diskUsageInfo1);

    DiskUsageInfo diskUsageInfo2 =
        new DiskUsageInfo("server2", DISK_UTILIZATION_PATH, 2000L, 1000L, System.currentTimeMillis());
    ResourceUtilizationInfo.setDiskUsageInfo("server2", diskUsageInfo2);
  ...
  public void testComputeDiskUtilizationValidInstances()
    ...
    responseMap.put("http://server1" + DiskUtilizationChecker.getDiskUtilizationApiPath(),
        "{ \"totalSpaceBytes\": 1000, \"usedSpaceBytes\": 500 }");
    responseMap.put("http://server2" + DiskUtilizationChecker.getDiskUtilizationApiPath(),
        "{ \"totalSpaceBytes\": 2000, \"usedSpaceBytes\": 1500 }");
