...
public class RealtimeReplicaGroupSegmentAssignmentTest {
  ...
  public void testAssignSegmentForUploadedSegments() {
    ...
    //   0_2=[instance_8, instance_9, instance_10, instance_11]
    // }
    Map<String, List<String>> expectedUploadedSegmentToInstances = Map.of(
        "uploadedSegment_0", List.of("completedInstance_0", "completedInstance_4", "completedInstance_8"),
        "uploadedSegment_1", List.of("completedInstance_1", "completedInstance_5", "completedInstance_9"),
        "uploadedSegment_2", List.of("completedInstance_2", "completedInstance_6", "completedInstance_10"),
        "uploadedSegment_3", List.of("completedInstance_3", "completedInstance_7", "completedInstance_11"),
        "uploadedSegment_4", List.of("completedInstance_0", "completedInstance_4", "completedInstance_8")
    );
  ...
  public void testExplicitPartition() {
    ...
    Map<InstancePartitionsType, InstancePartitions> onlyCompletedInstancePartitionMap =
        Map.of(InstancePartitionsType.COMPLETED, completedInstancePartitions);
    ...
    Map<InstancePartitionsType, InstancePartitions> instancePartitionsMap =
        Map.of(InstancePartitionsType.CONSUMING, consumingInstancePartitions, InstancePartitionsType.COMPLETED,
