...
public class SegmentAssignmentUtilsTest {
  ...
  public void testGetRealtimeConsumingSegmentPartitionId() {
    ...
    try (MockedStatic<ZKMetadataProvider> zkMetadataProviderMockedStatic = Mockito.mockStatic(
      ...
      // Fetch partitionId from segment such that it is fetched from SegmentZkMetadata
      Integer partitionId =
          SegmentAssignmentUtils.getRealtimeSegmentPartitionId(SEGMENT_LLC_NAME, REALTIME_TABLE_NAME_WITH_TYPE,
  ...
  public void testGetRealtimeCompletedInstancePartitionsSegmentPartitionId() {
    ...
    try (MockedStatic<ZKMetadataProvider> zkMetadataProviderMockedStatic = Mockito.mockStatic(
      ...
      Integer partitionId =
          SegmentAssignmentUtils.getOfflineOrCompletedPartitionId(SEGMENT, REALTIME_TABLE_NAME_WITH_TYPE,
              TableType.REALTIME, helixManager, 1, PARTITION_COLUMN);
    ...
    try (MockedStatic<ZKMetadataProvider> zkMetadataProviderMockedStatic = Mockito.mockStatic(
      ...
      // Fetch partitionId from segment such that it is fetched from SegmentZkMetadata
      Integer partitionId =
          SegmentAssignmentUtils.getOfflineOrCompletedPartitionId(SEGMENT_LLC_NAME, REALTIME_TABLE_NAME_WITH_TYPE,
              TableType.REALTIME, helixManager, 2, PARTITION_COLUMN);
  ...
  public void testGetOfflineSegmentPartitionId() {
    ...
    try (MockedStatic<ZKMetadataProvider> zkMetadataProviderMockedStatic = Mockito.mockStatic(
      ...
      Integer partitionId =
          SegmentAssignmentUtils.getOfflineOrCompletedPartitionId(SEGMENT, OFFLINE_TABLE_NAME_WITH_TYPE,
              TableType.OFFLINE, helixManager, 1, PARTITION_COLUMN);
    ...
    try (MockedStatic<ZKMetadataProvider> zkMetadataProviderMockedStatic = Mockito.mockStatic(
      ...
      // Fetch partitionId from segment such that it is fetched from SegmentZkMetadata
      Integer partitionId =
          SegmentAssignmentUtils.getOfflineOrCompletedPartitionId(SEGMENT_LLC_NAME, OFFLINE_TABLE_NAME_WITH_TYPE,
              TableType.OFFLINE, helixManager, 2, PARTITION_COLUMN);
