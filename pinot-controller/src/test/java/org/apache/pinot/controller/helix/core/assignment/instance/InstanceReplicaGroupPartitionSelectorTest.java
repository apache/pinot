...
public class InstanceReplicaGroupPartitionSelectorTest {
    ...
    public void testSelectInstances() throws JsonProcessingException {
        ...
        InstanceReplicaGroupPartitionConfig config = new InstanceReplicaGroupPartitionConfig(
            true, 0, 2, 2, 1, 2, true, null
        );

        InstanceReplicaGroupPartitionSelector selector = new InstanceReplicaGroupPartitionSelector(
            config,
            "tableNameBlah",
            existing
        );
        ...
        String[] poolNames = {"FirstHalfReplicationGroups", "FirstHalfReplicationGroups", "SecondHalfReplicationGroups", "SecondHalfReplicationGroups"};
