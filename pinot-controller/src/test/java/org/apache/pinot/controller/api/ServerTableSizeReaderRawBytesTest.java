...
public class ServerTableSizeReaderRawBytesTest {
  ...
  public void testDeserializesNewFields() {
    ...
    assertEquals(colStats.get("col_a").getRawForwardIndexSizeBytes(), 10000);
    assertEquals(colStats.get("col_a").getCompressedForwardIndexSizeBytes(), 2000);
    assertEquals(colStats.get("col_a").getCompressionCodec(), "LZ4");
