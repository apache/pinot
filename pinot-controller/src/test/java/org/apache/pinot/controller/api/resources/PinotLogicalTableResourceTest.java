...
public class PinotLogicalTableResourceTest extends ControllerTest {
  ...
  public void setUpClass()
    ...
    _addLogicalTableUrl = getAdminUrlBuilder().forLogicalTableCreate();
  ...
  public void testCreateUpdateDeleteLogicalTables(String logicalTableName, List<String> physicalTableNames,
    ...
    String updateLogicalTableUrl =
        getAdminUrlBuilder().forLogicalTableUpdate(logicalTableName);
    String deleteLogicalTableUrl =
        getAdminUrlBuilder().forLogicalTableDelete(logicalTableName);
  ...
  public void testCreateLogicalTable(TableType tableType)
    ...
    String getLogicalTableUrl =
        getAdminUrlBuilder().forLogicalTableGet(LOGICAL_TABLE_NAME);
    LogicalTableConfig logicalTableConfig =
  ...
  public void testGetLogicalTableNames()
    ...
    String getLogicalTableNamesUrl =
        getAdminUrlBuilder().forLogicalTableNamesGet();
