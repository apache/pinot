...
public class PinotTableRestletResourceTest {
  ...
  public void testCreateTable()
    ...
    try {
      TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineTableConfigJson.toString());
    ...
    TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineTableConfigString);
    ...
    try {
      TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineTableConfig.toJsonString());
    ...
    try {
      TEST_INSTANCE.sendPostRequest(_createTableUrl, realtimeTableConfigJson.toString());
    ...
    try {
      TEST_INSTANCE.sendPostRequest(_createTableUrl, realtimeTableConfig.toJsonString());
    ...
    TEST_INSTANCE.sendPostRequest(_createTableUrl, realtimeTableConfigString);
  }
  ...
  public void testTableCronSchedule() {
    ...
    try {
      TEST_INSTANCE.sendPostRequest(_createTableUrl, tableConfig.toJsonString());
    ...
    try {
      String response = TEST_INSTANCE.sendPostRequest(_createTableUrl, tableConfig.toJsonString());
  ...
  private void testTableMinReplicationInternal(String tableName, int tableReplication)
    ...
    TEST_INSTANCE.sendPostRequest(_createTableUrl, tableJSONConfigString);
...
//    Assert.assertEquals(replicasPerPartition, Math.max(tableReplication, TABLE_MIN_REPLICATION));
  ...
  private TableConfig getTableConfig(String tableName, String tableType)
    ...
    String tableConfigString =
        TEST_INSTANCE.sendGetRequest(TEST_INSTANCE.getControllerRequestURLBuilder().forTableGet(tableName));
  ...
  public void testUpdateTableConfig()
    ...
    TEST_INSTANCE.sendPostRequest(_createTableUrl, tableConfigString);
    // table creation should succeed
    TableConfig tableConfig = getTableConfig(tableName, "OFFLINE");
    ...
    JsonNode jsonResponse = JsonUtils.stringToJsonNode(TEST_INSTANCE.sendPutRequest(
  ...
  public void rebalanceTableWithoutSegments()
      throws Exception {
    // Create the table
    TEST_INSTANCE.sendPostRequest(_createTableUrl, _offlineBuilder.build().toJsonString());

    // Rebalance should return status NO_OP
    RebalanceResult rebalanceResult = JsonUtils.stringToObject(TEST_INSTANCE.sendPostRequest(
  ...
  public void testDeleteTable()
    ...
    String creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, realtimeTableConfig.toJsonString());
    ...
    String deleteResponse = TEST_INSTANCE.sendDeleteRequest(
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineTableConfig.toJsonString());
    Assert.assertEquals(creationResponse,
        "{\"unrecognizedProperties\":{},\"status\":\"Table table0_OFFLINE succesfully added\"}");

    // Delete offline table using OFFLINE suffix.
    deleteResponse = TEST_INSTANCE.sendDeleteRequest(
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, rtConfig1.toJsonString());
    Assert.assertEquals(creationResponse,
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineConfig1.toJsonString());
    Assert.assertEquals(creationResponse,
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, rtConfig2.toJsonString());
    Assert.assertEquals(creationResponse,
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineConfig2.toJsonString());
    Assert.assertEquals(creationResponse,
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, rtConfig3.toJsonString());
    Assert.assertEquals(creationResponse,
    ...
    creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, offlineConfig3.toJsonString());
    Assert.assertEquals(creationResponse,
  ...
  public void testCheckTableState()
    ...
    String realtimeStateResponse = TEST_INSTANCE.sendGetRequest(
    ...
    String offlineStateResponse = TEST_INSTANCE.sendGetRequest(
        StringUtil.join("/", TEST_INSTANCE.getControllerBaseApiUrl(), "tables", "testTable",
            "state?type=offline"));
  ...
  public void testUnrecognizedProperties()
    ...
    String creationResponse = TEST_INSTANCE.sendPostRequest(_createTableUrl, jsonNode.toString());
    Assert.assertEquals(creationResponse,
    ...
    String updationResponse = TEST_INSTANCE.sendPutRequest(
    ...
    String validationResponse = TEST_INSTANCE.sendPostRequest(
