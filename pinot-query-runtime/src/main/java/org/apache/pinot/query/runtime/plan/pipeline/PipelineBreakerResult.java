...
public class PipelineBreakerResult {
  ...
  private final StageStatsHolder _stageStatsHolder;

  public PipelineBreakerResult(Map<PlanNode, Integer> nodeIdMap, Map<Integer, List<TransferableBlock>> resultMap,
      @Nullable TransferableBlock errorBlock, @Nullable StageStatsHolder stageStatsHolder) {
    _nodeIdMap = nodeIdMap;
    _resultMap = resultMap;
    _errorBlock = errorBlock;
    _stageStatsHolder = stageStatsHolder;
  }
  ...
  @Nullable
  public StageStatsHolder getStageStatsHolder() {
    return _stageStatsHolder;
  }
}
