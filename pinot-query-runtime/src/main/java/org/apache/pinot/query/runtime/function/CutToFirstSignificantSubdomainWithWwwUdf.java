...
public class CutToFirstSignificantSubdomainWithWwwUdf extends Udf.FromAnnotatedMethod {

  public CutToFirstSignificantSubdomainWithWwwUdf() throws NoSuchMethodException {
    super(UrlFunctions.class.getMethod("cutToFirstSignificantSubdomainWithWWW", String.class));
  }

  @Override
  public String getDescription() {
    return "Extracts the first significant subdomain and the top-level domain from the URL, "
        + "preserving 'www.' if present ";
  }
  ...
  public Map<UdfSignature, Set<UdfExample>> getExamples() {
    return UdfExampleBuilder.forSignature(UdfSignature.of(
        ...
        .addExample("with www", "https://www.example.com", "www.example.com")
