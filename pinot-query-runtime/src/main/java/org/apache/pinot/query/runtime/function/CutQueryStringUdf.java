...
public class CutQueryStringUdf extends Udf.FromAnnotatedMethod {

  public CutQueryStringUdf() throws NoSuchMethodException {
    super(UrlFunctions.class.getMethod("cutQueryString", String.class));
  }

  @Override
  public String getDescription() {
    return "Removes the query string from the URL "
  ...
  public Map<UdfSignature, Set<UdfExample>> getExamples() {
    return UdfExampleBuilder.forSignature(UdfSignature.of(
            ...
            UdfParameter.result(FieldSpec.DataType.STRING)
                .withDescription("The URL without the query string.")
        ))
        .addExample("with query", "https://example.com/path?foo=bar", "https://example.com/path")
        .addExample("no query", "https://example.com/path", "https://example.com/path")
