...
public class ArrayIndexesOfStringUdf extends Udf.FromAnnotatedMethod {
  public ArrayIndexesOfStringUdf() throws NoSuchMethodException {
    super(ArrayFunctions.class.getMethod("arrayIndexesOfString", String[].class, String.class));
  }
