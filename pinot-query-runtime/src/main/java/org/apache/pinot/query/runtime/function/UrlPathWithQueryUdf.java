...
public class UrlPathWithQueryUdf extends Udf.FromAnnotatedMethod {

  public UrlPathWithQueryUdf() throws NoSuchMethodException {
    super(UrlFunctions.class.getMethod("urlPathWithQuery", String.class));
  }

  @Override
  public String getDescription() {
    return "Extracts the path from the URL with the query string "
  ...
  public Map<UdfSignature, Set<UdfExample>> getExamples() {
    return UdfExampleBuilder.forSignature(UdfSignature.of(
            ...
            UdfParameter.result(FieldSpec.DataType.STRING)
                .withDescription("The path with query string, or null if invalid.")
        ))
        .addExample("with path and query", "https://example.com/a/b?x=1", "/a/b")
