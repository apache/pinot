...
public class UrlDecodeFormComponentUdf extends Udf.FromAnnotatedMethod {

  public UrlDecodeFormComponentUdf() throws NoSuchMethodException {
    super(UrlFunctions.class.getMethod("urlDecodeFormComponent", String.class));
  }

  @Override
  public String getDescription() {
    return "Decodes a URL-encoded form component string.";
  }
  ...
  public Map<UdfSignature, Set<UdfExample>> getExamples() {
    return UdfExampleBuilder.forSignature(UdfSignature.of(
            UdfParameter.of("url", FieldSpec.DataType.STRING)
                .withDescription("The URL-encoded form component string."),
        ...
        .addExample("percent encoding", "hello%20world", "hello world")
