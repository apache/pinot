...
public class QueryTestSet {
  ...
  public Object[][] provideTestSql() {
    return new Object[][]{
//        new Object[]{"SELECT * FROM b ORDER BY col1"},
//        // Order BY LIMIT
...
//        // Sub-query with IN clause to SEMI JOIN.
        new Object[]{"SELECT * FROM b WHERE b.col1 IN (SELECT a.col1 FROM a)"},
//        new Object[]{"SELECT b.col1, b.col2, SUM(b.col3) * 100 / COUNT(b.col3) FROM b WHERE EXISTS(SELECT 1 FROM a WHERE b.col1 = a.col1) GROUP BY b.col1, b.col2"}
