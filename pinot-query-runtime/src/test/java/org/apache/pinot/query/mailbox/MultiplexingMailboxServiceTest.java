...
public class MultiplexingMailboxServiceTest {
  private static final StringMailboxIdentifier LOCAL_MAILBOX_ID =
      new StringMailboxIdentifier("localJobId", "localhost", 0, "localhost", 0);
  private static final StringMailboxIdentifier NON_LOCAL_MAILBOX_ID =
      new StringMailboxIdentifier("localJobId", "localhost", 0, "localhost", 1);
  ...
  public void testHappyPath() {
    ...
    Mockito.doReturn(Mockito.mock(InMemorySendingMailbox.class)).when(inMemoryMailboxService)
        .createSendingMailbox(Mockito.any());
