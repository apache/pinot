...
public class IngestionConfigUtilsTest {
  ...
  public void testGetStreamConfigMap() {
    ...
    tableConfig.setIngestionConfig(
        new IngestionConfig(null, new StreamIngestionConfig(Lists.newArrayList(streamConfigMap)), null, null, null, null));
    ...
    tableConfig.setIngestionConfig(new IngestionConfig(null,
        new StreamIngestionConfig(Lists.newArrayList(streamConfigMap, deprecatedStreamConfigMap)), null, null, null, null));
    try {
      IngestionConfigUtils.getStreamConfigMap(tableConfig);
