...
public class PinotEnvironmentProviderFactoryTest {
  ...
  public void testCustomPinotEnvironmentProviderFactory() {
    ...
    Assert.assertEquals(((PinotEnvironmentProviderFactoryTest.TestEnvironmentProvider) testPinotEnvironment).getConfiguration().getProperty("maxRetry"), "3");
    Assert.assertEquals(
        ((PinotEnvironmentProviderFactoryTest.TestEnvironmentProvider) testPinotEnvironment).getConfiguration().getProperty("connectionTimeoutMillis"), "100");
    Assert.assertEquals(
        ((PinotEnvironmentProviderFactoryTest.TestEnvironmentProvider) testPinotEnvironment).getConfiguration().getProperty("requestTimeoutMillis"), "100");
  }
