...
public class QueryExecutionContext {
  ...
  /// Terminates the query execution with the given exception. Cancels all the tasks and clears the task list.
  public synchronized boolean terminate(QueryException exception) {
    if (_terminateException != null) {
      return false;
    }
    _terminateException = exception;
  ...
  /// Returns the terminate exception if the query has been terminated, or null otherwise.
  @Nullable
  public QueryException getTerminateException() {
