...
public class InstanceReplicaGroupPartitionConfig extends BaseJsonConfig {
  ...
  @JsonPropertyDescription("Number of instances per partition (within a replica-group) for replica-group based selection, select all instances if not "
      + "specified")
  private final int _numInstancesPerPartition;

  @JsonCreator
  public InstanceReplicaGroupPartitionConfig(@JsonProperty("replicaGroupBased") boolean replicaGroupBased, @JsonProperty("numInstances") int numInstances,
      @JsonProperty("numReplicaGroups") int numReplicaGroups, @JsonProperty("numInstancesPerReplicaGroup") int numInstancesPerReplicaGroup,
      @JsonProperty("numPartitions") int numPartitions, @JsonProperty("numInstancesPerPartition") int numInstancesPerPartition) {
