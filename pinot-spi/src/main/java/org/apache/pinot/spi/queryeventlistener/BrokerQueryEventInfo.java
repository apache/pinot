...
public class BrokerQueryEventInfo {
  ...
  public String toString() {
    return "BrokerQueryEventInfo{" + "_requestId='" + _requestId + '\'' + ", _brokerId='" + _brokerId + '\''
        + ", _query='" + _query + '\'' + ", _queryStatus='" + _queryStatus + '\'' + ", _failureJson='" + _failureJson
        + '\'' + ", _errorCode=" + _errorCode + ", _requestArrivalTimeMillis=" + _requestArrivalTimeMillis
        + ", _numServersQueried=" + _numServersQueried + ", _numServersResponded=" + _numServersResponded
        + ", _numDocsScanned=" + _numDocsScanned + ", _numEntriesScannedInFilter=" + _numEntriesScannedInFilter
        + ", _numEntriesScannedPostFilter=" + _numEntriesScannedPostFilter + ", _numSegmentsQueried="
        + _numSegmentsQueried + ", _numSegmentsProcessed=" + _numSegmentsProcessed + ", _numSegmentsMatched="
        + _numSegmentsMatched + ", _numConsumingSegmentsQueried=" + _numConsumingSegmentsQueried
        + ", _numConsumingSegmentsProcessed=" + _numConsumingSegmentsProcessed + ", _numConsumingSegmentsMatched="
        + _numConsumingSegmentsMatched + ", _minConsumingFreshnessTimeMs=" + _minConsumingFreshnessTimeMs
        + ", _totalDocs=" + _totalDocs + ", _numGroupsLimitReached=" + _numGroupsLimitReached + ", _timeUsedMs="
        + _timeUsedMs + ", _offlineThreadCpuTimeNs=" + _offlineThreadCpuTimeNs + ", _realtimeThreadCpuTimeNs="
        + _realtimeThreadCpuTimeNs + ", _offlineSystemActivitiesCpuTimeNs=" + _offlineSystemActivitiesCpuTimeNs
        ...
        + ", _offlineTotalCpuTimeNs=" + _offlineTotalCpuTimeNs + ", _realtimeTotalCpuTimeNs=" + _realtimeTotalCpuTimeNs
        + ", _numSegmentsPrunedByBroker=" + _numSegmentsPrunedByBroker + ", _numSegmentsPrunedByServer="
        + _numSegmentsPrunedByServer + ", _numSegmentsPrunedInvalid=" + _numSegmentsPrunedInvalid
        + ", _numSegmentsPrunedByLimit=" + _numSegmentsPrunedByLimit + ", _numSegmentsPrunedByValue="
        + _numSegmentsPrunedByValue + ", _explainPlanNumEmptyFilterSegments=" + _explainPlanNumEmptyFilterSegments
        + ", _explainPlanNumMatchAllFilterSegments=" + _explainPlanNumMatchAllFilterSegments + ", _numRowsResultSet="
        + _numRowsResultSet + ", _tableNames=" + _tableNames + ", _offlineServerTenant='" + _offlineServerTenant + '\''
        + ", _realtimeServerTenant='" + _realtimeServerTenant + '\'' + '}';
  }
}
