...
public class FieldConfig extends BaseJsonConfig {
  ...
  public FieldConfig(@JsonProperty(value = "name", required = true) String name,
    ...
    Preconditions.checkArgument(compressionCodec == null || codecPipeline == null || codecPipeline.isEmpty(),
   ...
   * When set, this takes precedence over {@link #getCompressionCodec()}.
   */
  @Nullable
