...
public class TableConfig extends BaseJsonConfig {
  ...
  public TableConfig(TableConfig tableConfig) {
    ...
    _tableSamplers = sanitizeTableSamplers(tableConfig.getTableSamplers());
  }
  ...
  @Nullable
  private static List<TableSamplerConfig> sanitizeTableSamplers(@Nullable List<TableSamplerConfig> tableSamplers) {
