...
/// This interface is designed to support the creation of multiple [ColumnReaderFactory] instances
...
public interface ColumnarDataSource extends Closeable {
  ...
  /// Creates a new [ColumnReaderFactory] instance for this data source.
  ///
