...
public class CommonConstants {
  ...
  public static class Server {
    ...
    // Authentication used by the server when it queries the broker routing-readiness endpoint. Credentials are sent
    // only when the broker advertises an HTTPS admin endpoint.
