...
public enum QueryErrorCode {
  ...
  QUERY_SCHEDULING_TIMEOUT(240, "QuerySchedulingTimeoutError", Response.Status.SERVICE_UNAVAILABLE),
  SERVER_RESOURCE_LIMIT_EXCEEDED(245, "ServerResourceLimitExceededError", Response.Status.SERVICE_UNAVAILABLE),
  EXECUTION_TIMEOUT(250, "ExecutionTimeoutError", Response.Status.GATEWAY_TIMEOUT),
  BROKER_SEGMENT_UNAVAILABLE(305, "", Response.Status.SERVICE_UNAVAILABLE),
  BROKER_TIMEOUT(400, "BrokerTimeoutError", Response.Status.GATEWAY_TIMEOUT),
  BROKER_RESOURCE_MISSING(410, "BrokerResourceMissingError", Response.Status.NOT_FOUND),
  BROKER_INSTANCE_MISSING(420, "BrokerInstanceMissingError", Response.Status.SERVICE_UNAVAILABLE),
  BROKER_REQUEST_SEND(425, "BrokerRequestSend", Response.Status.BAD_GATEWAY),
