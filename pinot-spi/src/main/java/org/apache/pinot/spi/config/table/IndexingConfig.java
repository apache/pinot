...
public class IndexingConfig extends BaseJsonConfig {
  ...
  public boolean isCreateAllIndicesDuringSegmentGeneration() {
    return _createAllIndicesDuringSegmentGeneration;
  }

  public void setCreateAllIndicesDuringSegmentGeneration(boolean createAllIndicesDuringSegmentGeneration) {
    _createAllIndicesDuringSegmentGeneration = createAllIndicesDuringSegmentGeneration;
  }

  public boolean isBloomFilterEnabledOnColumn(String columnName) {
    return (_bloomFilterColumns != null && _bloomFilterColumns.contains(columnName)) || (_bloomFilterConfigs != null
        && _bloomFilterConfigs.containsKey(columnName));
  }

  private boolean _createAllIndicesDuringSegmentGeneration;
