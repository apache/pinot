...
export default function cloudify() {
    ...
    var Node = function (_home, _label) {
        ...
        this.draw = function () {
            // size
            this.radius +=
                (this.targetRadius - this.radius) * RADIUS_ANIMATION_SPEED;
            var d = this.radius * 2;
            this.svgCircle.size(d, d);
            // text
            this.textOpacity +=
                (this.targetTextOpacity - this.textOpacity) *
    ...
    elements.each(function (i, e) {
        ...
        var home = new Vector(Math.sin(p) * r, Math.cos(p) * r);
