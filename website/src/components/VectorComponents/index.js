    ...
    return (
      <>
        ...
        {sinkComponents.length > 0 ?
          ...
          ''}
        <hr />
        <Jump to="https://github.com/apache/incubator-pinot/issues/new?labels=type%3A+new+feature" target="_blank" icon="plus-circle">
      ...
      <div className="filters">
        ...
        <div className="filter">
          <div className="filter--label">
            <Link to="/docs/about/data-model/" title="Learn more about Pinot's event types">
        ...
        <div className="filter">
          <div className="filter--label">
            <Link to="/docs/about/guarantees/" title="Learn more about Pinot's guarantees">
        ...
        {operatingSystems.size > 0 && (
          <div className="filter">
            <div className="filter--label">
              <Link to="/docs/setup/installation/operating-systems/" title="Learn more about ">
                Operating Systems
              </Link>
            </div>
            <div className="filter--choices">
