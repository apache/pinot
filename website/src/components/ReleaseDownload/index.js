...
function Downloads({browsePath, downloads}) {
  ...
  return (
    <ul className={styles.downloadFiles}>
        ...
        <li key={catIdx}>
          ...
          <ul>
            {groupedDownloads[key].map((download, downloadIdx) => (
              <li key={downloadIdx}>
                <a key={downloadIdx} title={download.file_name} href={`https://pinot.apache.org/`}>
      ...
      <li>
        <a href={`https://pinot.apache.org/`} target="_blank">browse all files&hellip;</a>
      </li>
    </ul>
  );
}
  ...
  return (
    <div className={styles.downloadTable}>
      ...
      <div>
        <div>License</div>
        <div>
          <a href="https://github.com/apache/incubator-pinot/blob/master/LICENSE" target="_blank">Apache 2</a>
        </div>
      </div>
      <div>
        <div>Downloads</div>
...
function ReleaseDownload({version}) {
  ...
  return (
    <Layout title="Download" description="Download Pinot for your platform.">
                  ...
                  <g id="Custom-Preset" transform="translate(-514.000000, -182.000000)">
                      <g id="Download" transform="translate(-340.000000, -479.000000)">
                          <g id="Box" transform="translate(855.000000, 662.000000)">
                              ...
                              <g id="Pinot" transform="translate(17.608696, 16.304348)">
