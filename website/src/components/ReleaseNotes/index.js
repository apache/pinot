      ...
      <header className={styles.header}>
        <div className="container container--fluid">
          <div className={styles.componentsHeroOverlay}>
            <h1>Pinot v{release.version} Release Notes</h1>
