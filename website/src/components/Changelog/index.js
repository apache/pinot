    ...
    <div className="section">
      <div className="badges">
        ...
        {commit.pr_number && (<span className="badge badge--secondary" style={{minWidth: "65px", textAlign: "center"}}>
          <a href={`https://github.com/apache/incubator-pinot/pull/${commit.pr_number}`} target="_blank"><i className="feather icon-git-pull-request"></i> {commit.pr_number}</a>
        </span>)}
        {!commit.pr_number && (<span className="badge badge--secondary" style={{minWidth: "65px", textAlign: "center"}}>
          <a href={`https://github.com/apache/incubator-pinot/commit/${commit.sha}`} target="_blank"><i className="feather icon-git-commit"></i> {commit.sha.slice(0,5)}</a>
        </span>)}
      </div>
