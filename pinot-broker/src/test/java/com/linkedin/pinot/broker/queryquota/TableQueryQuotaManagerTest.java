...
public class TableQueryQuotaManagerTest {
  ...
  public void testOfflineTableNotnullQuota() throws Exception {
    ...
    _tableQueryQuotaManager.dropTableQueryQuota(tableConfig, brokerResource);
  ...
  public void testOfflineTableWithNullQuotaButWithRealtimeTableConfigNullQpsConfig() throws Exception {
    ...
    ZKMetadataProvider.setRealtimeTableConfig(_testPropertyStore, REALTIME_TABLE_NAME, znRecord);
  ...
  public void testBothTableHaveQpsQuotaConfig() throws Exception {
    ...
    TableConfig offlineTableConfig = generateDefaultTableConfig(OFFLINE_TABLE_NAME);
    setQps(offlineTableConfig);
    TableConfig realtimeTableConfig = generateDefaultTableConfig(REALTIME_TABLE_NAME);
    setQps(realtimeTableConfig);
    ...
    znRecord = new ZNRecord("broker_instance_1");
    znRecord.setSimpleField("tableName", "testTable");
    ...
    znRecord.setSimpleField("metadata", "{\"customConfigs\":{\"d2Name\":\"CapReportingPinot\"}}");
    znRecord.setSimpleField("tableIndexConfig", "{\"segmentPartitionConfig\":null,\"sortedColumn\":[],\"invertedIndexColumns\":[\"jobsPosted\"],\"autoGeneratedInvertedIndex\":false,\"loadMode\":\"MMAP\",\"streamConfigs\":{},\"streamConsumptionConfig\":null,\"segmentFormatVersion\":\"v3\",\"columnMinMaxValueGeneratorMode\":null,\"noDictionaryColumns\":null,\"onHeapDictionaryColumns\":null,\"starTreeIndexSpec\":null,\"aggregateMetrics\":false}");
    ZKMetadataProvider.setOfflineTableConfig(_testPropertyStore, OFFLINE_TABLE_NAME, znRecord);
    ...
    _tableQueryQuotaManager.dropTableQueryQuota(offlineTableConfig, brokerResource);
    // Since real-time table still has the qps quota, the size of the hash map becomes 1.
    Assert.assertEquals(_tableQueryQuotaManager.getRateLimiterMapSize(), 1);

    _tableQueryQuotaManager.dropTableQueryQuota(realtimeTableConfig, brokerResource);
