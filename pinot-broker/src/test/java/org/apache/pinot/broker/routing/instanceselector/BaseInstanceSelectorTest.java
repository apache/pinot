...
public class BaseInstanceSelectorTest {
  private static class TestSelector extends BaseInstanceSelector {
    TestSelector() {
      super("testTable_OFFLINE", null, new BrokerMetrics(new NoopPinotMetricsRegistry()), null, Clock.systemUTC(),
    ...
    Map<String, Integer> expose(IdealState is) {
      return serverToReplicaGroupMap(is);
    }
  }
  ...
  public void testServerToReplicaGroupMap() {
    ...
    Map<String, Integer> map = selector.expose(is);
