...
public class ReplicaGroupInstanceSelectorTest {
  ...
  public void testNewSegmentFromZKMetadataSelection() {
    ...
    Map<String, List<String>> idealSateMap = Map.ofEntries(Map.entry(oldSeg, ImmutableList.of(instance0, instance1)),
  ...
  public void testNewSegmentsFromIDWithMissingEV() {
    ...
    Map<String, List<String>> idealSateMap = Map.ofEntries(Map.entry(oldSeg0, ImmutableList.of(instance0, instance1)),
        Map.entry(oldSeg1, ImmutableList.of(instance0, instance1)));
    IdealState idealState = createIdealState(idealSateMap);
    ...
    idealSateMap = Map.ofEntries(Map.entry(oldSeg0, ImmutableList.of(instance0, instance1)),
        Map.entry(oldSeg1, ImmutableList.of(instance0, instance1)),
        Map.entry(newSeg, ImmutableList.of(instance0, instance1)));
