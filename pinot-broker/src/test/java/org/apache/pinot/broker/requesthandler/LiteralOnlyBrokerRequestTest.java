...
public class LiteralOnlyBrokerRequestTest {
  ...
  public static class FakeBrokerResourceOnlineOfflineStateModelFactory extends StateModelFactory<StateModel> {
    ...
    private static final FakeBrokerResourceOnlineOfflineStateModelFactory.FakeBrokerResourceOnlineOfflineStateModel
        STATE_MODEL_INSTANCE =
        new FakeBrokerResourceOnlineOfflineStateModelFactory.FakeBrokerResourceOnlineOfflineStateModel();
    ...
    public static class FakeBrokerResourceOnlineOfflineStateModel extends StateModel {
      private static final Logger LOGGER = LoggerFactory.getLogger(
          ControllerTestUtils.FakeBrokerResourceOnlineOfflineStateModelFactory.FakeBrokerResourceOnlineOfflineStateModel.class);
  ...
  public static class FakeSegmentOnlineOfflineStateModelFactory extends StateModelFactory<StateModel> {
    ...
    private static final FakeSegmentOnlineOfflineStateModelFactory.FakeSegmentOnlineOfflineStateModel
        STATE_MODEL_INSTANCE =
        new FakeSegmentOnlineOfflineStateModelFactory.FakeSegmentOnlineOfflineStateModel();
    ...
    public static class FakeSegmentOnlineOfflineStateModel extends StateModel {
      private static final Logger LOGGER = LoggerFactory.getLogger(
          ControllerTestUtils.FakeSegmentOnlineOfflineStateModelFactory.FakeSegmentOnlineOfflineStateModel.class);
  ...
  public void suiteSetup()
      throws Exception {
    setupClusterAndValidate();

//    // Create the offline table and add one segment
//    TableConfig tableConfig =
//        new TableConfigBuilder(TableType.OFFLINE).setTableName("offlineTable").setNumReplicas(2).build();
...
//        .addNewSegment(TableNameBuilder.OFFLINE.tableNameWithType("offlineTable"),
//            SegmentMetadataMockUtils.mockSegmentMetadata("offlineTable", "offlineTable"), "downloadUrl");
  }
