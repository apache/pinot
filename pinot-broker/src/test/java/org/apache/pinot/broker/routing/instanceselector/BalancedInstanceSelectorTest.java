...
public class BalancedInstanceSelectorTest {
  ...
  public void testNewSegmentFromZKMetadataSelection() {
    ...
    int requestId = 0;
    Map<String, String> expectedBalancedInstanceSelectorResult = ImmutableMap.of(oldSeg, instance0, newSeg, instance1);
    ...
    requestId = 1;
    expectedBalancedInstanceSelectorResult = ImmutableMap.of(oldSeg, instance1);
    ...
    replicaGroupInstanceSelector.init(enabledInstances, idealState, externalView, onlineSegments);
    requestId = 0;
    expectedBalancedInstanceSelectorResult = ImmutableMap.of(oldSeg, instance0, newSeg, instance1);
    ...
    selectionResult =
        replicaGroupInstanceSelector.select(_brokerRequest, Lists.newArrayList(onlineSegments), requestId);
    expectedBalancedInstanceSelectorResult = ImmutableMap.of(oldSeg, instance1, newSeg, instance1);
  ...
  public void testNewSegmentsFromIDWithMissingEV() {
    ...
    int requestId = 0;
    Map<String, String> expectedBalancedInstanceSelectorResult =
        ImmutableMap.of(oldSeg0, instance0, oldSeg1, instance1);
  ...
  public void testExcludeNotEnabledInstanceForNewSegment() {
    ...
    expectedBalancedInstanceSelectorResult = ImmutableMap.of(oldSeg, instance1, newSeg, instance0);
