...
public interface InstanceSelector {
  ...
  /// Selects the server instances for the given segments queried by the given broker request, returns a map from
  /// segment to selected server instance hosting the segment and a set of unavailable segments (no enabled instance or
  /// all enabled instances are in ERROR state).
  ///
