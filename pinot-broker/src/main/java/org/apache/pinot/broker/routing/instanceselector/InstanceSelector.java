...
public interface InstanceSelector {
   ...
   */
  void init(Set<String> enabledInstances, BrokerRoutingManager.EnabledServerInstanceManager enabledServerManager, IdealState idealState, ExternalView externalView, Set<String> onlineSegments);
