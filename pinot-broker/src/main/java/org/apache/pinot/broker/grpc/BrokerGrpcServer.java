...
public class BrokerGrpcServer extends PinotQueryBrokerGrpc.PinotQueryBrokerImplBase {
  ...
  public BrokerGrpcServer(PinotConfiguration brokerConf, String brokerId, BrokerMetrics brokerMetrics,
    ...
    _grpcPort = Integer.parseInt(brokerConf.getProperty(CommonConstants.Broker.Grpc.KEY_OF_GRPC_PORT, "0"));
    ...
    _secureGrpcPort = brokerConf.getProperty(CommonConstants.Broker.Grpc.KEY_OF_GRPC_TLS_PORT, 0);
  ...
  public void submit(Broker.BrokerRequest request,
    ...
    SqlNodeAndOptions sqlNodeAndOptions = RequestUtils.parseQuery(query, requestJsonNode);
