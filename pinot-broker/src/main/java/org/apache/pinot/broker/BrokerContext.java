 ...
 * under the License.
 */
package org.apache.pinot.broker;
...
public class BrokerContext {
  ...
  public SslContext getClientGrpcSslContext() {
    return _queryRuntimeContext.getClientGrpcSslContext(InstanceType.BROKER);
  }

  public void setClientGrpcSslContext(SslContext clientGrpcSslContext) {
    _queryRuntimeContext.setClientGrpcSslContext(InstanceType.BROKER, clientGrpcSslContext);
  }

  @Nullable
  public SslContext getServerGrpcSslContext() {
    return _queryRuntimeContext.getServerGrpcSslContext(InstanceType.BROKER);
  }

  public void setServerGrpcSslContext(SslContext serverGrpcSslContext) {
    _queryRuntimeContext.setServerGrpcSslContext(InstanceType.BROKER, serverGrpcSslContext);
  }
