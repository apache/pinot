...
@Path("/")
public interface PinotBrokerRoutingService {
  ...
  String buildRouting(@ApiParam(value = "Table name (with type)") @PathParam("tableName") String tableNameWithType);
  ...
  String removeRouting(@ApiParam(value = "Table name (with type)") @PathParam("tableName") String tableNameWithType);
}
