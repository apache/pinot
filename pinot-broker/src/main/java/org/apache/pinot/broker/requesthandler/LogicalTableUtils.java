...
public class LogicalTableUtils {
  ...
  public static class LogicalTableRequests extends BaseSingleStageBrokerRequestHandler.Requests {
    public final HybridTableName _hybridTableName;

    public LogicalTableRequests(BaseSingleStageBrokerRequestHandler.Requests requests,
        HybridTableName hybridTableName) {
