...
public interface PinotBrokerDebugService {
  ...
  TimeBoundaryInfo getTimeBoundary(@ApiParam(value = "Name of the table") @PathParam("tableName") String tableName);
  ...
  Map<ServerInstance, List<String>> getRoutingTableForQuery(
