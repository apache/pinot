...
public abstract class BaseBrokerStarter implements ServiceStartable {
  ...
  public void start()
    ...
    ThreadAccounting.init(schedulerConfig, _instanceId, org.apache.pinot.spi.config.instance.InstanceType.BROKER);
    ...
    ThreadAccounting.getBrokerAccountant().startWatcherTask();
  ...
  public void stop() {
    ...
    ThreadAccounting.getBrokerAccountant().stopWatcherTask();
