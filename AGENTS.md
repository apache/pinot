...
## Build and test
- Build JDK: Use JDK 17+ (CI runs 17/21); code targets Java 17.
- Runtime JRE: Broker/server/controller/minion run on Java 17+.
...
- Use Javadoc comments with either `/** ... */` or `///` syntax (per JEP-467); code targets Java 17.
