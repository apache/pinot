...
## Build and test
- JDK 17 is required for building Pinot.
...
## Integration tests
- Single integration test example: `./mvnw -pl pinot-integration-tests -Dtest=OfflineClusterIntegrationTest test -am -Dsurefire.failIfNoSpecifiedTests=false`
...
- Use `./mvnw spotless:apply` to format code and `./mvnw checkstyle:check` to validate style.
