...
Set per-column forward index encoding inside `fieldConfigList[].indexes.forward.encodingType`. The older
field-level `fieldConfigList[].encodingType` form is deprecated and table creation rejects it.
