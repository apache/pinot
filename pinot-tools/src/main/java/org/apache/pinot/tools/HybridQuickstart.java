...
public class HybridQuickstart {
  ...
  public void execute()
    ...
    startKafka();
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Starting Zookeeper, 2 servers, 2 brokers and 1 controller *****");
    runner.startAll();
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Creating a server tenant with name 'airline' *****");
    runner.createServerTenantWith(1, 1, "airline");
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Creating a broker tenant with name 'airline_broker' *****");
    runner.createBrokerTenantWith(2, "airline_broker");
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Adding airlineStats schema *****");
    runner.addSchema();
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Adding airlineStats offline and realtime table *****");
    runner.addTable();
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Building index segment for airlineStats *****");
    runner.buildSegment();
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** Pushing segment to the controller *****");
    runner.pushSegment();
    ...
    Quickstart.printStatus(Quickstart.Color.YELLOW, "***** go to http://localhost:9000/query to run a few queries *****");
