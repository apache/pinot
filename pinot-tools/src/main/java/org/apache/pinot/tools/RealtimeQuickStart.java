...
public class RealtimeQuickStart {
  ...
  public void execute()
    ...
    runner.startAll();
    Quickstart.printStatus(Quickstart.Color.CYAN, "***** Adding meetupRSVP schema *****");
    runner.addSchema();
    Quickstart.printStatus(Quickstart.Color.CYAN, "***** Adding meetupRSVP table *****");
    runner.addTable();
    ...
    Quickstart.printStatus(Quickstart.Color.CYAN, "Query : " + q1);
    Quickstart.printStatus(Quickstart.Color.YELLOW, Quickstart.prettyPrintResponse(runner.runQuery(q1)));
    ...
    Quickstart.printStatus(Quickstart.Color.CYAN, "Query : " + q2);
    Quickstart.printStatus(Quickstart.Color.YELLOW, Quickstart.prettyPrintResponse(runner.runQuery(q2)));
    Quickstart.printStatus(Quickstart.Color.GREEN, "***************************************************");
    ...
    Quickstart.printStatus(Quickstart.Color.CYAN, "Query : " + q3);
    Quickstart.printStatus(Quickstart.Color.YELLOW, Quickstart.prettyPrintResponse(runner.runQuery(q3)));
    Quickstart.printStatus(Quickstart.Color.GREEN, "***************************************************");
    ...
    Quickstart.printStatus(Quickstart.Color.CYAN, "Query : " + q4);
    Quickstart.printStatus(Quickstart.Color.YELLOW, Quickstart.prettyPrintResponse(runner.runQuery(q4)));
    Quickstart.printStatus(Quickstart.Color.GREEN, "***************************************************");

    String q5 = "select count(*) from meetupRsvp limit 0";
    Quickstart.printStatus(Quickstart.Color.YELLOW, "Total number of documents in the table");
    Quickstart.printStatus(Quickstart.Color.CYAN, "Query : " + q5);
    Quickstart.printStatus(Quickstart.Color.YELLOW, Quickstart.prettyPrintResponse(runner.runQuery(q5)));
    Quickstart.printStatus(Quickstart.Color.GREEN, "***************************************************");

    Quickstart.printStatus(Quickstart.Color.GREEN, "You can always go to http://localhost:9000/query/ to play around in the query console");
  }
