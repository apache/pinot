...
@Api(tags = "Health", authorizations = {@Authorization(value = DEFAULT_SWAGGER_AUTHORIZATION_VALUE)})
...
public class PinotServiceManagerHealthCheck {
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Pinot Starter is healthy"),
      @ApiResponse(code = 503, message = "Pinot Starter is not healthy")
  })
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Pinot Service is healthy"),
      @ApiResponse(code = 503, message = "Pinot Service is not healthy")
  })
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Pinot Instance is healthy"),
      @ApiResponse(code = 503, message = "Pinot Instance is not healthy")
  })
