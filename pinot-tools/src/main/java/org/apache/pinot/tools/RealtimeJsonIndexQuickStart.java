...
public class RealtimeJsonIndexQuickStart {
  ...
  public void execute()
    ...
    URL resource = classLoader.getResource("examples/stream/meetupRsvp/json_meetupRsvp_schema.json");
    Preconditions.checkNotNull(resource);
    FileUtils.copyURLToFile(resource, schemaFile);
    resource = classLoader.getResource("examples/stream/meetupRsvp/json_meetupRsvp_realtime_table_config.json");
    Preconditions.checkNotNull(resource);
