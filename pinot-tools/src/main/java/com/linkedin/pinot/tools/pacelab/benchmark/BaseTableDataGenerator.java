...
import com.linkedin.pinot.tools.data.generator.*;
...
public class BaseTableDataGenerator {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        final Map<String, FieldSpec.DataType> dataTypes = new HashMap<String, FieldSpec.DataType>();
        final Map<String, FieldSpec.FieldType> fieldTypes = new HashMap<String, FieldSpec.FieldType>();
        ...
        for (final String col : columns) {
            dataTypes.put(col, FieldSpec.DataType.INT);
            fieldTypes.put(col, FieldSpec.FieldType.DIMENSION);
