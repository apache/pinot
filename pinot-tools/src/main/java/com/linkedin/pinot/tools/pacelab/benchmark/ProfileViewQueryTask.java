        ...
        */
        ...
        switch (queryId) {
            ...
            case 2:
                ...
                break;
	        case 3:
                query = String.format(queries[queryId], randomJob.getValue("Position"),groupByLimit);
                runQuery(query);
                break;
	        case 4:
                query = String.format(queries[queryId], randomJob.getValue("Position"),groupByLimit);
                ...
                break;
            case 5:
                query = String.format(queries[queryId], randomCompany.getValue("Location"),groupByLimit);
                runQuery(query);
                break;
            case 6:
                query = String.format(queries[queryId], randomCompany.getValue("Location"),groupByLimit);
