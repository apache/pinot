...
public class RefreshSegmentTaskExecutor extends BaseSingleSegmentConversionExecutor {
  ...
  /**
   * Refresh segment using traditional row-major approach (existing implementation).
   */
  ...
  /**
   * Refresh segment using optimized column-wise approach for immutable-to-immutable conversion.
   */
