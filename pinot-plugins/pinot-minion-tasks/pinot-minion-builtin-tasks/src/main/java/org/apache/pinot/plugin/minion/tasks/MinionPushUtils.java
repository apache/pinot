...
public class MinionPushUtils implements Serializable {
  private MinionPushUtils() {
  }

  private static final Logger LOGGER = LoggerFactory.getLogger(MinionPushUtils.class);
  ...
  public static Map<String, String> getSegmentUriToTarPathMap(URI outputDirURI, PushJobSpec pushSpec,
    ...
    for (String file : files) {
      ...
      if (uri.getPath().endsWith(Constants.TAR_GZ_FILE_EXT)) {
        URI updatedURI = MinionPushUtils.generateSegmentTarURI(outputDirURI, uri, pushSpec.getSegmentUriPrefix(),
