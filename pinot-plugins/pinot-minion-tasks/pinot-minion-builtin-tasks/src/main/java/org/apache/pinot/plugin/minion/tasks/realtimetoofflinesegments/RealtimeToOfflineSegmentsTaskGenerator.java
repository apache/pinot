      ...
      while (true) {
        ...
        for (int segmentZkMetadataIndex = 0; segmentZkMetadataIndex < completedSegmentsZKMetadata.size();
          ...
          if (realtimeSegmentNameVsCorrespondingOfflineSegmentNamesOfPrevTask.containsKey(segmentName)) {
            ...
            reProcessSegment =
                checkIfSegmentNeedsToBeReProcessed(expectedCorrespondingOfflineSegments, offlineTableSegmentNames);
            ...
            if (reProcessSegment) {
              ...
              // segment has been picked in one of the past tasks and the task was successful.
          ...
          if (windowStartMs <= segmentEndTimeMs && segmentStartTimeMs < windowEndMs) {
            ...
            throw new RuntimeException(
                "Segment: " + segmentName + " needs to be reProcessed and should lie under bucket range.");
          }
