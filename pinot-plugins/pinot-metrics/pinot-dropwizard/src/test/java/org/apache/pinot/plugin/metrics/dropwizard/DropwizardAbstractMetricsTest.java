...
public class DropwizardAbstractMetricsTest extends AbstractMetricsTest {
  ...
  protected String metricsFactoryClassName() {
    return DropwizardMetricsFactory.class.getName();
  }

  @Override
  protected PinotMetricsRegistry buildRegistry() {
    return new DropwizardMetricsRegistry();
  }

  @Override
  protected MetricsInspector createInspector(PinotMetricsRegistry registry) {
    return new DropwizardMetricsInspector(registry);
  }

  @Override
  protected long getGaugeValue(AbstractMetrics<?, ?, ?, ?> metrics, String metricName) {
    return DropwizardMetricValueUtils.getGaugeValue(metrics, metricName);
  }
}
