...
public final class BrokerRuntimeSystemTableProvider implements SystemTableProvider {
  ...
  private final @Nullable PinotConfiguration _brokerConfig;

  public BrokerRuntimeSystemTableProvider() {
    this(null, null, null, null);
  }

  public BrokerRuntimeSystemTableProvider(@Nullable TableCache tableCache, @Nullable HelixAdmin helixAdmin,
      @Nullable String clusterName, @Nullable PinotConfiguration brokerConfig) {
