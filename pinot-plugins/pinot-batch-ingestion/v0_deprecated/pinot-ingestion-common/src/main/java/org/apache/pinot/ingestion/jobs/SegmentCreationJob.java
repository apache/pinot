...
public abstract class SegmentCreationJob extends BaseSegmentJob {
  ...
  public enum SchemaMisMatchCounter {
    FILE_BASED_DATA_TYPE_MISMATCH,
    FILE_BASED_SINGLE_VALUE_MULTI_VALUE_FIELD_MISMATCH,
    FILE_BASED_MULTI_VALUE_FIELD_STRUCTURE_MISMATCH,
    FILE_BASED_MISSING_PINOT_COLUMN,
    ROW_BASED_DATA_TYPE_MISMATCH,
    ROW_BASED_SINGLE_VALUE_MULTI_VALUE_FIELD_MISMATCH,
    ROW_BASED_MULTI_VALUE_FIELD_STRUCTURE_MISMATCH
  }
}
