...
public class ProtoBufRecordExtractorTest extends AbstractRecordExtractorTest {
  ...
  private Map<String, Object> createRecord1() {
    ...
    record.put(COMPLEX_MAP, getNestedMap("fruit1", getNestedMap(NESTED_STRING_FIELD, "apple", NESTED_INT_FIELD, 1),
  ...
  private Map<String, Object> createRecord2() {
    ...
    record.put(REPEATED_NESTED_MESSAGES,
        Arrays.asList(getNestedMap(NESTED_STRING_FIELD, "coffee", NESTED_INT_FIELD, 10),
            getNestedMap(NESTED_STRING_FIELD, "tea", NESTED_INT_FIELD, 20)));
    record.put(COMPLEX_MAP, getNestedMap("food3", getNestedMap(NESTED_STRING_FIELD, "pizza", NESTED_INT_FIELD, 1),
