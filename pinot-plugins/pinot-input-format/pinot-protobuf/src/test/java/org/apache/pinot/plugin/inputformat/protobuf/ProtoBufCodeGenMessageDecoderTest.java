...
import static org.apache.pinot.plugin.inputformat.protobuf.ProtoBufCodeGenMessgeDecoder.PROTOBUF_JAR_FILE_PATH;
import static org.apache.pinot.plugin.inputformat.protobuf.ProtoBufCodeGenMessgeDecoder.PROTO_CLASS_NAME;
...
public class ProtoBufCodeGenMessageDecoderTest {
  ...
  public void testComplexClass()
      throws Exception {
    ProtoBufCodeGenMessgeDecoder messageDecoder = setupDecoder("complex_types.jar",
  ...
  public void testHappyCase()
      throws Exception {
    ProtoBufCodeGenMessgeDecoder messageDecoder =
  ...
  public void testCompositeMessage()
      throws Exception {
    ProtoBufCodeGenMessgeDecoder messageDecoder = setupDecoder("composite_types.jar",
  ...
  @NotNull
  private ProtoBufCodeGenMessgeDecoder setupDecoder(String name, String value,
