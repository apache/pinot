...
import org.apache.pinot.plugin.inputformat.avro.datahub.deserializer.KafkaDatahubAvroDeserializer;
...
public class KafkaDatahubSchemaRegistryAvroMessageDecoder implements StreamMessageDecoder<byte[]> {
  ...
  private KafkaDatahubAvroDeserializer _deserializer;
  ...
  public void init(Map<String, String> props, Set<String> fieldsToRead, String topicName)
    ...
    _deserializer = new KafkaDatahubAvroDeserializer(topicName, props);
  ...
  public GenericRow decode(byte[] payload, GenericRow destination) {
    Record avroRecord = (Record) _deserializer.deserialize(payload);
