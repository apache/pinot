...
public class ORCRecordExtractorTest extends AbstractRecordExtractorTest {
  ...
  protected List<Map<String, Object>> getInputRecords() {
    ...
    Map[] simpleStructs = new Map[]{null, createStructInput("structString", "abc", "structLong", 1000L, "structDouble",
        5.99999), createStructInput("structString", "def", "structLong", 2000L, "structDouble",
