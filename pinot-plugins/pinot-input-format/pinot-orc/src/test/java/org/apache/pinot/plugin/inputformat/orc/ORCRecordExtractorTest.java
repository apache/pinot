    ...
    for (int i = 0; i < numRecords; i++) {
      ...
      if (complexList != null) {
        ...
        for (Map<String, Object> complexElement : complexList) {
          ...
          complexListDoubleVector.vector[complexListVector.childCount] = (double) complexElement.get("complexListDouble");
      ...
      if (complexMap != null) {
        ...
        for (Map.Entry<String, Map<String, Object>> entry : complexMap.entrySet()) {
          ...
          complexMapValueDoubleVector.vector[complexMapVector.childCount] = (double) entry.getValue().get("doubleField");
          complexMapValueBytesVector.setVal(complexMapVector.childCount, StringUtils.encodeUtf8((String) entry.getValue().get("stringField")));
