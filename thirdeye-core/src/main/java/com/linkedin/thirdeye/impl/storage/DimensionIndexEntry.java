...
public class DimensionIndexEntry implements Serializable
{
  ...
  public DimensionIndexEntry(UUID nodeId,
                             UUID fileId,
                             Integer dictionaryStartOffset,
                             Integer dictionaryLength,
                             Integer bufferStartOffset,
  ...
  public String toString()
  {
    ...
    sb.append("nodeId=").append(nodeId).append("\t")
      ...
      .append("bufferStartOffset=").append(bufferStartOffset).append("\t")
      .append("bufferLength=").append(bufferLength).append("\t");
