...
public class BenchmarkSumAggregation extends BaseQueryBenchmark {
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(BenchmarkSumAggregation.class.getSimpleName())
//        .addProfiler(GCProfiler.class)
  ...
  protected Schema createSchema() {
    return new Schema.SchemaBuilder()
        ...
        .addDimensionField("valueInt", FieldSpec.DataType.INT)
        .addDimensionField("valueLong", FieldSpec.DataType.LONG)
        .build();
  }
